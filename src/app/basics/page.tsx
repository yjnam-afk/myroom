...
const TERMS: Term[] = [
  ...
  { ko: "뮤텍스", en: "Mutex", cat: "프로세스·동기화", def: "열쇠가 1개뿐인 잠금장치. 잠근 스레드만 풀 수 있는 '소유' 개념이 있다 — 한 번에 한 명만.", see: "세마포어(Semaphore)" },
  { ko: "스핀락", en: "Spinlock", cat: "프로세스·동기화", def: "잠금이 풀릴 때까지 잠들지 않고 루프를 돌며 계속 재시도하는 잠금(바쁜 대기). 대기가 아주 짧을 때만 유리하다.", see: "경쟁조건(Race Condition) 해결 방안" },
