...
export const SUBNOTES: TextbookSubnote[] = [
  ...
  },
  {
    ...
    tables: [
      ...
      {
        caption: "SDD 절차 (요명계구검)",
        headers: ["절차", "산출물", "설명"],
        rows: [
          ["① 요구사항·아이디어 정의", "Spec 요구 목록", "문제·시나리오\n수용 기준 확정"],
          ["② 명세서 작성(Create Specification)", "명세서(SSoT)", "기능 요구·계약\n제약 조건 명시"],
          ["③ 계획 및 가드레일 설정", "아키텍처 설계서\n데이터 구조도", "구현 방향 결정\n금지 규칙 설정"],
          ["④ AI 기반 구현 및 생성", "코드·테스트\n문서 자동화", "명세에서 생성\n작업 분해 수행"],
          ["⑤ 검증 및 피드백 루프", "리뷰 결과\n수정된 명세", "사람이 검증\n명세에 재반영"],
        ],
      },
      {
        ...
        headers: ["절차", "설명"],
        rows: [
          ["① 정의(Specify)", "상세 명세서 작성\n맥락·성공 기준"],
          ["② 설계(Plan)", "스택·스키마\n명세 기반 설계"],
          ["③ 분해(Break Down)", "테스트 가능 단위\n작고 독립적 분할"],
          ["④ 구현(Implement)", "에이전트 코딩\n명세 제약 내 검증"],
        ],
      },
      {
