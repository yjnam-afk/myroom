...
export const SUBNOTES: TextbookSubnote[] = [
  ...
  },
  {
    ...
    defPair: [
      {
        name: "스니핑(Sniffing)",
        def: "네트워크 패킷을 몰래 감청하여 데이터를 탈취하는 수동적 가로채기 공격 기법",
        features: ["수동적 감청", "기밀성 침해", "패시브·액티브"],
      },
      {
        name: "스푸핑(Spoofing)",
        def: "가짜 정보로 속여 신뢰받는 시스템으로 위장해 공격 대상을 기만하는 공격 기법",
    ...
    defPair: [
      {
        ...
        def: "가상 머신·컨테이너·서버리스 등 클라우드 서버 워크로드를 보호하는 보안 솔루션",
        features: ["워크로드 보호", "호스트 방화벽", "내부 실행 위협 대응"],
      },
      {
        name: "CSPM(Cloud Security Posture Management)",
        def: "클라우드 인프라의 잘못된 구성과 규정 준수 위험을 지속 모니터링하는 프로세스",
