    ...
    tables: [
      {
        ...
        headers: ["역할", "설명", "기능"],
        rows: [
          ["HW 자원 보호", "인가되지 않은 직접 접근을 방지하고 HW를 보호", "HW 직접 참조 오류 방지"],
          ["자원 관리", "프로세스·메모리·I/O 장치 등 한정된 자원을 할당·스케줄", "프로세스 관리·CPU Scheduling·메모리 관리"],
          ["파일시스템·NW 관리", "파일시스템, 네트워크 등의 자원 관리", "File System·네트워크 관리"],
          ["Kernel 데이터 보호", "Kernel Level 데이터 직접 참조를 막고 System Call로만 접근", "시스템 호출·IPC"],
          ["추상화", "HW와 응용 프로그램을 연계하도록 HW를 추상화해 제공", "커널 모드·운영 모드 분리"],
        ],
      },
      {
