    ...
    tables: [
      {
        ...
        headers: ["특징", "키워드", "설명"],
        rows: [
          ["AI 역량과의 정렬", "볼트 고속 반복", "AI 맞춤 주기"],
          ["단계 최소화, 흐름 극대화", "설계 기법 내재화", "흐름 극대화"],
        ],
      },
      {
        caption: "AI-DLC 구성요소",
      ...
      },
      {
        ...
        headers: ["특징", "키워드", "설명"],
        rows: [
          ["실행 가능한 명세", "행동 규격 중심", "프롬프트 명세화"],
          ["요구-코드 간 의미적 정합성 보장", "단일 진실 원천", "요구·코드 일치"],
        ],
      },
      {
        caption: "SDD 절차",
        headers: ["절차", "키워드", "설명"],
        rows: [
          ["① 정의(Specify)", "상세 명세서 작성", "맥락·성공 기준"],
          ["② 설계(Plan)", "스택 스키마 결정", "명세 기반 설계"],
          ["③ 분해(Break Down)", "테스트 가능 단위", "작고 독립적 분할"],
          ["④ 구현(Implement)", "에이전트 코딩", "명세 제약 내 검증"],
        ],
      },
    ],
    notes: [
