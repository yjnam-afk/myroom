...
export const SUBNOTES: TextbookSubnote[] = [
  ...
  },
  {
    ...
    defShort: "현실 물리 법칙·인과 관계·시공간 역동성을 이해·시뮬레이션하는 기초 모델",
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["추론", "Transformer 처리", "Unified-IO2"],
          ["생성", "Any-to-Any 출력", "Interleaved Generation"],
        ],
      },
      {
  ...
  },
  {
    ...
    defShort: "AI 신뢰성·안전성을 위해 위험을 식별·측정·관리하는 NIST 위험관리 프레임워크",
