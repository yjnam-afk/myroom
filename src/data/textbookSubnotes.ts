    ...
    tables: [
      {
        ...
        headers: ["세부 프로세스", "주요 산출물", "내용"],
        rows: [
          ["범위 관리 계획 수립", "범위관리계획서\n요구사항관리서", "범위 관리 절차\n방법 정의"],
          ["요구사항 수집", "요구사항 문서\n요구사항 추적표", "이해관계자 요구\n수집·문서화"],
          ["범위 정의", "범위기술서", "제품·서비스\n범위 기술"],
          ["WBS 작성", "WBS\n범위 기준선", "작업 계층 정의\n범위 기준 설정"],
          ["범위 확인", "승인된 인도물", "인도물 공식 승인"],
          ["범위 통제", "변경요청(CR)", "기준선 변경 관리"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        headers: ["종류", "설명"],
        rows: [
          ["프로젝트 버퍼(Project Buffer)", "Critical Chain\n끝에 배치\n안전·감시 영역\n행동 영역"],
          ["피딩 버퍼(Feeding Buffer)", "Non-Critical 끝\n착수 지연 방지"],
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["SPI", "EV/PV", "일정 성과 지표\n<1 일정 지연"],
          ["CPI", "EV/AC", "비용 성과 지표\n<1 예산 초과"],
          ["ETC", "(BAC−EV)/CPI", "잔여 추정 원가"],
          ["EAC", "AC+ETC", "종료시 발생 원가"],
          ["VAC", "BAC−EAC", "종료시 추가 원가"],
          ["BCWR", "BAC−EV", "잔여 업무량"],
          ["TCPI", "(BAC−EV)/(BAC−AC)", "완료 성과 지수"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["방법", "설명"],
        rows: [
          ["에스컬레이션(Escalation)", "PM 권한 밖 보고\nPMO 에서 관리"],
          ["회피(Avoid)", "위험 영향권에서\n목표 고립·변경"],
          ["전가(Transfer)", "제3자에게 이동\n보험·이행 보증"],
          ["완화(Mitigate)", "발생 가능성과\n영향 수준 낮춤"],
          ["수용(Accept)", "존재 인지 후\n조치 안 함\n수동·능동 수용"],
        ],
      },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "단계", "설명"],
        rows: [
          ["프리텍스트 태스크 단계", "무라벨 데이터", "프리텍스트 학습"],
          ["다운스트림 태스크 단계", "학습 특징 활용\n분류기 학습", "적은 레이블 적용\n새 데이터 대응"],
          ["파인튜닝 단계", "사전학습 가중치", "미세 조정 적용"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["Input 미니배치 평균/분산 계산", "피처별 분류\n미니배치 분리", "평균·표준편차\n배치 단위 로드"],
          ["BN층 활성화값/출력값 정규화", "Modify\n활성함수 산출", "입력값 수정 전달\n정규화 값 산출"],
          ["활성함수 은닉층 적용", "스케일·시프트\n입력 분포 확인", "변환값 기반 수행\n가중치 이상 판단"],
          ["Output 확인", "재수행 여부\n개선점 판단", "반복 여부 결정\n개선점 판단 전달"],
        ],
      },
    ...
    tables: [
      {
        ...
        rows: [
          ["숫자 K값 설정", "이웃 수 K 결정\n작으면 과적합", "탐색 이웃 범위\n크면 과소적합"],
          ["거리 측정방법 설정", "유클리드 맨하탄", "거리 기준 선택"],
          ["K개의 최근접 이웃 탐색", "K개 이웃 탐색", "샘플 최근접 탐색"],
          ["가장 많은 클래스에 속한 클래스에 할당", "다수결 결정", "최다 클래스 할당"],
          ["클래스 확정", "최종 클래스", "분류 결과 확정"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["시작", "전체 데이터\nLazy 학습", "데이터 일괄 수용\n지연 학습 방식"],
          ["Cluster K개 지정", "K값 파라미터", "군집 수 사전 입력"],
          ["초기 평균값 선정", "무작위 추출", "임의 객체 선정"],
          ["초기 평균값 기준으로 데이터 선별", "최근접 평균값", "근접 중심 배정"],
          ["최소 거리를 가진 데이터들로 그룹핑", "최소 거리 기반", "거리 기준 그룹핑"],
          ["평균값 재조정", "중심점 재계산\n3~5단계 반복", "군집 평균 갱신\n수렴까지 반복"],
          ["알고리즘 종료", "평균값 불변", "변화 없으면 완료"],
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        headers: ["절차", "키워드", "설명"],
        rows: [
          ["데이터 셋 로드", "분석 대상 준비", "PCA 데이터셋"],
          ["평균, 공분산 계산", "평균·편차\n공분산 행렬", "중심값 산출\n변수 관계 계산"],
          ["고유값, 고유 벡터 계산", "고유값·벡터", "데이터 최적 표현"],
          ["주성분 선택", "고유값 큰 순\n설명 분산 비율", "주성분 우선 선택\n개수 결정 기준"],
          ["변환(Transform) 수행", "회전·확장", "저차원 변환 예측"],
        ],
      },
      {
        caption: "주요수식",
    ...
    tables: [
      {
        ...
        headers: ["절차", "키워드", "설명"],
        rows: [
          ["데이터 전처리", "데이터 정규화", "학습 전 정규화"],
          ["산포행렬 계산", "간 산포 S(B)\n내 산포 S(W)", "클래스 간 행렬\n클래스 내부 행렬"],
          ["고유값, 고유 벡터 계산", "S(W) 역행렬\n고유값 계산", "S(B) 곱 연산\n고유벡터 산출"],
          ["변환(Transform) 수행", "고유벡터 이용\n회전·확장", "데이터셋 설명\n새 데이터 예측"],
        ],
      },
      {
        caption: "PCA와 LDA 비교",
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["문서 변환 & 저장", "문장 임베딩\n벡터 DB 저장", "로드·분할 파싱\n인덱싱 후 저장"],
          ["입력 쿼리 & 문서 검색", "입력 쿼리 처리\n문서 검색 수행", "검색용 쿼리 변환\n관련 스니펫 추출"],
          ["정보 증강(Information Augmentation)", "문서 맥락 통합\n증강 입력 형성", "쿼리+문서 결합\n추가 맥락 포함"],
          ["답변 생성", "Seq2Seq\nBART 등 모델", "증강 입력 제공\n응답 생성 처리"],
          ["출력 생성", "정제 및 형식화", "최종 응답 전달"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["AI 전략 수립", "고유 데이터 식별\n자동화 대상", "가치 소스 발굴\n효율 프로세스"],
          ["파일럿 프로젝트 실행", "조직 신뢰 확보\n모멘텀 생성", "혁신 기반 마련\n확산 동력 확보"],
          ["사내 AI 혁신팀 구축", "내부 혁신팀\n아웃소싱 지양", "자체 역량 육성\n장기 관점 운영"],
          ["AI 교육 제공", "역할별 교육", "직원 역량 강화"],
          ["내외부 커뮤니케이션", "내외부 소통\n전사 조정 보장", "의사소통 개선\n업무 정합 확보"],
          ["AI 전략 업데이트", "전략 주기 갱신\n혁신 지속 유지", "환경 변화 반영\n지속 개선 체계"],
        ],
      },
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["사전 준비", "도입 서비스 식별\n세부 항목·유형", "대상 서비스\n추가 활동 항목"],
          ["서비스 이용료 계산", "사용기간 결정\n가격표·견적서\n이용료 산정", "서비스 이용료"],
          ["커스터마이징 작업비용 계산", "비용 항목 식별\n가격표·견적서\n요구분석·설계\n데이터 구축", "커스터마이징작업비용"],
          ["구축·개발 비용 계산", "SW 개발·SI 식별\n기능점수·공수", "구축·개발 비용"],
          ["AI 서비스 도입 사업비 산정", "서비스 이용료 +\n커스터마이징 +\n구축·개발 비용", "도입 사업비"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        headers: ["구분", "절차", "설명"],
        rows: [
          ["테스트 대상 분석", "대상 시스템 식별", "식별 및 특징 분석"],
          ["테스트 대상 분석", "앱·프레임워크", "적용 대상 파악"],
          ["테스트 대상 분석", "네트워크 계층\n통신 프로토콜", "망 구간 대상\n규약 분석 수행"],
          ["테스트 대상 분석", "소스코드 분석", "역공학 병행 수행"],
          ["입력 값 선정", "미디어 파일\n다큐먼트 파일", "오류 유발 입력\n문서 형식 값"],
          ["입력 값 선정", "프로토콜 값\n비정상 입력", "규약 기반 값\n예외 값 선정"],
          ["테스트 케이스 생성", "제너레이션\n뮤테이션", "신규 TC 생성\n기존 값 변형"],
          ["테스트 케이스 생성", "FuzzBox\nSeed 수집", "퍼징 도구 활용\n시드 값 확보"],
          ["테스트 실행", "TC 투입 실행\n명령행 도구", "프로그램 구동\nCLI 기반 실행"],
          ["시스템 동작 모니터링", "시스템 로그\n커널 로그", "동작 상태 감시\n장애 흔적 확보"],
          ["시스템 동작 모니터링", "크래시 콜스택", "문제 발생 기록"],
          ["문제 분류 및 해결", "발생 항목 점검\n원인 분석", "문제 분류 수행\n결함 코드 수정"],
          ["문제 분류 및 해결", "널 포인터 참조", "잘못된 참조 오류"],
          ["문제 분류 및 해결", "0 나눗셈 오류", "산술 예외 발생"],
          ["문제 분류 및 해결", "버퍼 오버플로", "메모리 초과 기록"],
        ],
      },
      {
        caption: "유형",
    ...
    tables: [
      {
        ...
        headers: ["구성", "구성 요소", "설명"],
        rows: [
          ["Scope", "문서 적용범위", "TR 범위 규정"],
          ["Normative references", "규범적 참조", "참조 표준 명시"],
          ["Terms, definitions and abbreviated terms", "용어·정의", "약어 정의 수록"],
          ["Introduction to AI and Testing", "AI 개요 소개\n테스트 맥락", "AI 기반 시스템\n맥락별 시험법"],
          ["AI System characteristics", "25010 품질\nAI 고유 특성", "특성 일부 적용\nAI만의 특성"],
          ["Introduction to the testing of AI-based systems", "AI 구성요소\n테스트 방법", "기존 SW 결합\n동일 결함 대응"],
          ["Testing and QA of ML systems", "ML 품질보증", "시험 기회 설명"],
          ["Black-box testing of AI-based systems", "블랙박스 시험", "AI 시스템 대상"],
          ["White-box testing of neural networks", "화이트박스", "신경망 시험법"],
          ["Test environments for AI-based systems", "테스트 환경\nML 격리 시험", "일반 환경 유사\n개발 FW 내 수행"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["구분", "절차", "설명"],
        rows: [
          ["분석 대상 및 범위 정의", "명세서·설계서", "대상·범위 정의"],
          ["시스템 위험 또는 사고 정의", "위험·사고 정의", "시스템 수준 정의"],
          ["초기 이벤트 정의", "초기 이벤트 정의", "트리 시작점 배치"],
          ["Event Tree 전개", "중간 이벤트 도출\n성공/실패 분기", "초기→최종 결과\n트리 전개 완성"],
          ["결과 리스크 파악", "발생 가능성 계산", "시나리오별 평가"],
          ["위험 경감 대책 수립", "안전조치 도출", "예방·개선 계획"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["절차"],
        rows: [
          ["측정 유형 결정 → 2. 측정 범위와 어플리케이션 경계 식별 → 3. 데이터 기능 측정 · 4. 트랜잭션 기능 측정 → 5. 미조정 기능점수 결정 → 6. 조정인자 결정 → 7. 조정 기능점수 결정"],
        ],
      },
      {
        caption: "상세 내역",
    ...
    tables: [
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["클라우스 서비스 모델 유형", "서비스 모델 유형", "제공 범위 상이"],
          ["기존 IT 운영 관리체계 수준", "운영 관리체계", "기존 수준 점검"],
          ["현행 업무 위험 수용 수준", "위험 수용 수준", "업무 위험 판단"],
          ["클라우드 적재 데이터의 통합적 가치", "데이터 통합 가치", "적재 가치 평가"],
          ["클라우드 적재 데이터의 내부보안등급", "내부 보안등급", "등급별 적재 제한"],
          ["클라우드 공유 데이터의 준거성 의무", "준거성 의무", "공유 데이터 규제"],
          ["클라우드 서비스 제공자 위험", "제공자 위험", "CSP 종속 위험"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["구분", "구성요소", "설명"],
        rows: [
          ["종합의견", "작성 시점 전제", "보고서 전제조건"],
          ["종합의견", "감리의견 총괄", "사업 의견 총정리"],
          ["종합의견", "개선권고 요약\n중요도·협조", "유형별 사항 정리\n협조 필요 표시"],
          ["감리영역별 점검결과", "사업관리·품질", "항목별 상세 결과"],
          ["감리영역별 점검결과", "응용시스템 영역", "항목별 상세 결과"],
          ["감리영역별 점검결과", "DB 구조·보안", "항목별 상세 결과"],
          ["별첨", "감리계획서 첨부", "수행 전 제출 문서"],
        ],
      },
      {
        caption: "개선권고 유형·시점",
    ...
    tables: [
      {
        ...
        headers: ["구분", "원리", "설명"],
        rows: [
          ["비교 정렬", "원소 간 비교", "비교만으로 정렬"],
          ["분할과 정복", "Pivot 분할", "분할 리스트 정렬"],
          ["재귀적 수행", "분할·정렬 반복", "부분 리스트 재귀"],
    ...
    tables: [
      {
        ...
        rows: [
          ["Parity bit 수 결정", "2^p ≥\nd+p+1", "패리티 수 결정\n데이터 4면 3개"],
          ["Parity bit 위치 결정", "1 2 4 8 위치\n2의 승 자리", "패리티 삽입 위치\n거듭제곱 자리"],
          ["Parity bit 값 결정", "짝수 패리티\nP1~P8 결정", "해당 비트 검사\n값 각각 결정"],
          ["데이터와 패리티 비트 위치 지정", "데이터 88 배치", "비트 위치 지정"],
          ["해밍 코드 생성", "1 위치 확인\nXOR 연산", "7 9 11 위치\n결과 0101"],
          ["해밍 코드 생성 결과", "XOR 0101", "생성 코드 완성"],
        ],
      },
      {
        caption: "오류 검출 및 정정",
        headers: ["단계", "키워드", "설명"],
        rows: [
          ["패리티 비트 영역 검사", "P1~P8 검사\n짝수 패리티", "수신 패리티 검사\n0101 값 확인"],
          ["정상 전송 검증", "검사 결과 0", "정상 전송 확인"],
          ["오류 검출", "0 아닌 결과", "전송 오류 발생"],
          ["오류 정정", "검사값 나열\n2진→10진", "오류 위치 산출\n해당 비트 반전"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["원칙"],
        rows: [
          ["암호 알고리즘은 공개되어도 안전해야 한다"],
          ["시스템의 보안은 암호 키의 비밀성에 의존해야 한다"],
          ["키가 유출되었을 경우 쉽게 변경할 수 있어야 한다"],
          ["시스템은 실용적이어야 하며, 유지보수가 가능해야 한다"],
        ],
      },
    ],
    notes: [
    ...
    tables: [
      {
        ...
        rows: [
          ["개발환경 침투", "공급사 개발환경"],
          ["변조 업데이트 파일 유포", "업데이트 파일"],
          ["개인사용자 및 기업 내부 확대", "개인 사용자 PC 및\n서버"],
          ["타겟설정 범위확대", "내부 타 서버"],
          ["추가 악성코드 감염", "외부 영향\nPC/서버"],
        ],
      },
    ...
    tables: [
      {
        ...
        rows: [
          ["URL 변조 요청", "네트워크 스캔\n통해 SSRF 취약점\n웹서버 발견, URL\n변조 요청"],
          ["백엔드로 요청 전달", "웹 서버는\n방화벽이 있는 Private\nNetwork 서버 요청 전달"],
          ["내부 주요 정보 요청", "Private Network의 서버가\n내부 작업(DB 등)\n수행"],
          ["백엔드 결과 응답", "공격자에게\n필요한 정보 전송"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["구분", "절차", "설명"],
        rows: [
          ["Message Digest 생성", "해시함수 축약", "메시지 요약 생성"],
          ["전자서명 생성", "송신자 개인키\n전자서명", "MD 암호화 수행\n서명 데이터 생성"],
          ["비밀키로 암호문 생성", "비밀키 대칭키\n전자서명 메시지", "암호문 생성 사용\n공개키 인증서"],
          ["전자봉투 생성", "수신자 공개키", "비밀키 암호화"],
          ["암호문과 전자봉투 전송", "비밀키 암호문\n전자봉투", "암호화 전자서명\n수신자에게 전송"],
        ],
      },
      {
        caption: "전자봉투 수신 절차",
        headers: ["구분", "절차", "설명"],
        rows: [
          ["전자봉투 복호화", "수신자 개인키", "비밀키 획득"],
          ["암호문 복호화", "비밀키 대칭키\n암호문 복호화", "전자서명 메시지\n송신 인증서 획득"],
          ["전자서명 복호화", "송신자 공개키\n인증서 내 키", "전자서명 복호화\n메시지 요약 획득"],
          ["무결성 검증", "해시값 MD 비교", "무결성 검증 완료"],
        ],
      },
    ],
    notes: [
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["기획·설계 단계", "대체 수단 마련\n영향평가 수행", "선택 수단 제공\n침해 위험 평가"],
          ["수집 단계", "적법한 수집\n위·변조 대책", "동의 기반 수집\n위조 탐지 대응"],
          ["수집 단계", "전송구간 보호", "입력 시 구간 보호"],
          ["이용·제공 단계", "목적 범위 이용\n통제 수단 제공", "동의 범위 준수\n주체 통제 보장"],
          ["이용·제공 단계", "입력 단말 처리", "수집 단말 내 처리"],
          ["보관·파기 단계", "저장 암호화\n원본정보 분리", "암호화 보관\n분리 보관 적용"],
          ["보관·파기 단계", "생체정보 파기", "파기 절차 이행"],
          ["상시 점검", "처리방침 공개\n취급자 관리", "상시 점검 공개\n관리·감독 수행"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["디지털 자산 발견", "네트워크 연계\n모든 자산 식별", "클라우드·저장소\n웹 앱·API·인증서\n프로비저닝 IP\nOSINT·다크웹"],
          ["자산 식별 및 분류", "자산 유형·특성\n중요도 따라 분류", "자산 관리자\n비즈니스 영향도\n속성 분류"],
          ["지속적인 보안 모니터링", "CVSS·CWE 활용\n위험도 산정", "SSL/TLS·MITM\n악성코드 공격\n불필요 포트"],
          ["악성자산 및 사고 모니터링", "보안사고 대응\n추가 공격 시도\n피해범위 파악", ""],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["조직 사이버보안 관리", "사이버보안 정책\n보안 문화 조성", "정책 수립·공표\n조직 문화 정착"],
          ["조직 사이버보안 관리", "정보 공유·사후\n보안 도구 관리", "공유·사후 관리\n도구 통제 수행"],
          ["조직 사이버보안 관리", "정보 보안 관리\n조직 보안 감사", "보안 정보 관리\n감사 수행 점검"],
          ["프로젝트 사이버보안 관리", "책임자 선정\n보안 계획 수립", "담당자 지정\n활동 계획 수립"],
          ["프로젝트 사이버보안 관리", "보안 수정 작업\n재사용·불필요", "변경 작업 반영\n요소 식별 제거"],
          ["프로젝트 사이버보안 관리", "사이버보안 사례\n평가·내역 공개", "근거 사례 관리\n평가·공개 수행"],
          ["분산 사이버보안 활동", "공급망 이해관계\n업무 분담·책임", "능력 평가 수행\n책임 소재 확립"],
          ["지속적인 사이버보안 활동", "보안 모니터링\n이벤트 평가", "상시 감시 수행\n이벤트 영향 평가"],
          ["지속적인 사이버보안 활동", "취약점 분석\n취약점 관리", "취약성 도출\n조치·이력 관리"],
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["정보보호 인력 현황", "보호 전담인력\n인력 비율", "전담 인원 수\n인력 비중 공시"],
          ["정보보호 인력 현황", "CISO 지정\nCPO 지정", "보호책임자 지정\n개인정보 책임자"],
          ["정보보호 관련 인증·평가·점검 등에 관한 사항", "인증·평가 점검", "보유 현황 공시"],
          ["정보통신서비스를 이용하는 자의 정보보호를 위한 활동 현황", "이용자 보호 활동", "활동 현황 공시"],
        ],
      },
    ],
    notes: [
