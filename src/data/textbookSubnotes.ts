    ...
    tables: [
      {
        ...
        headers: ["기능", "내용"],
        rows: [
          ["결함감지", "Fault Detection, 시스템 내\n결함 발생 및 내용\n감지"],
          ["결함진단", "Fault Diagnosis, 결함의\n원인/위치/파급효과\n판단"],
          ["결함통제", "Fault Isolation, 결함으로\n인한 오류 파급\n차단"],
          ["결함복구", "Fault Recovery &\nReconfiguration 결함요소\n제거, 시스템\n재구성"],
        ],
      },
      {
      ...
      },
      {
        ...
        headers: ["기법", "설명"],
        rows: [
          ["Rollback (Undo)", "트랜잭션 ACID\n보장"],
          ["Log File 활용 회복, Check Point, Shadow Paging", "DB 회복 기법으로\n활용"],
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        headers: ["구분", "설명"],
        rows: [
          ["Kick (Clear)", "주기적으로 Watchdog에게\n알려주는\nAlive신호"],
          ["Reset", "워치독 타이머가\nMCU를\n초기화하는\n시그널"],
          ["Clock", "Clock 디바이스를\n동작시키는 외부\n클럭 소스(Clock Source)"],
          ["Timeout", "MCU의 Task가 정상\n동작하지 않음을\n알려주는 신호"],
        ],
      },
      {
        caption: "동작 과정",
    ...
    tables: [
      {
        ...
        rows: [
          ["용량(Capacity)", "상위 레벨에서\n하위 레벨로\n갈수록 용량이\n증가"],
          ["접근 시간(Access Time)", "상위 레벨에서\n하위 레벨로\n갈수록 접근\n시간이 증가"],
          ["비트당 비용(Cost per Bit)", "상위 레벨에서\n하위 레벨로\n갈수록 비트당\n비용이 감소"],
          ["성능(Performance)", "하위 레벨 메모리\n접근 빈도가\n낮을수록 전체\n시스템 성능 향상"],
        ],
      },
    ],
    notes: [
    ...
    tables: [
      {
        ...
        headers: ["구분", "설명"],
        rows: [
          ["원인", "Locality를 고려하지 않은\nFIFO의 한계"],
          ["영향", "1) Page Fault의 증가로 인한\n성능 저하 / 2) Threshing 발생"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["종류", "설명"],
        rows: [
          ["① 경성 실시간 시스템(Hard Real-Time)", "정한 시간내에\n반드시 완료해야\n하는 실시간\n시스템"],
          ["② 연성 실시간 시스템(Soft Real-Time)", "시간적 제한이\n다소 약한 형태의\n실시간 시스템"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["원칙", "영역"],
        rows: [
          ["스튜어드쉽 (Stewardship)", "진실성, 케어,\n신뢰성,\n규정준수"],
          ["팀 (Team)", "권한, 책임"],
          ["이해관계자 (Stakeholders)", "회의, 의사소통,\n적극적 협업"],
          ["가치 (Value)", "프로젝트\n정당성,\n사업전략"],
          ["시스템 사고 (System thinking)", "사전 예방적\n통합관리,\n외부검토"],
          ["리더쉽 (Leadership)", "동기부여,\n갈등관리,\n공동목표일치"],
          ["조정 (Tailoring)", "기존 방법론\n최적화, 생산성\n향상"],
          ["품질 (Quality)", "성능, 만족도,\n회복력, 신뢰성"],
          ["복잡성 (Complexity)", "인간행동,\n시스템동작,\n기술혁신"],
          ["위험 (Risk)", "비용 효율적,\n관련 이해관계자\n합의"],
          ["적응성과 복원력 (Adaptability and Resiliency)", "지속적인 학습과\n개선, 짧은\n피드백"],
          ["변화(Change)", "변경관리, 협업"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        headers: ["원칙", "낭비 요소"],
        rows: [
          ["Eliminate Waste (낭비 제거)", "미완성 작업 (Partial Done\nWork)"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["기법", ""],
        rows: [
          ["Fine-tuned CNN(파인튜닝)", "Pre-trained\nModel(프리트레인드\n모델)"],
          ["Domain Adaptation(도메인 적응)", "Layer Re-use(레이어\n재사용)"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["구분", "설명"],
        rows: [
          ["① LLM의 가중치(Weight)는 1.5~3B", "모델을 GPU에\n로드 하는 것도 큰\n비용이 발생"],
          ["② 모델의 Forward, Backward, 가중치, gradient 모두 GPU에 저장", "가중치 수 ×\n2~3배의 GPU vram 필요"],
        ],
      },
      {
        caption: "원리",
        headers: ["구분", "설명"],
        rows: [
          ["Pretrained Weights (W ∈ R^d×d)", "Query, Key, Value, Output\nlayer 차원(d×k). 학습 시\nFreeze — Weight update 안됨\n→ vram을 save"],
          ["LoRA A Layer", "차원: d×r, A = N(0, σ²)로\n초기화"],
          ["LoRA B Layer", "차원: r×k, B = 0으로 초기화"],
          ["결과", "Pretrain Model에 weight\n더함 — LoRA A layer, LoRA B\nlayer의 weight만 업데이트"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["인식(Perceive)", "데이터 수집,\n특징 추출"],
          ["추론(Reason)", "LLM 기반 추론, RAG(검색 증강\n생성)"],
          ["행동(Act)", "목표 설정, 자율\n계획, API 통합"],
          ["학습(Learn)", "피드백 루프,\n데이터 플라이휠"],
          ["성숙도 및 관리", "SaaS 통합, IoT 디바이스\n통합, 자율적\n의사 결정, 보안\n및 거버넌스"],
        ],
      },
      {
        caption: "사례",
    ...
    tables: [
      {
        ...
        headers: ["값", "설명"],
        rows: [
          ["왜도 < 0", "오른쪽으로\n치우진 분포 (Negative\nSkewness, right-modal)"],
          ["왜도 = 0", "비대칭성 정도가\n정규 분포와\n유사한 분포"],
          ["왜도 > 0", "왼쪽으로 치우진\n분포 (Positive Skewness,\nleft-modal)"],
        ],
      },
      {
        caption: "첨도(뾰족함)",
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["조건", "설명"],
        rows: [
          ["불편성(Unbiasedness)", "기대값이 실제\n모수 값과 동일"],
          ["효율성(Efficiency)", "불편한 추정량\n중에서 분산이\n가장 작은 추정량"],
          ["일치성(Consistency)", "표본의 크기가\n커질수록\n추정량이 실제\n모수에 수렴"],
          ["충분성(Sufficiency)", "통계량만으로도\n모수에 대한\n충분한 정보를\n제공"],
        ],
      },
      {
        caption: "불편추정량",
    ...
    tables: [
      {
        ...
        headers: ["표준", "설명"],
        rows: [
          ["ISO/IEC 25023", "SW 제품 품질\n측정에 관한\n국제표준"],
          ["ISO/IEC 25051", "SW 제품 품질\n요구사항과\n시험에 관한\n국제표준"],
          ["ISO/IEC 25041", "SW 제품 품질\n평가에 관한\n국제표준"],
        ],
      },
      {
        caption: "품질 특성(평가 항목)",
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["복잡도 = 폐구간 + 1", "폐쇄영역(enclosed areas) +\n1"],
          ["복잡도 = 의사결정 수 + 조건 수 + 1", "의사결정 수: if-then-else,\ndo while, case(각각이 하나)\n/ 조건 수: and, or, not 등"],
        ],
      },
      {
        caption: "복잡도 분석",
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["Timestamp", "SBOM이\n마지막으로\n업데이트된 날짜\n및 시간(ISO 8601)"],
          ["Supplier Name", "SW 공급업체의\n이름 또는 기타\n식별자"],
          ["Component Name", "SW 구성요소 이름\n또는 식별자"],
          ["Version String", "SW Version 정보 (Semantic\nVersioning)"],
          ["Component Hash", "SW 컴포넌트 해시\n값을 통한 무결성\n증빙"],
          ["Unique Identifier", "고유한 Namespace 및 고유\n식별자 생성"],
          ["Relationship", "SBOM 구성 요소\n간의 종속성 및\n연간 관계 표현"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "설명"],
        rows: [
          ["분할", "5 1 6 4 8 3 7 9 2 → (5 1 6 4 8) (3 7 9 2)\n→ (5 1 6)(4 8)(3 7)(9 2) → (5\n1)(6)(4)(8)(3)(7)(9)(2)\n→ (5)(1) 까지 분할"],
          ["정복", "(5)(1) → (1 5) → (1 5 6)·(4\n8)·(3 7)·(2 9) → (1 4 5 6 8)·(2\n3 7 9) → 1 2 3 4 5 6 7 8 9"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["활용", "설명"],
        rows: [
          ["데이터 압축", "DEFLATE (PKZIP의\n알고리즘)에\n적용"],
          ["멀티미디어 코덱", "JPEG, MP3 등의 기본\n알고리즘으로\n활용"],
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["단계", "설명"],
        rows: [
          ["1단계", "<S>에서 I(0.4), the(0.3) 두\n후보 유지"],
          ["2단계", "I → am(0.8) / do(0.5), the →\ncat(0.4) / dog(0.6) 확장 후\n상위 2개 유지"],
          ["3단계", "am → cat(1.0) / dog(0.8),\ndog → barked(0.9) /\nsleep(0.7)"],
          ["최종", "\"I am cat\"(1.0 선택) vs \"the\ndog barked\"(0.9 미선택) →\n확률이 가장 높은\n\"I am cat\" 선택"],
        ],
      },
      {
        caption: "활용 사례",
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["특징", "설명"],
        rows: [
          ["0-RTT/1-RTT 연결", "UDP 기반 이전\n연결의 캐시된\n자격 증명 사용"],
          ["HOL 블로킹 해결", "다중 Stream 제공 및\n개별 Stream 내에서\n흐름 제어 제공"],
          ["멀티 스트리밍 전송", "멀티 플렉싱된\n스트림 통해\n트래픽 손실\n최소화"],
          ["Selective ACK(SACK)", "오류 발생시\n재전송 통해 에러\n복구"],
          ["Seamless Connection", "Connection ID 사용, IP·Port\n변경 시에도\n지속적 연결 유지"],
          ["보안성 강화", "두 번째 패킷부터\n0-RTT, 1개의 패킷 전달을\n통해 암호화된\n연결 설정함"],
        ],
      },
      {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["API's", "응용과 SCTP 사이\n인터페이스"],
          ["SCTP Transport Service", "SCTP 전송\n서비스(다중 IP\n주소 사용)"],
          ["IP Network Service", "IP 네트워크\n서비스 — SCTP Node A ↔\nNetwork Transport ↔ SCTP\nNode B"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["자가구축", "On-Premise 형"],
          ["이음 5G 사업자", "On-Premise 형 / 5G Core CP\n공유형 / 5G Core 전체\n공유형"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["메커니즘 측면", "Nested Loop Join, Sort Merge\nJoin, Hash Join"],
        ],
      },
      {
        caption: "조인 메커니즘",
    ...
    tables: [
      {
        ...
        rows: [
          ["메타데이터 수집 및 분석", "사전 수집\n테이블, 컬럼\n분석"],
          ["프로파일링 대상 및 유형선정", "대상업무 테이블\n선정, 분석유형\n결정"],
          ["프로파일링 수행", "누락값,\n비유효값,\n무결성 위반사항\n분석"],
          ["프로파일링 결과 리뷰", "프로파일링 결과\n취합 및 결과 리뷰"],
          ["프로파일링 결과 종합", "결과물 취합,\n결과보고서 작성"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["원인", "설명"],
        rows: [
          ["Business Pressure", "Time-To-Market 무리한\n일정, 적은 예산\n진행"],
          ["Low Technology Maturity", "잘못된 아키텍처\n구조, 개발자의\n경험·협업 부족"],
          ["Frequent Requirement Changes", "코드 복잡성\n상승, 낮은\n테스트 커버리지\n발생"],
          ["Lack of Experts", "부족한 테스팅 및\n문서화,\n스파게티 코드로\n품질 저하"],
        ],
      },
      {
        caption: "기술 부채의 유형",
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "유형"],
        rows: [
          ["구축 유형", "Mirror Site, Hot Site, Worm\nSite, Cold Site"],
          ["운영형태 유형", "상호계약형,\n공동이용형,\n외부위탁형,\n독자구축형"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["평가(Evaluate)", "비즈니스상의\n내외부적 환경을\n고려하여 평가"],
          ["지휘(Direct)", "비즈니스 목표를\n이루기 위한 계획\n및 정책 구현"],
          ["감독(Monitoring)", "정책 준수 및\n계획에 따른 성과\n모니터링"],
          ["이해관계자 참여(Engage Stakeholders)", "상호작용으로\nIT거버넌스\n효과성 극대화"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "내용"],
        rows: [
          ["자금의 바람직한 이동경로", "Cash Cow(₩)에서 나온\n자금을 Question Mark·Star\n방향으로 투자"],
          ["사업부의 바람직한 성장경로", "Question Mark → Star → Cash\nCow 방향으로 성장(Dog는\n철수)"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["단계", "설명"],
        rows: [
          ["Acquisition(획득)", "신규 고객이\n생기는 것"],
          ["Activation(활성화)", "고객이 처음으로\n서비스의 '주요\n기능'을 사용"],
          ["Revenue(매출)", "고객이 우리\n서비스에 금액을\n지불함"],
          ["Retention(리텐션)", "지속적으로\n고객이 서비스를\n이용하거나\n제품을 재구매함"],
          ["Referral(추천)", "서비스를 이용한\n고객이 만족하여\n주변에 추천함"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["조직", "보안 전담 조직\n구성, CISO 기반 APT 대응 TFT"],
          ["규정", "정책, 표준,\n지침의 현행화, Compliance\n보안 프로세스\n구축"],
          ["보안의식", "APT 위험성 교육,\n홍보, 감시, 내부\n감시"],
          ["시스템", "계층적 방어, 망\n분리"],
          ["네트워크", "Inbound Malicious Content\n탐지 기술, Outbound\nCallback Traffic 기술, Port\nScanning"],
          ["데이터", "암호화, DLP, Log 분석, Log\n시계열 분석, SIEM"],
        ],
      },
    ],
    notes: [
    ...
    tables: [
      {
        ...
        rows: [
          ["1. URL 변조 요청", "네트워크 스캔\n통해 SSRF 취약점\n웹서버 발견, URL\n변조 요청"],
          ["2. 백엔드로 요청 전달", "웹 서버는\n방화벽이 있는 Private\nNetwork 서버 요청 전달"],
          ["3. 내부 주요 정보 요청", "Private Network의 서버가\n내부 작업(DB 등)\n수행"],
          ["4. 백엔드 결과 응답", "공격자에게\n필요한 정보 전송"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["절차", "설명"],
        rows: [
          ["수집", "End Point 포함한 모든 데이터\n수집"],
          ["가설 수립", "ATT&CK·사이버 킬 체인\n모델 활용, 발생\n가능 가설 수립"],
          ["헌팅", "수립된 가설을\n기반으로 현재\n환경을 반복적\n분석 수행"],
          ["탐지자 개발", "위협 요소 식별을\n위한 행동을\n프로그래화하여\n자동화"],
          ["위협 탐지", "악성이 가거나\n위협이 될 것 같은\n행동 발견"],
          ["조사 및 대응", "탐지된 위협에\n대한 분석 및 분석\n내용에 대한 대응\n진행"],
    ...
    tables: [
      {
        ...
        headers: ["구성요소", "핵심기술"],
        rows: [
          ["신뢰 실행 환경(TEE)", "격리(isolation) 실행,\nIntel SGX, Intel TDX·AMD\nSEV, ARM TrustZone"],
          ["실행증명(Attestation)", "원격(remote) 실행증명,\n내장형\n시스템같이\n단순한 시스템, TrustZone"],
          ["주변장치(peripheral)", "GPU·FPGA 가속기, Smart NIC,\n암호화, 머클\n트리 구조체 유지"],
    ...
    tables: [
      {
        ...
        rows: [
          ["1~4", "범위·규범\n참조들·용어와\n정의·약어·일반"],
          ["5", "PIMS-specific\nrequirements related to\nISO/IEC 27001(27001 관련\nPIMS 요구사항)"],
          ["6", "PIMS-specific guidance\nrelated to ISO/IEC\n27001(27001 관련 PIMS 지침)"],
          ["7", "Additional ISO/IEC 27002\nguidance for PII\ncontrollers(PII 통제자에\n대한 추가 27002 지침)"],
          ["8", "Additional ISO/IEC 27002\nguidance for PII\nProcessors(PII 처리자에\n대한 추가 27002 지침)"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["측면", "기술요소"],
        rows: [
          ["보안 측면", "Cart Mandate, Intent\nMandate, Payment Mandate,\nVerifiable Credential"],
          ["연동 측면", "Agent to Agent Protocol,\nModel Context Protocol, A2A\nx402 Extension, Python\nLanguage"],
          ["거래 측면", "X402 Protocol, Smart\nContract, EVM Network,\nSolana Network,\nDistributed Ledger"],
          ["결제 측면", "Stablecoin, Credit Card,\n계좌이체"],
        ],
      },
    ],
    notes: [
