    ...
    tables: [
      {
        ...
        rows: [
          ["기본 구성", "Usecase", "제공해야 하는\n서비스·행위", "타원"],
          ["기본 구성", "Actor(행위자)", "사용자가 수행\n하는 역할", "졸라맨"],
          ["기본 구성", "시스템(System)", "전체 시스템\n영역 표현", "사각 테두리"],
          ["관계 표현", "연관(Association)", "Usecase·Actor\n관계 표현", "실선"],
          ["관계 표현", "확장(Extend)", "특별한 조건\n만족 시 수행", "«extend»\n점선 화살표"],
          ["관계 표현", "포함(Include)", "다른 Usecase가\n반드시 수행", "«include»\n점선 화살표"],
          ["관계 표현", "일반화(Generalization)", "상위 기능·역할\n상속 받음", "속이 빈 삼각형"],
          ["관계 표현", "그룹화(Grouping)", "여러 Usecase\n단순화", "Package"],
        ],
      },
      {
        caption: "작성 절차",
    ...
    tables: [
      {
        ...
        rows: [
          ["보안 데이터 수집", "NW·엔드포인트\n앱 등", "NW·엔드포인트\n앱 등", "NW·엔드포인트\n앱 등"],
          ["보안 데이터 분석", "위협 탐지", "탐지 및 대응", "계열 분석\nAI/ML"],
          ["위협 탐지", "이벤트 기반", "이벤트 기반", "이벤트 계열 분석"],
          ["위협 대응", "전문가 주도", "자동화", "자동화"],
          ["장점", "다양한 데이터\n수집·분석", "운영 효율 향상\n업무 부담 감소", "포괄적·정밀\n탐지·대응"],
    ...
    tables: [
      {
        ...
        headers: ["Part", "구분", "세부"],
        rows: [
          ["Part 1", "General(일반)", "용어·컨셉·모델\n약어 사전\n적합 Metric\n7개 FR 정의"],
          ["Part 2", "Policy & Procedure", "보안 프로그램\n관리 가이드\n패치 관리\n공급업체 준수"],
          ["Part 3", "System(시스템)", "IACS 보안 기술\n영역·전송 수준\n시스템 요구사항"],
          ["Part 4", "Component", "제품 개발 요건\nIACS 컴포넌트\n7개 FR 상세"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["개념", "보안 등급 기반\n관리자가 설정", "소유자가 권한\n부여, 유연성↑", "역할(Role) 기반\n접근 제어", "속성 기반\n동적 접근 통제"],
          ["주체의 권한", "권한 변경 불가", "파일 권한 부여", "역할 지정 시\n권한 부여", "조건 충족 시\n접근 가능"],
          ["보안 강도", "높음(엄격)", "낮음(조정 가능)", "중간~높음", "높음(동적 제어)"],
          ["대표 구현", "BLP·BIBA·만리장성\nClark-Wilson", "접근제어 행렬\nACL·Capability", "역할 기반 권한", "사용자·리소스\n환경 속성"],
          ["적용 사례", "군사·정부기관", "기업 파일 공유\n상용 DBMS", "기업·금융 조직", "클라우드·IoT\n의료 동적 보안"],
        ],
      },
      {
        caption: "접근 제어 원칙",
