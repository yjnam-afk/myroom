  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["해결방안", "키워드", "설명"],
        rows: [
          ["예방 (Prevention)", "상호배제 비선점\n점유대기 환형", "조건 하나 부정\n발생 원천 차단"],
          ["회피 (Avoidance)", "안전 상태 유지\n은행원 알고리즘", "불안정 상태 회피\n선언간선 그래프"],
          ["발견 (Detection)", "감시 알고리즘\n자원할당 그래프", "교착 상태 검사\n대기 그래프 탐지"],
          ["회복 (Recovery)", "순차 Kill\n종료 비용 최소", "해소까지 제거\n순위 진행 복귀"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        headers: ["항목", "키워드", "설명"],
        rows: [
          ["Available", "길이 m 벡터", "가용 자원 k개"],
          ["Max", "n×m 행렬", "Max 최대 요청"],
          ["Need", "n×m 행렬\nMax−할당량", "Need 필요량\n완료까지 필요 수"],
          ["Allocation", "n×m 행렬", "현재 할당 자원 수"],
        ],
      },
      {
        caption: "안정상태",
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["프로세스 상태", "프로세스 상태\n상태 레지스터", "생성 준비 실행\n대기·중단 표시"],
          ["프로그램 카운터", "다음 명령 주소", "PC 레지스터"],
          ["레지스터 저장 영역", "누산기·인덱스\n프로그램 카운터", "범용·조건 코드\n함께 저장·복귀"],
          ["프로세서 스케줄링 정보", "우선순위 포인터", "스케줄 매개변수"],
          ["계정 정보", "계정 정보\n사용 시간", "프로세스 번호\n실제·상한 시간"],
          ["입출력 상태 정보", "할당 I/O 장치\n개방 파일 목록", "장치 리스트\n열린 파일 정보"],
          ["메모리 관리 정보", "경계 레지스터\n페이지 테이블", "상한·하한 정의\n세그먼트 테이블"],
        ],
    ...
    tables: [
      {
        ...
        headers: ["구조", "키워드", "설명"],
        rows: [
          ["부트 블록(Boot Block)", "부트스트랩 코드", "OS 부트 초기화"],
          ["슈퍼 블록(Super Block)", "메타데이터 저장\n가용 블록 목록", "크기·블록 수\n다음 블록 색인"],
          ["아이노드 (i-node)", "파일 정보 구조", "모든 정보 보유"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["작업분류체계 사전(WBS Dictionary)", "작업패키지 상세\n원가·산출물", "내용 자원 일정\n완료·인수 기준"],
          ["작업분류체계 코드(Code of Account)", "고유 식별자", "WBS ID 부여"],
          ["통제 계정(Control Account)", "작업 패키지 묶음", "한 통제계정 연결"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["계획 단계", "기능적 기준선", "계획서 개발표준"],
          ["요구분석 단계", "분배적 기준선", "요구정의 흐름도"],
          ["설계 단계", "설계 기준선", "화면 명세 ERD"],
          ["개발(구현) 단계", "시험 기준선", "코드 단위시험"],
          ["시스템 통합 및 테스트 단계", "제품 기준선", "통합 시스템시험"],
          ["설치 및 운영 단계", "운용 기준선", "지침서 이관소스"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ["목적", "품질보증 평가\n공정성·투명성", "복수 PJT 관리\n자원·일정 감시"],
          ["역할", "기술적 품질검토", "경영·관리 참여"],
          ["효과", "위험 대응 제시\n산출물 품질향상", "위험 조기 식별\nIT 전략 연계"],
          ["관점", "독립적 제3자", "발주자 관점"],
          ["법적 근거", "5억 이상 의무", "공공 PMO 의무"],
          ["법령", "전자정부법\n57조 의무", "전자정부법\n64조 권고"],
          ["수행조직", "감리법인 수행", "컨설팅 SI 업체"],
          ["주요 산출물", "감리계획서\n결과보고서", "요구사항 정의서\n관리 계획서"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["요구사항 변경관리 (CMMi L2 PA)", "확인·검증", "기대 요구 부합"],
        ],
      },
      {
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["아키텍처 설계", "이해관계자 파악", "관계자별 뷰 정의"],
          ["아키텍처 설계", "아키텍처 스타일", "MVC·계층 등"],
          ["아키텍처 설계", "배경도 작성\nSAD 기술", "관점별 도식 작성\n아키텍처 명세서"],
          ["검증 및 승인", "요구 만족도 평가\n품질속성 관계", "적합성 평가\n성능·보안 등"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["단계", "키워드", "설명"],
        rows: [
          ["A. 통합(Integration)", "브랜칭·병합\nVCS 활용", "마스터 이동 과정\nGit 등 도구"],
          ["B. 지속적 통합(Continuous Integration)", "자동 빌드 수행\n초기 테스트", "변경 자동 반영\nCI 도구 이용"],
          ["C. 빌드 시스템(Build System)", "명세 파일 관리\nMaven 이용", "바이너리 생성\n빌드 도구 사용"],
          ["D. 코드형 인프라(IaC, Infrastructure-as-Code)", "IaC 자동화\n구성 도구 이용", "서버 환경 생성\nChef 등 활용"],
          ["E. 배포(Deployment)", "릴리즈 준비\n카나리 전략", "서버 전송 제출\nA/B 테스트"],
          ["F. 릴리즈(Release)", "사용자 공개\n신버전 게시", "최종 이용 가능\nDNS 변경 반영"],
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["NLP", "발화 문장 품사", "명사·동사 인식"],
          ["NLP", "형태소 결합 규칙", "청크 간 관계 분석"],
          ["NLP", "성분 간 의미관계", "구문 결과 해석"],
          ["NLP", "문맥 속 의미", "문장 의미 분석"],
          ["NLU", "다수 문장 제공", "문맥 의미 학습"],
          ["NLU", "K개 카테고리", "입력 문장 분류"],
          ["NLU", "문장 입력→출력", "시퀀스 변환 기술"],
          ["NLU", "지문 학습·질의", "답변 추론 기술"],
          ["NLU", "문장 이해·생성", "대화 흐름 관리"],
          ["NLG", "상황 적합 자연어", "질문 답변 변환"],
          ["NLG", "자연어 문법 계획", "적합 문법 생성"],
          ["NLG", "문장 내 구문 선택", "명사·동사 선택"],
          ["NLG", "표현 오류 검출", "최종 문장 확정"],
          ["NLG", "텍스트→음성", "사람 목소리 구현"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["서문", "적용 범위 한정", "29119 기준"],
          ["서문", "인용 표준 규정", "AI 표준 연계"],
          ["서문", "AI 특화 용어", "40개 정의"],
          ["서문", "약어 목록 정리", "LLM 등 표기"],
          ["기술 본론", "AI 시스템\n테스트 소개", "생애주기 정의\n위험 기반 체계"],
          ["기술 본론", "리스크 식별", "우선순위 설정"],
          ["기술 본론", "레벨별 접근", "특화 유형 제시"],
          ["기술 본론", "부속서 정리", "AI 특성 설명"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구성요소", "키워드", "설명"],
        rows: [
          ["위험 식별(Risk Identification)", "기지·미지 위험\n위험 프로필 작성", "체계적 발굴\n위험 목록 작성"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["요구사항", "키워드", "설명"],
        rows: [
          ["목적과 범위 설정", "목적 범위 명확", "적용 대상 확정"],
          ["리스크 관리", "잠재 리스크 식별\n전 단계 관리", "위험 요인 도출\n개발·운영 포괄"],
          ["윤리 준수", "전 과정 윤리", "윤리 기준 준수"],
          ["투명성", "과정 투명 공개", "전 주기 공개"],
          ["책임성", "결과 책임 부담", "산출 결과 책임"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["조항", "키워드", "설명"],
        rows: [
          ["고영향 인공지능(2조 4호)", "생명·기본권", "중대 영향 AI"],
          ["생성형 인공지능(2조 5호)", "구조·특성 모방", "결과물 생성 AI"],
          ["인공지능산업(2조 6호)", "제품 개발·제조", "서비스 제공 산업"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["커스터마이징 — 기본 커스터마이징", "최소 맞춤작업\n사전학습 모델", "요구분석·설계\n샘플 데이터 적용"],
          ["커스터마이징 — AI 데이터 구축 커스터마이징", "데이터 신규구축\n데이터 품질검증", "재구축 포함\n검증 후 안정화"],
          ["커스터마이징 — AI 모델 커스터마이징", "모델 최적화\n알고리즘 개발", "파인튜닝 수행\n신규 모델 구현"],
          ["시스템통합형", "SW개발·통합", "맞춤작업 병행"],
        ],
      },
      {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["Ho", "귀무가설 H₀\n직접 검정 대상", "영가설 별칭\n옳다고 가정 시작"],
          ["H₁", "대립가설 H₁\n새 주장 입증", "연구가설 별칭\n귀무가설에 대립"],
          ["통계분석 방법", "표본분포 고려", "검정통계량 산정"],
          ["검정통계량", "Ho 근접도 수치\nZ·t·χ² 등", "모수 예측 판단 값\nF통계량 포함"],
          ["유의수준(α, 알파값)", "Ho 참 전제 확률", "통계량 관찰 확률"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["2) 입력 값 선정", "미디어·문서\n비정상 입력", "오류 유발 파일\n프로토콜 값 선정"],
          ["3) 테스트 케이스 생성", "제너레이션\n뮤테이션", "입력값 TC 생성\n도구 활용 변형"],
          ["4) 테스트 실행", "TC 투입 실행", "명령행 기반 구동"],
          ["5) 시스템 동작 모니터링", "장애 로그 수집\n크래시 콜스택", "시스템 로그 확보\n문제 발생시 기록"],
          ["6) 문제 분류 및 해결", "원인 분석 수정\n버퍼 오버플로", "문제 항목 점검\n널 참조·0 나눔"],
        ],
      },
      {
        caption: "유형",
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["운영 및 유지", "코드 기여·후원", "참여 방법 제시"],
          ["관리 및 개선", "라이선스 준수", "법적 문제 해결"],
          ["관리 및 개선", "OSS 지식 전달", "역량 강화 지원"],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["제1장 총칙", "총괄 담당자 지정\n대상 SW 지정", "제4조 담당자\n제5조 관리대상"],
          ["제2장 SW개발단계 안전확보", "요구·위험 분석\n설계 구현 검증", "제6조·제7조\n제8조·제9조"],
          ["제3장 SW운영단계 안전확보", "계획·위험 분석\n점검 변경 장애", "제10·11조\n제12~14조"],
          ["제4장 그 외 SW 안전확보 사항", "공유·기반 확보\n재검토 기한", "제15·16조\n제17·18조"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["사업비 규모", "사업비 500억\n지원 300억", "신규 사업 총액\n국가 재정 지원분"],
          ["정보화 사업 대상", "기본법 제15조", "소관업무 정보화"],
          ["신규사업", "국고 미지원 사업", "타당성조사비 등"],
          ["대상사업 요건", "재정지원 사업", "직접 대행 보조 등"],
        ],
      },
    ],
  },
    ...
    tables: [
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["상용SW 직접구매 대상", "사업규모 3억↑\n5천만원↑ 인증", "VAT 포함 총액\n쇼핑몰 등록 SW"],
          ["제외기준 사업", "민간투자형 사업", "진흥법 제40조"],
          ["제외기준 SW", "통합 불가·지연", "비용 상승 비효율"],
        ],
      },
      {
        caption: "법적 근거",
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["발생확률 계산", "문자 빈도 집계\n발생확률 산출", "A>B>C>D\n빈도/18 계산"],
          ["트리생성", "낮은 빈도 결합\nA=0 나머지 1", "빈도 낮은 쌍 결합\n나머지 하위 분기"],
          ["각 문자에 코드 할당", "A→0 B→10\nC→110", "고빈도 짧은 코드\nD→111 최장"],
          ["데이터 압축", "코드 치환 압축\n35bit 결과", "문자열 코드 대체\n18B 대비 축소"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["TF 계산(문서 별 단어의 빈도수)", "단어별 등장 횟수\n문서1·2 비교", "this 1·2\na 2·0"],
          ["IDF 계산(단어의 등장 빈도의 역수)", "등장 빈도 역수\nlog 계산", "this is 0\n나머지 0.3"],
          ["TF-IDF 계산(TF × IDF)", "TF×IDF\n단어별 곱셈 값", "this is 0\na 0.6 최대"],
        ],
      },
    ],
    ...
    tables: [
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["X 축", "동위상 반송파", "I 축 반송파 성분"],
          ["Y 축", "구상 반송파", "Q 축 반송파 성분"],
          ["심볼 코딩", "심볼당 n bit", "1심볼 4비트"],
          ["심볼 표현", "위상 φ·진폭 a\n위상·진폭 차이", "0000 심볼\n심볼 상호 구분"],
          ["16 QAM", "진폭 3가지\n위상 12가지", "진폭 변조 활용\n위상 변조 활용"],
        ],
      },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["구분", "키워드", "구성"],
        rows: [
          ["TCP 헤더 (20 byte, 무옵션시)", "포트·순서번호\n제어플래그 6종", "발신·목적 포트\n윈도우·체크섬"],
          ["UDP 헤더 (8 byte)", "송수신 포트\n길이·검사합", "각 16비트 필드\n총 8바이트"],
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["개념", "장비 기능 분리\n가상화 관리", "기능 SW 제어\n유연한 망 운용"],
          ["NFVI", "물리 HW 자원", "VNF 실행 지원"],
          ["VNFs", "SW 기능 집합", "응용 지원 기능"],
          ["MANO", "VNF 관리", "자원 전달 관리"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["절차", "키워드", "설명"],
        rows: [
          ["[개념] 주제 영역 정의", "최상위 집합 구분\n중복 최소·확장", "전사 관점 분류\n관련성·편의성"],
          ["[개념] 후보 Entity 선정", "후보 엔티티 수집\n현업 참여 필수", "함부로 제외 금지\n현업 의견 반영"],
          ["[개념] 핵심 Entity 정의", "핵심 엔티티 선별\n본질식별자 정의", "후보 중 핵심 선별\n관리 여부 등 확인"],
          ["[개념] 관계 정의", "엔티티 간 연관\n양방향·두 관점", "관계 유형 정의\n항상 두 엔티티 간"],
          ["[논리] 속성 정의", "최소 데이터 단위\n속성 분할 필수", "분해 불가 상세화\n업무 요구 근거"],
          ["[논리] Entity 상세화", "식별자·정규화\nM:M 관계 해소", "단계별 정규화\n참조무결성 규칙"],
          ["[논리] 이력 관리 정의", "활용성·추적성\n시점·선분 이력", "정보 추적성 확보\n물리 성능 고려"],
          ["[물리] 물리 환경 조사", "구축 환경 분석\n관리 기법 고려", "HW 자원 확정\n백업·관리 정책"],
          ["[물리] 논리모델 변환", "테이블·속성\n수퍼/서브 전환", "관계·제약 전환\nPK 최적화 조정"],
          ["[물리] 반정규화", "성능·개발 편의\n분할·중복 컬럼", "운영 단순성 확보\n인덱스 조정 우선"],
        ],
      },
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["TCL (Transaction Control Language)", "COMMIT 등\nTCL 별도 분류", "트랜잭션 제어\nDCL 에서 분리"],
        ],
      },
    ],
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["대상", "유일한 이름", "데이터 구별 명칭"],
          ["대상", "의미 범위 규정", "자격요건 정의"],
          ["대상", "표현 형태 정의", "입력 오류 최소화"],
          ["대상", "가능 값 사전 정의", "통제 위험 최소화"],
          ["체계", "데이터 표준 요소\n표준용어·단어", "전 객체 대상 관리\n도메인·코드 등"],
          ["체계", "표준 관리조직\n데이터 관리자", "정의·감독 보안\n계획 수립·통제"],
          ["체계", "표준화 프로세스\n요구 수집→정의", "단계별 절차\n확정→관리 진행"],
        ],
    ...
    tables: [
      {
        ...
        rows: [
          ["데이터 내용 개념", "레코드·필드 값\n원천 데이터", "문자·숫자 집합\n텍스트·영상 등"],
          ["인증 유형", "유형 3종 구분", "복합 보통 단순형"],
          ["심사 지표", "A/B/C 등급", "3단계 심사지표"],
          ["인증 대상", "데이터 구조\n데이터 내용", "정형·비정형\n데이터 값"],
          ["정형 데이터 심사", "필수 3개 지표\n선택 5개 지표", "완전 유효 일관성\n정확 접근 유일성"],
          ["비정형 데이터 심사", "필수 4개 지표\n선택 5개 지표", "완전 유효 정확성\n유일 일관 접근성"],
        ],
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["개념", "현 보유 역량\n미래 역량 도출", "내부 자원 분석\n역량 방향 제시"],
          ["절차", "사업·재무 성과\n현황·역량 진단", "실적 기반 분석\n시사점 도출"],
          ["기법 — Value Chain 분석", "부가가치 활동\n강·약점 파악", "가치 창출 분석\n비용 우위 확보"],
          ["기법 — 균형 지표 성과 분석(BSC)", "재무·고객 관점\n프로세스·학습", "성과지표 전환\n균형 성과 관리"],
          ["기법 — 7S 모형 분석", "하드·소프트\n조직 현황 진단", "7S 요소 구분\n총체적 역량 진단"],
    ...
    tables: [
      {
        ...
        headers: ["단계", "키워드", "설명"],
        rows: [
          ["프로젝트 착수 및 참여자 결정", "지원조직 형성\n수행조직 편성", "경영진 지원 확보\nPJT 계획 수립"],
          ["정보시스템 방향성 수립", "정보화 전략 검토\n추진 범위·방향", "벤치마킹 선택적\n정의 및 검토"],
          ["업무 및 정보기술 요건 분석", "업무·IT 현황\n업무·IT 요건", "현황 분석 수행\n요건 분석·검토"],
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["평가 단계", "중간평가 검증\n위험 수치화", "추진비용 검증\n수정안 도출"],
          ["평가 단계", "사후평가 수행\nCSF·KPI", "전략 분석 수행\n성과 측정·개선"],
          ["시행 추진 단계", "내부조직 구성", "추진체계 수립"],
          ["시행 추진 단계", "착수 발주 계약", "실행 및 통제"],
          ["시행 추진 단계", "프로젝트 종료", "사업관리 평가"],
          ["성과 추진 단계", "BSC 재무지표\nCSF·KPI", "운영지표 결합\n조직 효과성 측정"],
          ["분석 기법", "NPV 현재가치", "예정 순이익 환산"],
          ["분석 기법", "ROI 수익 비율", "자본 투자 대비"],
          ["분석 기법", "회수기간 PP", "플러스 전환 기간"],
          ["분석 기법", "편익/비용 비율\n1 초과 경제성", "현재가치 환산\n경제성 판단 지표"],
        ],
      },
    ],
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["취약점", "키워드", "설명"],
        rows: [
          ["LLM01 프롬프트 인젝션", "입력 정제·검증\n문맥 격리 적용", "악성 입력 차단\n출력 모니터링"],
          ["LLM02 민감한 정보 공개", "데이터 정제\n접근 제어 강화", "입력값 검증\n차등 프라이버시"],
          ["LLM03 공급망 취약점", "공급업체 검증\nSBOM 관리", "레드팀 평가\n코드 서명 검증"],
          ["LLM06 과도한 대행", "인간 개입 유지\n권한 제한", "휴먼 인 더 루프\n행동 로깅 감시"],
          ["LLM08 벡터·임베딩 취약점", "벡터값 정제\n적대적 테스트", "임베딩 안전화\n이상 징후 탐지"],
          ["LLM09 잘못된 정보", "RAG 활용\n인간 검증 감독", "근거 기반 생성\n자동 검증 병행"],
          ["LLM10 무제한 소비", "입력·속도 제한\n자원 할당 관리", "요청 속도 통제\n샌드박스 적용"],
        ],
      },
    ],
    notes: [
    ...
    tables: [
      {
        ...
        headers: ["인증영역", "키워드", "설명"],
        rows: [
          ["Ⅰ. 기본적인 요구사항(14항목)", "식별·목적\n단계별 보호조치", "처리 흐름 파악\n처리 주체 식별"],
          ["Ⅱ. 개인정보 처리의 적법성(26항목)", "동의·제한\n정보주체 권리", "아동·위치 동의\n파기·열람 보장"],
          ["Ⅲ. 정보보안 및 프라이버시 강화(22항목)", "인증·권한 관리\n암호·완전 삭제", "안전한 인증정보\n원격 접속 통제"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["SW 보호(PS, Protect the Software)", "코드 변조 보호\n릴리스 무결성", "무단 액세스 방지\n보관·보호 검증"],
          ["보안이 잘된 SW 제작(PW, Produce Well Secured Software)", "보안 설계 재사용\n코드 검토·분석", "위험 완화 설계\n보안 코딩 준수"],
    ...
    tables: [
      {
        ...
        rows: [
          ...
          ["안전성 확보의 원칙", "안전보호 장치", "분실·유출 대비"],
          ["공개의 원칙", "처리 정책 공개", "일반 대상 공개"],
          ["개인 참가의 원칙", "열람·정정 청구", "존재 확인 권리"],
    ...
    tables: [
      {
        ...
        headers: ["구분", "키워드", "설명"],
        rows: [
          ["1~4. 기본", "개요·용어 정의", "참고 문헌·고려"],
          ["5. 조직 사이버보안 관리", "정책·문화 관리", "정보 공유·감사"],
          ["6. 프로젝트 사이버보안 관리", "책임자·계획", "평가·내역 공개"],
          ["7. 분산 사이버보안 활동", "공급망 이해관계", "능력 평가·분담"],
          ["8. 지속적인 사이버보안 활동", "모니터링·평가", "취약점 분석 관리"],
          ["9~11. 개념 정의~검증", "개념 개발 검증", "제품 설계·검증"],
          ["12~15. 생산 이후", "생산 운영 폐기", "지원·위험 평가"],
        ],
      },
    ],
    notes: [
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["1. 정보보호 투자 현황", "정보기술 투자액\n정보보호 투자액", "부문별 투자 금액\n비율·특이사항"],
          ["2. 정보보호 인력 현황", "IT·보호 인력\nCISO 지정", "인력 수·비율\nCPO 지정 현황"],
    ...
    tables: [
      {
        ...
        rows: [
          ["기능 적합성", "완전성·정확성\n기능적합성 신규", "적절성 포함 기준\nAI 특화 추가"],
          ["성능 효율성", "시간 반응성\n자원·용량성", "응답 시간 성능\n자원 활용·용량"],
          ["호환성", "공존 상호운용성", "타 시스템 연동"],
          ["사용성", "인식·학습 운영\n제어성·투명성", "오류 방지·미학\nAI 특화 추가"],
          ["신뢰성", "성숙·가용 회복\n허용성·강건성", "안정 운영 능력\n결함·교란 내성"],
          ["보안성", "기밀·무결 부인\n책임·인증 개입", "정보 보호 속성\n개입가능성 추가"],
          ["유지보수성", "모듈·재사용성\n분석·수정 시험", "구조 변경 용이\n테스트 용이성"],
          ["이식성", "설치·대체 적응", "환경 이전 용이"],
        ],
      },
      {
  ...
  },
  {
    ...
    tables: [
      ...
      },
      {
        ...
        headers: ["계층", "키워드", "설명"],
        rows: [
          ["Consumer Surfaces(소비자 접점)", "구글 AI 모드\nGemini 등", "AI 플랫폼 접점\n음성 채팅 비주얼"],
          ["UCP 프로토콜 코어", "쇼핑 서비스\nOrders 등", "결제 품목 합계\n기능·확장 요소"],
          ["전송 방식(Transport)", "REST API\nMCP·A2A", "JSON RPC\n에이전트 연동"],
          ["보안 & 결제 계층", "OAuth\n2.0 신원연결", "AP2 결제증명\nPCI-DSS"],
          ["판매자 백엔드(Merchant Backend)", "기존 인프라 유지", "변경 없이 연동"],
        ],
      },
    ],
    notes: [
