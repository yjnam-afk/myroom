    ...
    subDefs: [
      {
        ...
        def: "특정 시간에 참조되는 Locality가 포함된 page들의 집합",
      },
      {
        name: "PFF(Page Fault Frequency)",
        lead: "부재율 기반 프레임 조정",
        def: "page fault 발생 시 page frame 수를 조정하는 기법",
      },
    ],
    keywords: [
      "리소스 부족",
  ...
  },
  {
    ...
    subDefs: [
      ...
      },
      {
        ...
        lead: "클록 단위의 교대 실행",
        def: "여러 쓰레드의 명령어를 클록 사이클마다 번갈아 선택해 실행하는 구조",
      },
      {
      ...
      },
      {
        ...
        lead: "동일 사이클의 동시 실행",
        def: "여러 쓰레드의 명령어를 같은 클록 사이클에 동시에 실행하는 병렬 구조",
      },
      {
        name: "Chip Multiprocessing(CMP)",
        lead: "다수 코어의 병렬 처리",
        def: "하나의 칩에 다수의 독립 코어를 두어 쓰레드를 각각 병렬 실행하는 구조",
      },
    ],
    keywords: [
      "Single Thread",
    ...
    tables: [
      {
        caption: "멀티 쓰레드 종류",
        headers: ["Thread 종류", "특징"],
        rows: [
          ["Single Thread", "한 번에 한 흐름만\nCPU 활용률 낮음"],
          ["Interleaved Multithreading (IMT)", "클록마다 교대\n하나씩 실행"],
          ["Blocked Multithreading (BMT)", "블록 시에만 교대\nIMT보다 낮음"],
          ["Simultaneous Multithreading (SMT)", "파이프라인 공유\nHyper-Threading"],
          ["Chip Multiprocessing (CMP)", "물리 코어 병렬\n실행 유닛 독립"],
        ],
      },
    ],
    notes: [
  ...
  },
  {
    ...
    subDefs: [
      ...
      },
      {
        ...
        lead: "한 방향 이동의 요청 처리",
        def: "헤드가 한 방향 끝까지 이동하며 경로상 요청을 처리하는 스케줄링 기법",
      },
      {
        name: "N-Step SCAN",
        lead: "그룹 단위의 SCAN 처리",
      ...
      },
      {
        ...
        lead: "원형 확장의 단방향 이동",
        def: "한 방향으로만 이동하고 끝에 도달하면 처음으로 되돌아가는 원형 기법",
      },
      {
        name: "LOOK",
        lead: "요청 범위까지의 이동",
        def: "요청이 있는 마지막 위치까지만 이동한 뒤 방향을 바꾸는 스케줄링 기법",
      },
      {
        name: "C-LOOK",
        lead: "단방향 이동의 처음 점프",
        def: "한 방향으로만 이동하다 요청이 끝나면 가장 처음 요청으로 점프하는 기법",
      },
      {
        name: "SLTF(Shortest Latency Time First)",
        lead: "회전 지연의 최소화",
        def: "같은 트랙 내에서 회전 지연이 가장 적은 섹터를 먼저 처리하는 스케줄링",
      },
    ],
    keywords: [
      "FCFS",
    ...
    tables: [
      {
        ...
        headers: ["기법", "동작 방식", "장점", "단점"],
        rows: [
          ["FCFS(First Come First Serve)", "요청 순서대로", "단순·공정 보장", "평균 응답시간↑"],
          ["SSTF(Shortest Seek Time First)", "가장 가까운 선택", "탐색 시간 감소", "먼 요청 기아"],
          ["SCAN(엘리베이터 알고리즘)", "끝까지 후 전환", "응답시간 균등", "불필요 이동 발생"],
          ["N-Step SCAN", "그룹 SCAN", "응답 예측 가능", "일부 요청 지연"],
          ["C-SCAN(Circular SCAN)", "끝에서 처음 복귀", "응답 처리 균일", "복귀 이동 낭비"],
          ["LOOK", "마지막 요청 전환", "불필요 이동 감소", "여전히 지연 가능"],
          ["C-LOOK", "처음 요청 점프", "이동 효율 균일", "먼 점프 시 지연"],
          ["SLTF(Shortest Latency Time First)", "최근접 섹터 선택", "회전 대기 감소", "여러 트랙 제한"],
        ],
      },
    ],
    notes: [
    ...
    subDefs: [
      {
        name: "동등 클래스 분할 기법",
        lead: "입력 도메인의 등가 분할",
        def: "입력 도메인을 등가 분할해 영역별 대표값으로 케이스를 설계하는 기법",
      },
      {
        name: "경계값 분석",
        lead: "경계 근처 결함의 착안",
        def: "입력 영역 분할 클래스의 경계값으로 테스트 케이스를 설계하는 분석 기법",
      },
      {
        name: "의사결정 테이블 테스팅",
        lead: "결정 요소의 결합 조합",
        def: "의사결정 요소를 결정테이블로 만들어 결합으로 케이스를 설계하는 기법",
      },
      {
        name: "상태전이 테스팅",
        lead: "상태 변화의 동작 파악",
        def: "상태전이 다이어그램으로 이벤트·액션의 상태 변화를 파악하는 기법",
      },
      {
        name: "유스케이스 테스팅",
        lead: "비즈니스 시나리오 기반",
      ...
      },
      {
        name: "분류 트리 기법",
        lead: "트리 구조의 분석 표현",
        def: "소프트웨어의 일부나 전체를 트리 구조로 표현해 케이스를 설계하는 기법",
      },
      {
        name: "페어와이즈 테스팅",
        lead: "두 요소 상호작용 조합",
      ...
      },
      {
        name: "원인-결과 그래프",
        lead: "입력·출력 관계의 분석",
        def: "입력 데이터 관계가 출력에 미치는 영향을 분석해 케이스를 설계하는 기법",
      },
      {
        name: "오류예측 기법",
        lead: "감각과 경험의 결함 탐색",
        def: "다른 기법들이 놓치기 쉬운 오류를 감각과 경험으로 찾아 검증하는 기법",
      },
    ],
  ...
  },
  {
    ...
    subDefs: [
      ...
      },
      {
        name: "루프 테스트",
        lead: "루프 경계선의 오류 검출",
        def: "단순·중첩·연결·비구조 루프 경계선에서 생기는 오류를 찾는 테스트",
      },
      {
        name: "구문 커버리지",
        lead: "모든 구문의 1회 실행",
      ...
      },
      {
        name: "변경조건/결정 커버리지",
        lead: "개별 조건의 독립적 영향",
        def: "개별 조건식이 다른 조건식과 무관하게 전체식에 영향을 주게 하는 기법",
      },
      {
        name: "다중조건/결정 커버리지",
        lead: "모든 조건 조합의 고려",
    ...
    tables: [
      {
        ...
        headers: ["구분", "노드"],
        rows: [
          ["최대 힙(Max-Heap)", "자손보다 큰 값"],
          ["최소 힙(Min-Heap)", "자손보다 작은 값"],
        ],
      },
      {
    ...
    tables: [
      ...
      },
      {
        ...
        rows: [
          ["위치 투명성", "응용 단순화\n자유로운 접근", "속도 저하\n저장공간 낭비"],
          ["복제 투명성", "상향식 확장\n점진적 제공", "이질형 구현 시\n복잡"],
          ["병행 투명성", "자원 사용 극대화", "복잡한 Locking"],
          ["분할 투명성", "병목 방지\n시스템 성능 향상", "충분한 설계기술\n필요"],
          ["장애 투명성", "장애처리 단순", "장애원인 규명\n복잡"],
        ],
      },
      {
        caption: "분산방법 [위분복요]",
    ...
    tables: [
      {
        ...
        headers: ["항목", "설명", "대표 약점"],
        rows: [
          ["입력데이터 검증 및 표현(17)", "입력값 검증 부재", "SQL·XML 삽입\nLDAP 삽입\nCSRF·SSRF\n파일 업로드"],
          ["보안 기능(16)", "인증·인가·암호화\n기능 미흡", "인증 없는 기능\n취약한 암호화\n하드코드 정보"],
          ["시간 및 상태(2)", "동시 수행 시점\n순서 처리 결함", "경쟁조건\n(TOCTOU)\n무한 반복·재귀"],
          ["에러 처리(3)", "에러 메시지로\n정보 노출", "오류메시지 노출\n대응 부재\n부적절 예외 처리"],
          ["코드 오류(5)", "개발자 부주의로\n인한 오류", "Null 역참조\n부적절 자원해제\n해제 자원 사용"],
          ["캡슐화(4)", "중요 데이터\n노출", "세션 정보 노출\nPrivate 배열 반환\npublic 데이터 할당"],
          ["API 오용(2)", "취약한 API 사용", "DNS Lookup 의존\n취약한 API 사용"],
        ],
      },
      {
