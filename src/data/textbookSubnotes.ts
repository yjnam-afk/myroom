...
export const SUBNOTES: TextbookSubnote[] = [
  ...
  },
  {
    ...
    tables: [
      {
        caption: "절차 (특선상세문)",
        headers: ["절차", "수행 내용", "산출물"],
        rows: [
          ["프로젝트 특징 정의", "범위 규모 확인", "특성 요인도"],
          ["표준 프로세스 선정 및 검증", "방법론 후보 선정\n적합성 검증", "표준 문서 확보\n프로세스 검증서"],
          ["상위 수준의 커스터마이징", "생명주기 선정", "WBS 정의서"],
          ["세부 커스터마이징", "기법 도구 확정", "맞춤 매트릭스"],
          ["테일러링 문서화", "조정 근거 기록", "적용 결과서"],
        ],
      },
      {
        caption: "목적 / 필요성",
