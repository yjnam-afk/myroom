...
export const EXTRAS: Record<string, SubnoteExtra> = {
  "chaos-test": {
    guide: {
      hook: "실 서비스에 '인위적 혼돈을 주입'해 아키텍처 문제를 미리 찾는 테스트입니다.",
      scene: "출시 전 테스트로 못 잡는 장애가 있습니다. 카오스 테스트는 실제 운영 환경에 의도적 장애(서버 다운·지연)를 넣어, 정상 지표와 비교해 시스템이 견디는지 검증하고 숨은 아키텍처 약점을 찾습니다.",
      ...
      map: [
        { as: "정상 지표 정의", real: "정상 상태", note: "정가실결문" },
        { as: "장애 견딤 가설", real: "가설 수립", note: "" },
        { as: "롤백 계획 하 주입", real: "실험 디자인", note: "안전장치" },
        { as: "지표 비교·수정", real: "결과·수정", note: "" },
      ],
  ...
  "refactoring": {
    guide: {
      hook: "'겉보기 기능은 그대로 두고 내부 구조만 개선'해 유지보수성을 높이는 기법입니다.",
      scene: "코드가 돌아가긴 하는데 지저분하면 나중에 고치기 어렵습니다. 리팩토링은 동작을 바꾸지 않으면서 코드를 정리해, 읽기 쉽고 바꾸기 쉽게 만듭니다. 테스트가 안전망 역할을 합니다.",
      ...
      map: [
        { as: "기능 그대로 구조만", real: "동작 불변", note: "핵심" },
        { as: "중복·긴 메소드", real: "코드 냄새", note: "중긴큰긴산" },
        { as: "메소드 추출·이동", real: "리팩토링 기법", note: "" },
        { as: "회귀 테스트 안전망", real: "테스트와 짝", note: "" },
      ],
  ...
  "three-r": {
    guide: {
      hook: "생산성을 위해 '역공학·재공학·재사용'을 레포지토리 기반으로 쓰는 공학 접근법입니다.",
      scene: "기존 자산을 버리지 않고 활용합니다. 코드에서 설계를 거꾸로 뽑고(역공학), 그걸 재설계해 새 형태로 바꾸고(재공학), 검증된 부품을 다시 씁니다(재사용). 셋의 중심에 레포지토리가 있습니다.",
      ...
      map: [
        { as: "코드→설계 추출", real: "역공학(이해)", note: "" },
        { as: "재설계·변환", real: "재공학(개선)", note: "" },
        { as: "부품 다시 쓰기", real: "재사용(활용)", note: "" },
        { as: "중심 저장소", real: "레포지토리", note: "" },
      ],
  ...
  "turing-test": {
    guide: {
      hook: "'기계가 인간과 구별 안 될 만큼 지적인지'를 대화로 판정하는 테스트입니다.",
      scene: "판정자가 벽 너머의 상대(사람 또는 기계)와 대화만으로 어느 쪽이 기계인지 못 맞히면, 그 기계는 지능이 있다고 봅니다(튜링, 1950). AI 판별의 고전적 기준입니다.",
      ...
      map: [
        { as: "구별 못 하면 지능", real: "모방 게임", note: "" },
        { as: "겉보기 행동으로", real: "행동주의 판정", note: "" },
        { as: "이해 없이 통과 가능", real: "중국어 방 반론", note: "한계" },
        { as: "봇 거르기", real: "CAPTCHA(역튜링)", note: "응용" },
      ],
  ...
  "regression-test": {
    guide: {
      hook: "'수정 후에도 기존 기능이 멀쩡한지' 다시 확인하는 테스트입니다.",
      scene: "한 곳을 고쳤더니 멀쩡하던 다른 곳이 깨지는 일이 흔합니다. 회귀 테스트는 변경 후 기존 기능을 재실행해 이런 부작용(파급효과)을 잡습니다. 자동화가 필수입니다.",
      ...
      map: [
        { as: "고친 뒤 기존 재확인", real: "회귀 테스트", note: "" },
        { as: "파급·부작용", real: "Ripple·Side Effect", note: "" },
        { as: "변경 영향만", real: "선택적 재실행", note: "" },
        { as: "자동화·CI", real: "필수", note: "" },
      ],
  ...
  "fuzzing-test": {
    guide: {
      hook: "'랜덤·비정상 데이터를 대량 입력해' 예외와 보안 취약점을 찾는 테스트입니다.",
      scene: "예상 못한 입력에 프로그램이 어떻게 반응하는지 봅니다. 퍼징은 무작위·변조 데이터를 쏟아부어 크래시·메모리 오류를 유발하고, 그 지점이 곧 취약점 후보가 됩니다. 보안 테스트의 핵심입니다.",
      ...
      map: [
        { as: "랜덤·비정상 입력", real: "퍼징", note: "" },
        { as: "크래시=취약점", real: "취약점 발견", note: "핵심" },
        { as: "유효 입력 변형", real: "변이 기반", note: "" },
        { as: "명세로 생성", real: "생성 기반", note: "" },
      ],
  ...
  "performance-test": {
    guide: {
      hook: "시스템이 '요구된 성능 목표'를 부하 상황에서 내는지 검증하는 테스트입니다.",
      scene: "기능은 되는데 사용자가 몰리면 느려지거나 죽으면 실패입니다. 성능 테스트는 부하·스트레스를 걸어 응답시간·처리량·자원 사용을 측정하고 병목을 찾습니다.",
      ...
      map: [
        { as: "요청 하나 속도", real: "응답시간", note: "" },
        { as: "단위시간 처리량", real: "처리량(Throughput)", note: "" },
        { as: "예상 부하 성능", real: "부하 테스트", note: "" },
        { as: "한계 초과·복구", real: "스트레스 테스트", note: "" },
      ],
  ...
  "iso-29119": {
    guide: {
      hook: "SW 개발 전 과정의 '테스팅 프로세스·산출물'을 다루는 국제 표준 시리즈입니다.",
      scene: "테스트를 조직마다 제각각 하면 품질이 들쭉날쭉합니다. ISO 29119는 테스트 개념·프로세스·문서화·기법·키워드 주도까지 파트별로 표준화해, 일관된 테스트를 지원합니다.",
      ...
      map: [
        { as: "개념·정의", real: "Part 1", note: "개프도테키" },
        { as: "프로세스 3계층", real: "Part 2", note: "" },
        { as: "문서화·기법·키워드", real: "Part 3·4·5", note: "" },
        { as: "AI 테스트", real: "Part 11", note: "확장" },
      ],
  ...
  "iso-29119-11": {
    guide: {
      hook: "'AI 기반 시스템을 어떻게 테스트할지' 지침을 주는 ISO 29119의 11부입니다.",
      scene: "AI는 정답 판정 기준(오라클)이 모호하고 비결정적이라 기존 테스트가 안 통합니다. 29119-11은 이런 AI 특유의 어려움과 그에 맞는 테스트 기법을 제시합니다.",
      ...
      map: [
        { as: "AI 오라클 문제", real: "기대값 모름", note: "핵심 난제" },
        { as: "입력 변형-출력 관계", real: "변성 테스트", note: "해법" },
        { as: "다른 구현 비교", real: "백투백", note: "" },
        { as: "비결정성·데이터 의존", real: "AI 특성", note: "" },
      ],
  ...
  "mutation-test": {
    guide: {
      hook: "'코드에 일부러 결함(변이)을 심어' 테스트가 그걸 잡는지 검증하는 기법입니다.",
      scene: "커버리지가 높아도 테스트가 허술할 수 있습니다. 뮤테이션 테스트는 코드를 조금 변형(변이체)해 놓고, 기존 테스트가 그 변형을 실패로 잡아내는지 봅니다 — 못 잡으면 테스트가 약한 것입니다. 테스트의 품질을 테스트합니다.",
      ...
      map: [
        { as: "일부러 결함 심기", real: "변이체 생성", note: "" },
        { as: "테스트가 잡으면", real: "죽임(killed)", note: "" },
        { as: "못 잡으면", real: "살아남음", note: "테스트 약함" },
        { as: "잡은 비율", real: "변이 점수", note: "테스트 품질" },
      ],
  ...
  "test-process": {
    guide: {
      hook: "테스트를 '계획→분석·설계→구현·실행→평가·종료'로 체계화한 프로세스입니다.",
      scene: "테스트도 무작정 하면 놓칩니다. 테스트 프로세스는 무엇을·어떻게 테스트할지 계획하고, 케이스를 설계하고, 실행하고, 결과를 평가해 종료하는 단계를 정의합니다(ISO 29119-2).",
      ...
      map: [
        { as: "정책·전략", real: "조직적 프로세스", note: "3계층" },
        { as: "계획·통제·완료", real: "관리 프로세스", note: "" },
        { as: "설계·실행·보고", real: "동적 프로세스", note: "" },
        { as: "종료 조건", real: "완료", note: "" },
      ],
  ...
  "iso-25010": {
    guide: {
      hook: "소프트웨어 '제품 품질'을 8대 특성으로 정의한 국제 표준(2023 개정)입니다.",
      scene: "'좋은 SW'는 막연합니다. 25010은 품질을 기능성·성능·호환성·사용성·신뢰성·보안·유지보수성·이식성 8개로 나눠, 무엇을 어떻게 평가할지 공통 기준을 줍니다. AI 확장이 25059입니다.",
      ...
      map: [
        { as: "기능·성능·호환성", real: "8특성(전반)", note: "" },
        { as: "사용성·신뢰성·보안", real: "8특성(중반)", note: "" },
        { as: "유지보수성·이식성", real: "8특성(후반)", note: "" },
        { as: "AI 확장", real: "25059", note: "" },
      ],
  ...
  "sp-cert": {
    guide: {
      hook: "SW 기업의 '개발·운영 프로세스 역량'을 심사·인증하는 제도입니다.",
      scene: "좋은 SW는 좋은 프로세스에서 나옵니다. SP(SW Process) 인증은 기업의 개발·관리 프로세스 수준을 심사해 등급을 매겨, 프로세스 역량을 대외 증명하고 공공사업 참여에 활용하게 합니다.",
      ...
      map: [
        { as: "개발 프로세스 심사", real: "SP 인증", note: "" },
        { as: "등급 부여", real: "1~3등급", note: "" },
        { as: "공공사업 가점", real: "혜택", note: "" },
        { as: "과정 vs 제품", real: "GS와 구분", note: "" },
      ],
  ...
  "gs-cert": {
    guide: {
      hook: "국산 SW의 '품질을 국가가 시험·인증'하는 Good Software 인증입니다.",
      scene: "SW 품질을 객관적으로 증명하려면 공인 시험이 필요합니다. GS 인증은 국제 표준(ISO 25023 등) 기반으로 SW의 기능·성능·사용성 등을 시험해 품질을 인증하고, 공공 조달에서 우대받게 합니다.",
      ...
      map: [
        { as: "SW 제품 품질 시험", real: "GS 인증", note: "" },
        { as: "기능·성능·사용성", real: "품질 특성", note: "ISO 25023" },
        { as: "공공 조달 우대", real: "혜택", note: "" },
        { as: "제품 vs 프로세스", real: "SP와 구분", note: "" },
      ],
  ...
  "cmmi": {
    guide: {
      hook: "조직의 '개발·서비스 프로세스 성숙도'를 5단계로 평가·개선하는 모델입니다(3.0).",
      scene: "잘하는 조직은 프로세스가 체계적입니다. CMMI는 조직의 프로세스 능력을 초기(1)부터 최적화(5)까지 5단계로 평가해, 어디가 부족한지 진단하고 개선 방향을 제시합니다.",
      ...
      map: [
        { as: "임기응변", real: "1 초기", note: "" },
        { as: "조직 표준", real: "3 정의", note: "" },
        { as: "측정·통계 통제", real: "4 정량적 관리", note: "" },
        { as: "지속 개선", real: "5 최적화", note: "" },
      ],
  ...
  "oss-governance": {
    guide: {
      hook: "조직이 오픈소스를 '안전하고 합법적으로' 쓰도록 관리하는 체계입니다.",
      scene: "오픈소스를 마구 가져다 쓰면 라이선스 위반·보안 사고가 납니다. 오픈소스 거버넌스는 무엇을·어떻게 쓸지 정책을 세우고, 사용 현황·라이선스·취약점을 관리해 위험을 통제합니다.",
      ...
      map: [
        { as: "라이선스 준수", real: "카피레프트/퍼미시브", note: "GPL·MIT" },
        { as: "사용 승인", real: "OSRB 프로세스", note: "" },
        { as: "보안·현황 관리", real: "SCA·SBOM", note: "" },
        { as: "조직 정책", real: "거버넌스", note: "" },
      ],
  ...
  "stpa": {
    guide: {
      hook: "'시스템 이론'으로 복잡계의 안전을 분석하는 현대적 기법입니다.",
      scene: "FTA·FMEA는 부품 고장 중심이라, 소프트웨어·인적 요소가 얽힌 복잡계의 '제어 문제'는 못 잡습니다. STPA는 사고를 부품 고장이 아니라 '부적절한 제어'로 보고, 제어 구조에서 안전하지 않은 제어 행동을 찾습니다.",
      ...
      map: [
        { as: "제어 문제로 봄", real: "시스템 이론(STAMP)", note: "" },
        { as: "제어 구조 모델링", real: "컨트롤러-피드백", note: "" },
        { as: "안전하지 않은 제어", real: "UCA 식별", note: "핵심" },
        { as: "부품 고장 중심 넘어", real: "FTA·FMEA와 차이", note: "" },
      ],
  ...
  "eta": {
    guide: {
      hook: "'초기 사건에서 결과로' 앞으로 전개하며 사고 시나리오를 분석하는 귀납적 기법입니다.",
      scene: "'화재 발생'이라는 초기 사건에서 시작해, 안전장치가 작동하느냐/실패하느냐의 분기를 따라가며 최종 결과(대형 사고~경미)를 확률과 함께 분석합니다. FTA와 방향이 반대입니다.",
      ...
      map: [
        { as: "초기 사건→결과", real: "전향적·귀납", note: "" },
        { as: "성공/실패 분기", real: "이진 트리 전개", note: "" },
        { as: "결과 시나리오·확률", real: "결과 분석", note: "" },
        { as: "사고→원인 후향", real: "FTA와 반대", note: "" },
      ],
  ...
  "hazop": {
    guide: {
      hook: "'가이드워드로 정상에서 벗어난 상황'을 체계적으로 찾는 위험·운용성 분석입니다.",
      scene: "'만약 흐름이 없다면?', '많다면?'처럼 가이드워드를 공정 변수에 적용해, 설계 의도에서 벗어난 이탈(deviation)과 그 원인·결과를 팀이 브레인스토밍으로 찾습니다. 화학 플랜트에서 유래했습니다.",
      ...
      map: [
        { as: "No·More·Less 등", real: "가이드워드", note: "" },
        { as: "설계 의도 벗어남", real: "이탈(Deviation)", note: "" },
        { as: "팀 브레인스토밍", real: "구조적 협의", note: "" },
        { as: "원인·결과·권고", real: "분석 결과", note: "" },
      ],
  ...
  "fmea": {
    guide: {
      hook: "'각 부품의 고장 모드가 미치는 영향'을 상향식으로 분석하는 안전 기법입니다.",
      scene: "각 부품이 어떻게 고장 날 수 있고(고장 모드), 그게 시스템에 어떤 영향을 주는지 하나씩 따집니다. 발생·심각도·검출을 곱한 위험 우선순위(RPN)로 어디를 먼저 개선할지 정합니다.",
      ...
      map: [
        { as: "부품 고장→영향", real: "상향식·귀납", note: "" },
        { as: "심각도×발생×검출", real: "RPN", note: "우선순위" },
        { as: "RPN 높은 것 먼저", real: "개선 우선", note: "" },
        { as: "사고→원인 하향식", real: "FTA와 대비", note: "" },
      ],
  ...
  "ops-performance": {
    guide: {
      hook: "정보시스템 운영이 '목표 성과를 내는지' 지표로 관리하는 활동입니다.",
      scene: "시스템을 그냥 돌리는 게 아니라 잘 돌리는지 측정해야 합니다. 운영 성과관리는 가용성·응답시간·장애·사용자 만족 같은 지표로 운영 수준을 재고, SLA 충족과 지속 개선을 관리합니다.",
      ...
      map: [
        { as: "가용성·응답시간", real: "성능 지표", note: "" },
        { as: "장애·복구(MTTR)", real: "신뢰성 지표", note: "" },
        { as: "SLA 준수율", real: "서비스 수준", note: "SLM" },
        { as: "IT-BSC 균형", real: "성과 관리", note: "" },
      ],
  ...
  "audit-report": {
    guide: {
      ...
      scene: "감리가 끝나면 무엇이 문제이고 어떻게 고쳐야 하는지 문서로 남겨야 합니다. 감리결과보고서는 점검 결과·발견사항·개선 권고를 정리해, 발주자·수행사가 시정하게 하는 근거가 됩니다.",
      ...
      map: [
        { as: "대상·범위·기준", real: "감리 개요", note: "" },
        { as: "종합 의견", real: "총평", note: "" },
        { as: "문제점·권고", real: "발견사항·개선 권고", note: "" },
        { as: "시정 요구·확인", real: "후속 관리", note: "" },
      ],
  ...
  "common-audit-process": {
    guide: {
      hook: "정보시스템 감리를 '예비→현장→종료'로 수행하는 표준 절차입니다.",
      scene: "감리도 절차대로 해야 객관적입니다. 사전에 계획을 세우고(예비), 현장에서 산출물·활동을 점검하고(현장), 결과를 정리해 보고합니다(종료). 각 단계의 산출물이 정해져 있습니다.",
      ...
      map: [
        { as: "계획 수립", real: "예비 감리", note: "" },
        { as: "산출물·활동 점검", real: "현장 감리", note: "" },
        { as: "결과보고·권고", real: "종료 감리", note: "" },
        { as: "시정조치 확인", real: "실효성", note: "" },
      ],
  ...
  "audit-mandatory": {
    guide: {
      hook: "'어떤 사업이 감리 의무 대상인지'와 감리의 3대 점검 관점을 정한 기준입니다.",
      scene: "모든 정보화 사업을 감리하진 않습니다. 일정 규모·중요도(예산·대국민 서비스) 이상이면 감리가 의무입니다. 감리는 사업이 제대로 가는지 3가지 관점(사업관리·품질보증·구축)으로 점검합니다.",
      ...
      map: [
        { as: "규모·중요도 이상 의무", real: "감리 의무 대상", note: "" },
        { as: "PM 적정성", real: "사업관리 관점", note: "①" },
        { as: "방법론·산출물 준수", real: "품질보증 관점", note: "②" },
        { as: "구축 품질", real: "응용시스템 관점", note: "③" },
      ],
  ...
  "ops-maintenance-audit": {
    guide: {
      hook: "운영·유지보수 단계 정보시스템이 '제대로 관리되는지' 제3자가 점검하는 감리입니다.",
      scene: "시스템은 구축 후 운영·유지보수 단계가 훨씬 깁니다. 이 감리는 운영·유지보수가 절차·품질·보안 기준대로 이뤄지는지 독립적으로 점검해 개선을 권고합니다.",
      ...
      map: [
        { as: "운영 중 시스템 점검", real: "운영·유지보수 감리", note: "" },
        { as: "SLA·장애·변경 관리", real: "운영 관리 점검", note: "" },
        { as: "유지보수 프로세스", real: "변경·회귀", note: "" },
        { as: "구축 감리와 다름", real: "지속 운영 적정성", note: "" },
      ],
  ...
  "oss-security-threat": {
    guide: {
      hook: "널리 쓰는 오픈소스에 '숨은 취약점·악성 코드'가 공급망 위협이 됩니다.",
      scene: "현대 SW의 대부분이 오픈소스로 조립됩니다. 그 오픈소스에 알려진 취약점(Log4j)이나 악성 코드(xz 백도어)가 있으면, 그걸 쓰는 모든 SW가 위험에 노출됩니다. 신뢰하는 부품의 오염입니다.",
      ...
      map: [
        { as: "알려진 취약점", real: "CVE(Log4Shell)", note: "" },
        { as: "간접 포함", real: "전이 의존성", note: "" },
        { as: "악성 패키지", real: "타이포스쿼팅·백도어", note: "xz" },
        { as: "SCA·SBOM 대응", real: "방어", note: "" },
      ],
  ...
  "fta": {
    guide: {
      hook: "'최종 사고에서 원인으로 거꾸로' 내려가며 논리 게이트로 분석하는 하향식 안전 기법입니다.",
      scene: "'시스템이 폭발했다'는 정상 사건에서 출발해, 그 원인이 되는 하위 사건들을 AND/OR 게이트로 연결하며 트리로 내려갑니다. 어떤 조합이 사고를 일으키는지 논리적으로 밝힙니다.",
      ...
      map: [
        { as: "사고에서 원인으로", real: "하향식·연역", note: "" },
        { as: "AND/OR 게이트", real: "논리 전개", note: "" },
        { as: "최소 원인 조합", real: "최소 절단 집합", note: "" },
        { as: "부품→영향 상향식", real: "FMEA와 대비", note: "" },
      ],
  ...
  "iso-14764": {
    guide: {
      hook: "소프트웨어 유지보수의 '유형·프로세스'를 정한 국제 표준입니다.",
      scene: "유지보수를 주먹구구로 하면 사고가 납니다. ISO 14764는 유지보수를 4유형으로 분류하고, 요청부터 완료까지의 프로세스를 표준화해 체계적으로 관리하게 합니다.",
      ...
      map: [
        { as: "4유형 분류", real: "수정·적응·완전·예방", note: "" },
        { as: "요청→분석→구현", real: "유지보수 프로세스", note: "" },
        { as: "12207 상세화", real: "생명주기 연계", note: "" },
        { as: "변경 관리", real: "영향 분석·회귀", note: "" },
      ],
  ...
  "mccabe": {
    guide: {
      hook: "'코드의 분기 복잡도'를 수치로 재는 순환 복잡도(Cyclomatic Complexity)입니다.",
      scene: "if·while이 많을수록 코드가 복잡하고 테스트할 경로가 많아집니다. McCabe 복잡도는 제어 흐름의 독립 경로 수를 세어 복잡도를 정량화하고, 테스트 케이스 수·유지보수 위험을 가늠합니다.",
      ...
      map: [
        { as: "분기점 수 + 1", real: "V(G) 계산", note: "E−N+2" },
        { as: "독립 경로 수", real: "테스트 케이스 수", note: "기본 경로" },
        { as: "10 초과면 위험", real: "임계값", note: "리팩토링" },
        { as: "복잡도 정량화", real: "품질 측정", note: "" },
      ],
  ...
  "maintenance": {
    guide: {
      hook: "출시 후 SW를 '수정·개선·적응'시키는 활동 — 전체 비용의 대부분을 차지합니다.",
      scene: "SW는 출시가 끝이 아니라 시작입니다. 버그를 고치고, 환경 변화에 맞추고, 기능을 개선하고, 미래 문제를 예방합니다. 유지보수가 SW 총비용의 60~80%를 차지합니다.",
      ...
      map: [
        { as: "결함 수정", real: "수정(Corrective)", note: "사후" },
        { as: "환경 변화 대응", real: "적응(Adaptive)", note: "" },
        { as: "기능·성능 개선", real: "완전(Perfective)", note: "비중 최대" },
        { as: "사전 예방", real: "예방(Preventive)", note: "" },
      ],
  ...
  "commercial-sw-quality-test": {
    guide: {
      hook: "공공이 도입하는 '상용 SW의 품질·성능을 시험'하는 제도입니다.",
      scene: "공공기관이 상용 SW를 살 때 품질이 검증돼야 합니다. 이 시험은 상용 SW의 기능·성능을 표준 기반으로 평가해, 조달 시 품질을 보증하고 부실 도입을 막습니다.",
      ...
      map: [
        { as: "상용 SW 시험", real: "COTS 품질·성능", note: "" },
        { as: "ISO 25051 기준", real: "상용 품질 요구", note: "" },
        { as: "조달 품질 보증", real: "목적", note: "" },
        { as: "GS 인증 연계", real: "관계", note: "" },
      ],
  ...
  "function-point": {
    guide: {
      hook: "'사용자에게 보이는 기능'을 기준으로 SW 규모를 재는 언어 독립적 방법입니다.",
      scene: "코드 라인 수는 언어마다 다르고 구현 후에야 압니다. 기능 점수는 사용자 관점의 기능(입력·출력·조회·파일·인터페이스)을 세어, 구현 전에도 언어와 무관하게 규모를 산정합니다.",
      ...
      map: [
        { as: "내부/외부 파일", real: "데이터 기능(ILF·EIF)", note: "" },
        { as: "입력·출력·조회", real: "트랜잭션(EI·EO·EQ)", note: "" },
        { as: "복잡도 가중치", real: "미조정 FP", note: "" },
        { as: "언어 독립·초기 산정", real: "장점", note: "대가 표준" },
      ],
  ...
  "sw-cost": {
    guide: {
      hook: "공공 SW 사업의 '적정 대가를 산정'하는 국가 기준('25년 개정판)입니다.",
      scene: "SW 개발·유지보수·운영에 얼마를 줄지 주먹구구면 저가 수주·품질 저하가 생깁니다. 사업대가 산정 가이드는 기능점수 기반으로 적정 대가를 계산해, 공정한 발주와 SW 제값 받기를 돕습니다.",
      ...
      map: [
        { as: "기능점수×단가", real: "개발비 산정", note: "주류" },
        { as: "맨먼스×단가", real: "유지관리(SM)", note: "" },
        { as: "개발·유지보수·운영", real: "대가 유형", note: "" },
        { as: "SaaS·AI 반영", real: "25년 개정", note: "" },
      ],
  ...
  "obfuscation": {
    guide: {
      hook: "코드를 '일부러 읽기 어렵게' 변형해 역공학·변조를 늦추는 보호 기법입니다.",
      scene: "설계도를 알아보기 어렵게 뒤섞어 경쟁사·해커가 못 베끼게 합니다. 기능은 그대로 두되 이름·흐름·문자열을 꼬아 분석 비용을 폭증시킵니다. 완전 차단이 아니라 지연이 목적입니다.",
      ...
      map: [
        { as: "이름 뒤섞기", real: "레이아웃 난독화", note: "약함" },
        { as: "글자 암호화", real: "데이터 난독화", note: "" },
        { as: "흐름 스파게티", real: "제어 흐름 난독화", note: "강함" },
        { as: "자체 언어 변환", real: "가상화", note: "최강" },
      ],
