...
export const EXTRAS: Record<string, SubnoteExtra> = {
  ...
  "sbom": {
    guide: {
      ...
      scene: "식품 포장의 성분표처럼, SW에도 어떤 오픈소스·부품으로 만들어졌는지 적은 목록이 필요합니다. SBOM이 바로 이 성분표로, 문제 재료 파동(취약점, 예: Log4j)이 터졌을 때 '우리 제품에 그 재료가 들었나'를 즉시 확인해 대응하게 해 줍니다.",
      ...
      map: [
        { as: "식품 성분표", real: "구성요소 명세", note: "" },
        { as: "성분표 쓰는 공통 서식", real: "표준 포맷", note: "SPDX·CycloneDX" },
        { as: "문제 재료 든 제품 즉시 찾기", real: "핵심 활용", note: "Log4j" },
        { as: "공장에서 자동으로 찍혀 나옴", real: "SCA 도구", note: "빌드 시 생성" },
      ],
  ...
  "direct-purchase": {
    guide: {
      hook: "급식을 통째로 맡기지 말고, 쌀만큼은 학교가 직접 사게 하는 제도입니다.",
      scene: "학교 급식을 통째로 한 업체에 맡기면 쌀·반찬 납품가가 후려쳐지기 쉽습니다. 직접구매(분리발주)는 마치 쌀만큼은 학교가 산지에서 직접 사는 것과 같이, 일정 금액 이상의 상용 SW를 구축 사업(SI)에서 떼어 내 발주기관이 직접 사게 해 SW 기업이 제값을 받도록 합니다.",
      ...
      map: [
        { as: "쌀만 떼어 따로 주문", real: "분리발주", note: "" },
        { as: "학교가 산지에서 직접 구매", real: "직접구매", note: "" },
        { as: "납품가 후려치기 방지", real: "목적", note: "제값·하도급 개선" },
        { as: "직접 살 만한지 먼저 검토", real: "제도 흐름", note: "영향평가 연계" },
      ],
  ...
  "sw-impact-assessment": {
    guide: {
      hook: "동네에 이미 빵집이 있는데 구청이 빵집을 차리진 않는지 미리 살피는 제도입니다.",
      scene: "구청이 직접 빵집을 차리면 동네 빵집들은 장사가 어려워지니, 차리기 전에 '이미 파는 빵이 있는지'부터 확인해야 합니다. SW사업 영향평가가 딱 이 확인 절차로, 공공기관이 SW를 새로 개발하기 전에 민간에서 이미 파는 제품(상용 SW)과 겹치는지 평가해, 겹치면 사서 쓰도록(직접구매) 유도합니다.",
      ...
      map: [
        { as: "동네에 같은 빵집 있나 조사", real: "영향 평가", note: "" },
        { as: "있으면 사다 쓰기 권고", real: "구매 유도", note: "상용 SW 대체" },
        { as: "골목상권 지키기·중복 방지", real: "목적", note: "" },
        { as: "사다 쓰기 제도로 이어짐", real: "제도", note: "직접구매 연계" },
      ],
  ...
  "feasibility-study": {
    guide: {
      hook: "큰 다리를 놓기 전에 '정말 놓을 가치가 있나'부터 따지는 사전 조사입니다.",
      scene: "수백억짜리 다리는 삽을 뜨기 전에 통행량이 나올지(경제성), 나라 계획에 맞는지(정책성), 지반에 세울 수 있는지(기술성)부터 따집니다. 정보화 예비타당성 조사가 딱 이 사전 조사로, 대형 공공 정보화 사업을 세 측면에서 분석하고 저울질 기법(AHP)으로 종합해 시행 여부를 정합니다.",
      ...
      map: [
        { as: "통행량 대비 공사비", real: "경제성(B/C·NPV)", note: "" },
        { as: "나라 계획에 맞나", real: "정책성", note: "" },
        { as: "지반 위에 세울 수 있나", real: "기술성", note: "" },
        { as: "세 저울을 하나로 종합", real: "시행 결정", note: "AHP" },
      ],
  ...
  "sw-safety-guideline": {
    guide: {
      hook: "고장이 곧 인명 사고가 되는 SW를 위한, 놀이기구 안전 규정 같은 지침입니다.",
      scene: "놀이공원 기구는 볼트 하나만 풀려도 인명 사고라, 설계부터 운행까지 위험 요소를 미리 찾고 등급별 안전 규정을 지킵니다. SW 안전 지침도 이와 같이 자동차·의료기기처럼 오작동이 곧 사고인 SW에 대해, 위험을 찾아 분석하고(FTA·STPA 등) 위험이 클수록 엄격한 수준(SIL)을 매겨 만들고 검증하게 합니다.",
      ...
      map: [
        { as: "고장이 사고로 못 가게 차단", real: "기능 안전", note: "" },
        { as: "위험 요소 미리 찾기", real: "FTA·FMEA·STPA", note: "" },
        { as: "위험할수록 엄격한 등급", real: "SIL", note: "" },
        { as: "업종별 안전 규정집", real: "안전 표준", note: "IEC 61508·26262" },
      ],
  ...
  "se-135": {
    guide: {
      hook: "채점표를 먼저 만들어 두고, 그걸 통과할 만큼만 코드를 짜는 개발법입니다.",
      scene: "요리 대회를 준비할 때 심사 채점표를 먼저 받아 두면, 채점표에 맞춰 연습하니 헛수고가 없습니다. TDD가 딱 이 순서로, 실패하는 테스트(채점표)를 먼저 쓰고(Red) 통과할 최소한의 코드만 짜고(Green) 코드를 정리하는(Refactor) 짧은 반복을 돌립니다.",
      ...
      map: [
        { as: "채점표부터 만들기", real: "Red", note: "실패 테스트=요구 명세" },
        { as: "채점표 통과할 만큼만 요리", real: "Green", note: "최소 코드" },
        { as: "요리 뒤 주방 정리", real: "Refactor", note: "테스트가 안전망" },
        { as: "고칠 때마다 채점표로 안심", real: "효과", note: "회귀 방지" },
      ],
  ...
  "se-139": {
    guide: {
      hook: "만드는 팀과 돌리는 팀의 벽을 허물어 한 팀처럼 일하게 하는 문화입니다.",
      scene: "식당에서 주방(만드는 쪽)과 홀(손님을 맞는 쪽)이 서로 탓만 하면 음식도 서비스도 느려집니다. DevOps는 이 둘을 한 팀으로 묶는 문화처럼 개발(Dev)과 운영(Ops)을 붙이고, 새 메뉴가 자동으로 검사·전달되는 컨베이어(CI/CD)를 깔아 자주·안전하게 내놓게 합니다.",
      ...
      map: [
        { as: "주방과 홀이 한 팀", real: "협업 문화", note: "" },
        { as: "재료 들어올 때마다 자동 검사", real: "CI", note: "자동 빌드·테스트" },
        { as: "완성되면 자동으로 상 내가기", real: "CD", note: "자동 릴리스" },
        { as: "주방 설비도 레시피로 적어 둠", real: "IaC", note: "인프라 코드화" },
      ],
  ...
  "se-141": {
    guide: {
      hook: "감이 아니라 '숫자와 자동화'로 가게를 돌리는 구글식 운영 방식입니다.",
      scene: "노련한 가게는 '하루 불만 접수 3건까지는 새 메뉴 실험을 계속한다'처럼 허용선을 숫자로 정해 두고 장사합니다. SRE가 딱 이 방식으로, 서비스 수준을 지표(SLI)와 목표(SLO)로 정하고 목표에서 남는 여유분(오류 예산)만큼만 과감히 새 기능을 내며, 반복 수작업(Toil)은 자동화로 없앱니다.",
      ...
      map: [
        { as: "재는 항목과 목표치", real: "SLI/SLO", note: "" },
        { as: "불만 3건까지는 실험 계속", real: "오류 예산(1−SLO)", note: "속도·안정 균형" },
        { as: "허드렛일은 기계에 맡김", real: "Toil 자동화", note: "" },
        { as: "탓하지 않는 반성회", real: "포스트모템", note: "" },
      ],
  ...
  "se-143": {
    guide: {
      hook: "가게 문을 닫지 않고 주방을 새것으로 바꾸는 요령 세 가지입니다.",
      scene: "영업을 멈추지 않고 주방을 바꾸려면 옆에 새 주방을 통째로 차려 손님을 한 번에 안내하거나, 일부 손님만 먼저 보내 보거나, 화구를 하나씩 갈아 끼웁니다. 무중단 배포가 딱 이 방식으로, 구·신 버전을 나란히 두고 손님(트래픽)을 서서히 넘기며 문제가 나면 즉시 되돌립니다(롤백).",
      ...
      map: [
        { as: "새 주방 차려 한 번에 안내", real: "블루-그린", note: "즉시 롤백·자원 2배" },
        { as: "손님 5%만 먼저 새 주방으로", real: "카나리", note: "위험 최소" },
        { as: "화구 하나씩 교체", real: "롤링", note: "자원 효율" },
        { as: "문제면 옛 주방으로 되돌림", real: "롤백", note: "" },
      ],
  ...
  "se-145": {
    guide: {
      hook: "코드가 손님상에 오르기까지의 컨베이어 벨트를 설계·관리하는 공학입니다.",
      scene: "공장 컨베이어 벨트는 같은 재료를 넣으면 언제나 같은 제품이 나오고, 사람 손을 거의 타지 않습니다. 릴리스 엔지니어링이 딱 이 벨트 설계로, 코드를 빌드·검사·포장(버전)·배포해 출시하는 전 과정을 같은 입력이면 같은 결과가 나오게(재현성), 손대지 않아도 돌게(자동화) 만듭니다.",
      ...
      map: [
        { as: "같은 재료면 같은 제품", real: "재현성", note: "결정적 빌드" },
        { as: "사람 손 안 타는 벨트", real: "자동화", note: "" },
        { as: "진열해 두고 커튼은 나중에 걷기", real: "기능 플래그", note: "배포·릴리스 분리" },
        { as: "제품 번호 붙여 창고 보관", real: "빌드·저장소", note: "버전 관리" },
      ],
  ...
  "se-144": {
    guide: {
      hook: "약한 병균을 미리 넣어 보는 예방주사처럼, 일부러 고장을 내 보는 실천입니다.",
      scene: "예방주사는 약한 병균을 미리 넣어 몸이 견디는 힘을 확인하고 키웁니다. 카오스 엔지니어링도 이와 같이 통제된 범위에서 서버를 일부러 죽이거나 지연을 넣어(장애 주입) 시스템이 견디는지 실험하고, 드러난 약점을 사고가 나기 전에 고칩니다(넷플릭스 카오스 몽키).",
      ...
      map: [
        { as: "평소 건강 수치 기록", real: "정량 지표", note: "정상 상태" },
        { as: "이만하면 견딜 거라는 예상", real: "가설 수립", note: "" },
        { as: "약한 병균 조금만 주입", real: "장애 주입", note: "블라스트 반경 제한" },
        { as: "드러난 약점 미리 치료", real: "회복력 강화", note: "" },
      ],
  ...
  "sec-341": {
    guide: {
      hook: "출하 직전이 아니라 만드는 단계마다 위생 검사를 붙여 두는 생산 방식입니다.",
      scene: "식품 공장은 출하 직전에만 검사하지 않고 재료 입고·조리·포장 단계마다 위생 검사기를 달아 문제를 일찍 잡습니다. DevSecOps가 딱 이 방식으로, 개발·빌드·테스트·배포의 컨베이어(CI/CD) 곳곳에 자동 보안 검사(SAST·DAST·SCA)를 심어 속도를 늦추지 않고 취약점을 조기에 잡습니다.",
      ...
      map: [
        { as: "라인 곳곳의 위생 검사기", real: "파이프라인 단계별", note: "Shift Left" },
        { as: "조리 전 재료 검사", real: "SAST", note: "정적 분석" },
        { as: "완성품 시식 검사", real: "DAST", note: "동적 분석" },
        { as: "납품 재료 원산지 검사", real: "SCA", note: "공급망" },
      ],
  ...
  "se-149": {
    guide: {
      hook: "'벌레는 다 못 잡고, 같은 약만 치면 내성이 생긴다' 같은 테스트 상식 7가지입니다.",
      scene: "해충 방제에는 상식이 있습니다 — 벌레가 안 보여도 없다고 단정 못 하고, 온 집을 다 뒤질 수는 없으며, 벌레는 부엌 근처에 몰리고, 같은 약만 치면 내성이 생깁니다. 테스트 7원칙이 딱 이 상식으로, 결함 존재 입증·완벽 테스팅 불가·결함 집중(파레토)·살충제 역설 같은 통찰을 담습니다.",
      ...
      map: [
        { as: "안 보인다고 없는 게 아님", real: "결함 존재 입증", note: "①" },
        { as: "온 집을 다 뒤질 수는 없음", real: "완벽 테스팅 불가", note: "②" },
        { as: "벌레는 부엌에 몰림", real: "결함 집중", note: "④ 파레토" },
        { as: "같은 약만 치면 내성", real: "살충제 역설", note: "⑤" },
      ],
  ...
  "review": {
    guide: {
      hook: "인쇄기를 돌리기 전에 여러 사람이 원고를 돌려 읽으며 오탈자를 잡는 일입니다.",
      scene: "책은 인쇄를 돌린 뒤 오탈자를 발견하면 회수 비용이 크지만, 원고 단계에서 잡으면 헐값입니다. 리뷰도 이 교정 작업과 같이 프로그램을 실행하지 않고 코드·설계·요구서를 여러 눈으로 검토해(정적 테스트) 결함을 일찍 찾으며, 격식을 얼마나 갖추느냐에 따라 종류가 나뉩니다.",
      ...
      map: [
        { as: "인쇄 전 원고 돌려 읽기", real: "정적 테스트", note: "실행 없이" },
        { as: "전문 교열자의 정식 교정", real: "인스펙션", note: "가장 공식적" },
        { as: "작가가 직접 읽어 주며 설명", real: "워크스루", note: "" },
        { as: "인쇄 전에 잡으면 헐값", real: "효과", note: "조기 발견" },
      ],
  ...
  "se-156": {
    guide: {
      hook: "속은 안 열어 보고, 넣은 것과 나온 것만 보고 판정하는 테스트입니다.",
      scene: "자판기 검사원이 기계 속은 열지 않고 동전을 넣어 음료가 제대로 나오는지만 확인하는 것처럼, 블랙박스 테스트는 코드 내부를 모른 채 요구서(명세)대로 입력에 맞는 출력이 나오는지 봅니다. 모든 동전을 다 넣어 볼 수 없으니 같은 부류는 대표만 넣고(동등 분할), 말썽 많은 경계 금액을 집중해 봅니다(경계값 분석).",
      ...
      map: [
        { as: "속 안 열고 넣고-나옴만 확인", real: "명세 기반", note: "" },
        { as: "같은 부류 동전은 대표 하나만", real: "동등 분할", note: "" },
        { as: "잔돈 경계 금액 집중 확인", real: "경계값 분석", note: "경계에 결함 몰림" },
        { as: "조건 조합표 만들어 확인", real: "결정 표", note: "" },
      ],
  ...
  "se-158": {
    guide: {
      hook: "뚜껑을 열고 회로도를 보며 배선 하나하나를 점검하는 테스트입니다.",
      scene: "수리기사가 제품 뚜껑을 열고 회로도를 보며 모든 배선에 전기가 흐르는지 하나씩 점검하는 것처럼, 화이트박스 테스트는 코드 속 분기·갈림길을 보며 모든 문장과 경로가 실행되는지 확인합니다. 얼마나 훑었는지는 백분율 자(커버리지)로 재고, 갈림길 수(McCabe 복잡도)만큼 최소 점검 횟수를 잡습니다.",
      ...
      map: [
        { as: "뚜껑 열고 회로 보기", real: "구조 기반", note: "" },
        { as: "모든 전선에 전기 통했나", real: "구문 커버리지", note: "" },
        { as: "스위치마다 켜고 꺼 보기", real: "분기 커버리지", note: "참·거짓" },
        { as: "갈림길 수만큼 점검 횟수", real: "기본 경로(McCabe)", note: "" },
      ],
  ...
  "code-coverage": {
    guide: {
      hook: "'테스트가 코드를 몇 %나 훑었는지'를 재는 청소 검사 같은 척도입니다.",
      scene: "대청소 검사도 '방마다 들어갔나'만 볼 수도 있고 '서랍마다 열어 봤나'까지 볼 수도 있어 깐깐함의 등급이 있습니다. 커버리지가 딱 이 검사 기준으로, 테스트가 코드의 몇 %를 실행했는지를 문장→분기→조건 순으로 점점 깐깐하게 재며, 100%라도 결함이 없다는 보장은 아닙니다.",
      ...
      map: [
        { as: "방마다 들어갔나", real: "구문 커버리지", note: "가장 약함" },
        { as: "문마다 열고 닫아 봤나", real: "분기 커버리지", note: "" },
        { as: "서랍 하나하나 따로 검사", real: "MC/DC", note: "항공 필수" },
        { as: "다 훑어도 얼룩 남을 수 있음", real: "한계", note: "" },
      ],
  ...
  "se-160": {
    guide: {
      hook: "짜인 코스표 없이, 감 좋은 여행자처럼 수상한 곳을 파고드는 테스트입니다.",
      scene: "베테랑 여행자는 정해진 코스표 없이 골목을 걸으며 흥미로운 곳을 즉석에서 파고들되, '오늘 오후는 시장 구역'처럼 시간과 목표는 정해 둡니다. 탐색적 테스트가 딱 이 방식으로, 대본(스크립트) 없이 써 보며 배우기·설계·실행을 동시에 하되 시간 상자(세션)와 목표(차터)로 관리합니다(SBTM).",
      ...
      map: [
        { as: "걸으며 코스를 즉석 결정", real: "탐험적 접근", note: "설계·실행 동시" },
        { as: "오늘의 탐방 목표 메모", real: "테스트 차터", note: "세차노요" },
        { as: "오후 2~4시까지만 탐방", real: "테스트 세션", note: "SBTM" },
        { as: "안내서에 없는 명소 발견", real: "장점", note: "명세 밖 결함" },
      ],
  ...
  "exp-based-test": {
    guide: {
      hook: "차 소리만 듣고 고장 부위를 짚는, 노련한 정비사의 감 같은 테스트입니다.",
      scene: "오래된 정비사는 차 소리만 듣고도 '이 차종은 여기가 잘 고장 나요' 하며 바로 그 부위를 열어 봅니다. 경험 기반 테스트가 딱 이 감으로, 과거에 자주 깨지던 곳을 찍어 보고(에러 추정) 몰아 보며 즉석 점검하고(탐색적) 노하우 목록(체크리스트)으로 훑어, 정식 검사표(명세·구조 기반)가 놓친 결함을 보완합니다.",
      ...
      map: [
        { as: "이 차종은 여기가 잘 고장", real: "에러 추정", note: "" },
        { as: "몰아 보며 즉석 점검", real: "탐색적 테스트", note: "" },
        { as: "정비사의 노하우 목록", real: "체크리스트", note: "" },
        { as: "정식 검사표를 보완", real: "3대 접근", note: "명세·구조·경험" },
      ],
...
"cbam": {
    guide: {
      hook: "집수리 목록에서 '든 돈 대비 효과'가 큰 공사부터 하도록 순서를 매기는 평가입니다.",
      scene: "집수리 목록이 길면 '단열 공사 300만 원에 난방비 얼마 절약'처럼 공사마다 든 돈과 얻는 효과를 견줘 가성비 좋은 것부터 합니다. CBAM이 딱 이 셈법으로, 설계 선택지(아키텍처 전략)마다 비용과 효익을 매겨 투자 대비 효과(ROI)가 큰 결정부터 우선하며, 품질 저울질(ATAM)에 돈 계산을 더한 방법입니다.",
      ...
      map: [
        { as: "품질 따지기에 돈 계산 추가", real: "ATAM에 경제성 추가", note: "" },
        { as: "난방비 절약 같은 효과", real: "효익(Benefit)", note: "" },
        { as: "효과 나누기 공사비", real: "ROI", note: "우선순위" },
        { as: "가성비 좋은 공사부터", real: "의사결정", note: "" },
      ],
...
"class-diagram": {
    guide: {
      hook: "부품(클래스)들과 그 사이 관계를 그린, 시스템의 가족관계도입니다.",
      scene: "가족관계도를 보면 누가 누구의 자식이고 어느 집에 속했는지 한눈에 들어옵니다. 클래스 다이어그램이 딱 이런 관계도로, 부품(클래스)을 상자로 그리고 물려받기(상속), 팀과 선수처럼 따로 살 수 있는 소속(집합), 집과 방처럼 운명을 같이하는 소속(합성)을 선으로 이어 시스템 뼈대를 보여 줍니다.",
      ...
      map: [
        { as: "이름·특징·할 일 3칸 상자", real: "클래스 표기", note: "속성·메서드" },
        { as: "부모-자식 물려받기", real: "일반화", note: "빈 삼각형" },
        { as: "팀과 선수 — 따로 살 수 있음", real: "집합", note: "빈 마름모" },
        { as: "집과 방 — 운명 공동체", real: "합성", note: "채운 마름모" },
      ],
...
"usecase-diagram": {
    guide: {
      hook: "누가 와서 무엇을 시킬 수 있는지 그린, 가게 안내도 같은 그림입니다.",
      scene: "가게 안내도에 손님·배달기사 같은 사람들과 그들이 이용할 서비스(주문·포장·환불)를 선으로 이어 두면 가게가 뭘 해 주는지 한눈에 보입니다. 유스케이스 다이어그램이 딱 이 안내도로, 이용자(액터)와 기능(유스케이스)을 잇고 '주문엔 결제가 반드시 따라온다(include)'와 '쿠폰 할인은 있을 때만(extend)'을 구분해 그립니다.",
      ...
      map: [
        { as: "손님·배달기사", real: "액터", note: "바깥의 이용자" },
        { as: "주문·포장 같은 서비스", real: "유스케이스(타원)", note: "" },
        { as: "주문하면 결제는 필수", real: "include", note: "항상 포함" },
        { as: "쿠폰은 있을 때만", real: "extend", note: "조건부" },
      ],
...
"state-diagram": {
    guide: {
      hook: "택배가 '접수→배송 중→배달 완료'로 바뀌듯, 상태의 변화를 그린 그림입니다.",
      scene: "택배는 접수→상차→배송 중→배달 완료로 상태가 바뀌고, 고객 부재면 보관으로 빠지기도 합니다. 상태 다이어그램이 딱 이 배송 상태판으로, 객체가 가질 수 있는 상태들과 어떤 사건(이벤트)·조건(가드)에서 다음 상태로 넘어가는지(전이)를 그려 한 객체의 일생을 보여 줍니다.",
      ...
      map: [
        { as: "접수·배송 중·완료 팻말", real: "상태(State)", note: "" },
        { as: "다음 단계로 넘어감", real: "전이(Transition)", note: "화살표" },
        { as: "'부재 시'처럼 조건 붙은 사건", real: "이벤트·가드", note: "[조건]" },
        { as: "도착하면 알림 발송", real: "액션", note: "entry/exit" },
      ],
...
"sequence-diagram": {
    guide: {
      hook: "등장인물들이 시간 순서대로 대사를 주고받는 연극 대본 같은 그림입니다.",
      scene: "연극 대본에는 등장인물이 위에 나란히 적히고, 시간이 흐르며 누가 누구에게 어떤 대사를 건네는지 순서대로 내려갑니다. 시퀀스 다이어그램이 딱 이 대본으로, 객체들을 위에 세우고 세로줄(생명선)을 따라 메시지를 화살표로 그리며, 답을 기다리는 호출(동기)과 안 기다리는 호출(비동기)을 구분합니다.",
      ...
      map: [
        { as: "등장인물의 세로 대사줄", real: "생명선", note: "시간은 위→아래" },
        { as: "무대에 서 있는 구간", real: "활성화 바", note: "" },
        { as: "답 기다리는/안 기다리는 대사", real: "메시지", note: "동기/비동기" },
        { as: "'만약·반복' 지문", real: "결합 프래그먼트", note: "alt·loop" },
      ],
...
"se-94": {
    guide: {
      hook: "큰 줄거리 판 사이사이에 상세 장면 대본을 끼워 넣은 그림입니다.",
      scene: "영화 기획은 전체 줄거리를 흐름도 한 장으로 잡고, 중요한 장면에만 상세 대본을 끼워 붙입니다. 상호작용 개요 다이어그램이 딱 이 구성으로, 큰 흐름(활동 다이어그램의 분기·병합) 위에 자세한 대사 장면(시퀀스 다이어그램)을 상자로 배치해, 언제 어떤 상호작용이 일어나는지 전체를 조망하게 합니다.",
      ...
      map: [
        { as: "줄거리 흐름 판", real: "제어 흐름 표기", note: "분기·병합" },
        { as: "끼워 넣은 상세 장면 대본", real: "상호작용 배치", note: "시퀀스" },
        { as: "장면들의 순서 한눈에", real: "전체 흐름", note: "" },
        { as: "대본 4형식 중 조망용", real: "고수준 조망", note: "상호작용 4종" },
      ],
...
"msa": {
    guide: {
      hook: "주방 하나짜리 대형 식당을, 가게마다 독립된 푸드코트로 바꾼 구조입니다.",
      scene: "주방 하나로 모든 메뉴를 내는 대형 식당은 튀김기 하나만 고쳐도 온 주방을 세워야 합니다. MSA는 푸드코트처럼 기능(주문·결제·배송)마다 독립된 작은 가게(서비스)로 쪼개, 가게마다 따로 열고 고치고 늘리며(독립 배포·확장) 각자 자기 창고(서비스별 DB)를 씁니다.",
      ...
      map: [
        { as: "가게마다 독립된 푸드코트", real: "MSA", note: "" },
        { as: "가게마다 자기 창고", real: "Database per Service", note: "" },
        { as: "입구의 공동 주문대", real: "API Gateway", note: "단일 진입" },
        { as: "가게가 많아 관리 복잡", real: "단점", note: "일관성·운영" },
      ],
...
"se-70": {
    guide: {
      hook: "몇 호실에 누가 있는지 몰라도 되게, 손님을 다 받아 주는 호텔 프런트입니다.",
      scene: "호텔 손님은 프런트만 찾으면 되고, 방 배정·신원 확인·민원 접수는 프런트가 한꺼번에 처리합니다. API Gateway가 딱 이 프런트로, 수십 개 서비스로 가는 모든 요청을 한 입구에서 받아 신분 확인(인증), 방 안내(라우팅), 몰림 조절(속도 제한)을 중앙에서 처리하며, 프런트가 마비되면 전체가 서니(단일 실패점) 이중화가 필요합니다.",
      ...
      map: [
        { as: "호텔의 하나뿐인 프런트", real: "게이트웨이", note: "단일 진입" },
        { as: "몇 호실로 갈지 안내", real: "라우팅", note: "" },
        { as: "신분 확인·몰림 조절", real: "공통 관심사", note: "인증·속도제한" },
        { as: "단체손님용 전용 프런트", real: "BFF", note: "클라이언트별" },
      ],
...
"saga-pattern": {
    guide: {
      hook: "호텔 예약이 실패하면 먼저 끊은 비행기표를 취소해 되돌리는 방식입니다.",
      scene: "여행 준비로 비행기표→호텔→렌터카를 차례로 예약하다 호텔이 실패하면, 이미 끊은 비행기표를 취소해 원상 복구합니다. Saga 패턴이 딱 이 방식으로, 서비스마다 장부(DB)가 따로인 MSA에서 각 서비스의 처리를 차례로 진행하다 실패하면 앞서 끝난 것들을 취소 작업(보상 트랜잭션)으로 되돌려, 결국 아귀를 맞춥니다(최종 일관성).",
      ...
      map: [
        { as: "표→호텔→차 차례 예약", real: "Saga", note: "로컬 트랜잭션 연쇄" },
        { as: "실패하면 앞 예약 취소", real: "보상 트랜잭션", note: "핵심" },
        { as: "서로 소식 주고받으며 알아서", real: "코레오그래피", note: "이벤트" },
        { as: "여행사 직원이 지휘", real: "오케스트레이션", note: "중앙 조정" },
      ],
...
"ddd": {
    guide: {
      hook: "현장 사람들이 쓰는 말 그대로, 업무를 중심에 놓고 설계하는 방식입니다.",
      scene: "큰 병원을 지을 때는 의사·간호사가 쓰는 말 그대로 요구를 적고, 외래·수술·입원처럼 업무 구역을 나눠 구역 안에서는 용어와 규칙이 일관되게 합니다. DDD가 딱 이 방식으로, 전문가와 개발자가 공통 언어(유비쿼터스 언어)를 쓰고 업무를 경계(바운디드 컨텍스트)로 나누며, 이 경계가 MSA 서비스를 자르는 기준이 됩니다.",
      ...
      map: [
        { as: "의사와 개발자가 같은 말", real: "유비쿼터스 언어", note: "" },
        { as: "외래·수술 같은 업무 구역", real: "바운디드 컨텍스트", note: "MSA 경계" },
        { as: "구역 안의 한 묶음 규칙", real: "애그리거트", note: "루트로만 접근" },
        { as: "번호 있는 것 vs 값뿐인 것", real: "엔티티/값 객체", note: "" },
      ],
...
"eda": {
    guide: {
      hook: "'생선 들어왔어요!' 방송을 들은 가게들이 알아서 움직이는 구조입니다.",
      scene: "시장에서 '생선 들어왔어요!' 하고 방송하면, 그 소식이 필요한 가게들만 각자 알아서 움직이고 방송한 사람은 누가 듣는지 신경 쓰지 않습니다. 이벤트 기반 구조(EDA)가 딱 이 방송 방식으로, 한 서비스가 사건(이벤트)을 발행하면 구독한 서비스들이 각자 반응해, 서로 몰라도 되는 느슨한 연결 덕에 확장과 추가가 쉽습니다.",
...
"os-2": {
    image: "/concept/book/os-2.webp", images: ["/concept/extra/kernel-hand.webp"], imagesLabel: "구조(Architecture)",
    guide: {
...
"sw-methodology": {
    guide: {
      hook: "집 짓는 공법이 시대별로 발전했듯, SW 만드는 방식의 계보입니다.",
      scene: "집 짓기도 순서 중심의 재래식, 자재 규격 중심, 조립식 공법처럼 시대마다 유행하는 방식이 달라졌습니다. SW 개발 방식도 마치 이 계보와 같아, 일 순서 중심(구조적)→자료 중심(정보공학)→부품 묶음 중심(객체지향)→조립식(CBD)→짧게 반복(애자일)으로 발전했고, 현장에 맞게 고쳐 씁니다(테일러링).",
      ...
      map: [
        { as: "일 순서대로 위에서 아래로", real: "구조적(DFD)", note: "" },
        { as: "자재 목록·규격 중심", real: "정보공학(ERD)", note: "데이터" },
        { as: "부품 단위로 묶기", real: "객체지향(UML)", note: "" },
        { as: "짧게 짓고 고치며 반복", real: "애자일", note: "" },
      ],
...
"sw-design-principle": {
    guide: {
      hook: "잘 나누고, 속을 감추고, 비슷한 것끼리 묶는 이삿짐 정리의 기술입니다.",
      scene: "이삿짐은 방별로 상자를 나누고, 상자 속은 겉 라벨만 보이게 하고, 비슷한 물건끼리 담고, 상자끼리 끈으로 얽어 두지 않아야 옮기기 쉽습니다. SW 설계 원리가 딱 이 정리법으로, 크게 나누고(모듈화) 속을 감추고(정보 은닉) 관련 있는 것끼리 모으고(높은 응집도) 상자 간 의존을 줄여(낮은 결합도) 고치기 쉽게 만듭니다.",
      ...
      map: [
        { as: "라벨만 보고 다룸", real: "추상화", note: "본질만" },
        { as: "상자 속은 안 보이게", real: "정보 은닉", note: "" },
        { as: "비슷한 물건끼리 한 상자", real: "높은 응집도", note: "기능적 최상" },
        { as: "상자끼리 얽어 두지 않기", real: "낮은 결합도", note: "자료 최상" },
      ],
...
"polymorphism": {
    guide: {
      ...
      scene: "'출발!'이라는 같은 구령에 개는 달리고 새는 날고 물고기는 헤엄치는 것처럼, 다형성은 같은 명령(메시지)이라도 받는 객체에 따라 다르게 동작하는 성질입니다. 덕분에 새 동물(타입)을 추가해도 구령은 그대로면 되고, 누가 어떻게 움직일지는 그 순간의 실제 객체가 정합니다(동적 바인딩).",
      ...
      map: [
        { as: "같은 구령, 다른 준비물", real: "오버로딩(정적)", note: "컴파일 타임" },
        { as: "부모의 구령을 새로 익힘", real: "오버라이딩(동적)", note: "런타임" },
        { as: "그 순간의 동물이 결정", real: "동적 바인딩", note: "" },
        { as: "새 동물 추가에도 구령 그대로", real: "OCP 지원", note: "" },
      ],
...
"ood-principles": {
    guide: {
      ...
      scene: "일 잘하는 팀은 한 사람이 한 업무만 맡고, 일이 늘면 기존 사람을 뜯어고치는 대신 새 사람을 더하고, 후임이 선임 자리를 그대로 대신할 수 있게 인수인계합니다. SOLID가 딱 이 팀 규칙으로, 클래스는 한 책임만(SRP), 확장엔 열고 수정엔 닫고(OCP), 자식은 부모를 대체 가능하게(LSP), 창구는 잘게(ISP), 구체가 아닌 약속에 의존(DIP)하게 합니다.",
      ...
      map: [
        { as: "한 사람 한 업무", real: "SRP", note: "" },
        { as: "일 늘면 사람을 더, 기존은 그대로", real: "OCP", note: "다형성" },
        { as: "후임이 선임 자리 대신", real: "LSP", note: "" },
        { as: "사람이 아니라 약속을 보고 일함", real: "DIP", note: "DI" },
      ],
...
"law-of-demeter": {
    guide: {
      ...
      scene: "심부름은 친구에게 부탁하면 되지, 친구의 친구네 집 서랍까지 직접 뒤지면 관계가 얽히고 탈이 납니다. 데메테르 법칙이 딱 이 예절로, 객체는 직접 아는 상대(자신·매개변수·직접 만든 것·멤버)하고만 대화하게 해, 남의 집 속사정이 바뀌어도 내게 불똥이 튀지 않도록 결합을 낮춥니다.",
      ...
      map: [
        { as: "직접 아는 친구에게만 부탁", real: "최소 지식", note: "핵심" },
        { as: "친구네 서랍 직접 뒤지기 금지", real: "기차 충돌 회피", note: "안티패턴" },
        { as: "친구가 대신 전해 줌", real: "개선책", note: "위임 메서드" },
        { as: "이웃 일에 안 얽힘", real: "효과", note: "결합도 감소" },
      ],
...
"se-28": {
    guide: {
      hook: "차대 하나로 여러 차종을 뽑아내듯, 공통 부품으로 제품군을 찍어 내는 방식입니다.",
      scene: "자동차 회사는 차대(플랫폼) 하나를 잘 만들어 두고 지붕·시트만 바꿔 세단·SUV를 뽑아냅니다. SW 제품 라인이 딱 이 방식으로, 제품군이 공유하는 부분(공통성)은 핵심 자산으로 미리 만들고 제품마다 다른 부분(가변성)만 갈아 끼워 조립해, 생산성과 품질을 함께 높입니다.",
      ...
      map: [
        { as: "공용 차대", real: "공통성", note: "코어 자산" },
        { as: "차종별 지붕·시트", real: "가변성", note: "가변점" },
        { as: "차대 개발 부서", real: "도메인 공학", note: "자산 개발" },
        { as: "차종 조립 라인", real: "응용 공학", note: "제품 개발" },
      ],
...
"aop": {
    guide: {
      ...
      scene: "학교의 모든 교실에 안내 방송이 필요하다고 교실마다 방송 담당을 두면 낭비라서, 중앙 방송실 하나가 정해진 시간에 각 교실로 방송을 흘려보냅니다. AOP가 딱 이 방식으로, 어디서나 반복되는 공통 기능(횡단 관심사 — 로깅·보안)을 한 곳(Aspect)에 모아 두고, 정해진 지점(포인트컷)에 자동으로 끼워 넣습니다(위빙).",
      ...
      map: [
        { as: "교실마다 반복되는 안내 방송", real: "횡단 관심사", note: "" },
        { as: "중앙 방송실", real: "Aspect", note: "" },
        { as: "어느 교실에 언제 틀지 규칙", real: "Pointcut", note: "" },
        { as: "스피커로 흘려보내기", real: "Weaving·Advice", note: "" },
      ],
...
"tailoring": {
    guide: {
      hook: "기성복을 몸에 맞게 줄이고 늘리듯, 표준 절차를 프로젝트에 맞게 고치는 일입니다.",
      scene: "기성복 정장은 그대로 입기보다 소매를 줄이고 허리를 늘려 몸에 맞게 수선해야 태가 납니다. 테일러링이 딱 이 수선으로, 표준 개발 절차와 산출물을 프로젝트의 규모·기간·성격에 맞게 더하고 빼고 고쳐(추가·삭제·수정), 획일 적용의 비효율을 막습니다.",
      ...
      map: [
        ...
        { as: "체형·용도 따라 다르게", real: "테일러링 기준", note: "규모·기간·복잡도" },
        { as: "줄이고 늘리고 고치기", real: "조정 방법", note: "추가·삭제·수정" },
        { as: "기성복 그대로 안 입기", real: "목적", note: "획일 적용 방지" },
      ],
...
"req-engineering": {
    guide: {
      ...
      scene: "인테리어 공사는 집주인의 바람을 꼼꼼히 묻고, 서로 부딪히는 요청을 조율하고, 계약서에 또박또박 적고, 시공 전에 맞는지 확인해야 탈이 없습니다. 요구공학이 딱 이 절차로, 요구를 끌어내고(도출) 정리하고(분석) 문서로 남기고(명세, SRS) 검증(확인)하며, 이후의 변경은 장부(추적표, RTM)로 관리합니다.",
      ...
      map: [
        { as: "집주인 바람 꼼꼼히 묻기", real: "도출(수집기법)", note: "" },
        { as: "부딪히는 요청 조율", real: "분석", note: "우선순위" },
        { as: "계약서에 또박또박 적기", real: "명세", note: "SRS" },
        { as: "시공 전 맞는지 확인", real: "확인(리뷰)", note: "" },
      ],
...
"iso-42010": {
    guide: {
      hook: "건축 도면을 '누구를 위해 어떤 규칙으로 그릴지' 정한 국제 규격입니다.",
      scene: "건축 도면은 입주자·시공사·설비공마다 궁금한 게 달라, 누구를 위한 도면인지와 그리는 규칙부터 정해야 서로 통합니다. ISO 42010이 딱 이 규칙으로, 이해관계자의 관심사마다 그리는 규칙(관점)을 정하고 그 규칙대로 그림(뷰)을 그려 설계 문서(아키텍처 기술서)에 담게 합니다.",
      ...
      map: [
        { as: "도면 볼 사람과 궁금증", real: "이해관계자·관심사", note: "" },
        { as: "도면 그리는 규칙", real: "관점(Viewpoint)", note: "" },
        { as: "규칙대로 그린 도면", real: "뷰(View)", note: "" },
        { as: "도면 세트의 대표 사례", real: "구체화", note: "4+1 뷰" },
      ],
...
"sw-arch-process": {
    guide: {
      hook: "요구 듣기→설계→도면→검증으로 이어지는, 건축 설계 같은 절차입니다.",
      scene: "건축가는 건축주의 핵심 요구(채광·내진)를 먼저 추리고, 그에 맞는 공법을 골라 설계하고, 도면으로 남기고, 구조 검토를 받습니다. 설계 뼈대(아키텍처)를 세우는 절차가 딱 이 순서로, 품질 요구(드라이버)를 뽑고 스타일·패턴을 골라 설계(ADD)하고 관점별 도면(4+1 뷰)으로 남긴 뒤 평가(ATAM·CBAM)로 검증하며, 이를 반복합니다.",
      ...
      map: [
        { as: "채광·내진 같은 핵심 요구", real: "드라이버 도출", note: "" },
        { as: "요구에 맞는 공법 고르기", real: "아키텍처 설계(ADD)", note: "" },
        { as: "관점별 도면 남기기", real: "4+1 뷰·42010", note: "" },
        { as: "구조 검토 받기", real: "ATAM·CBAM", note: "평가" },
      ],
...
"se-67": {
    guide: {
      hook: "가장 안 바뀌는 것을 가장 안쪽 방에 모시는 동심원 구조입니다.",
      scene: "궁궐은 한가운데에 임금이 있고 바깥 행랑채는 자주 바뀌어도 안채는 그대로이며, 출입과 보고는 언제나 바깥에서 안쪽으로만 향합니다. 클린 설계(클린 아키텍처)가 딱 이 구조로, 핵심 업무 규칙(엔티티·유스케이스)을 중심에 두고 자주 바뀌는 것들(DB·웹 틀·UI)을 바깥에 둬 의존이 항상 안쪽만 향하게 하니, 바깥을 통째로 갈아도 중심은 안전합니다.",
      ...
      map: [
        { as: "한가운데 안채", real: "엔티티·유스케이스", note: "핵심 규칙" },
        { as: "자주 바뀌는 바깥 행랑채", real: "세부사항", note: "DB·프레임워크" },
        { as: "출입은 바깥→안쪽만", real: "의존성 규칙", note: "핵심" },
        { as: "문지방에서 방향 뒤집기", real: "DIP", note: "경계" },
      ],
...
"sw-arch-driver": {
    guide: {
      hook: "수백 가지 주문 중 '집의 뼈대를 결정하는' 몇 가지 핵심 요구입니다.",
      scene: "집을 지을 때 벽지 색은 나중에 바꿔도 되지만 '3층으로, 지진에 견디게, 예산은 얼마까지'는 뼈대를 결정합니다. 설계를 이끄는 핵심 요구(아키텍처 드라이버)가 딱 이런 요구로, 핵심 기능과 품질 속성(성능·가용성 등 — 가장 중요), 협상 불가한 제약을 먼저 추려 설계 방향(스타일·패턴 선택)을 이끌게 합니다.",
      ...
      map: [
        { as: "꼭 있어야 할 방 구성", real: "기능 요구", note: "" },
        { as: "지진에 견딜 것·볕 잘 들 것", real: "품질 속성", note: "가장 중요" },
        { as: "예산·법규처럼 못 바꾸는 것", real: "제약사항", note: "협상 불가" },
        { as: "집 뼈대를 결정", real: "설계 견인", note: "" },
      ],
...
"utility-tree": {
    guide: {
      hook: "막연한 바람을 가지치기해 구체 소원으로 만들고 순위를 매기는 나무입니다.",
      scene: "'좋은 집'이라는 막연한 바람은 따뜻함→단열→'한겨울에도 실내 20도'처럼 가지를 쳐 내려가야 손에 잡힙니다. 유틸리티 트리가 딱 이 가지치기로, 품질(뿌리)에서 속성(성능·보안)을 거쳐 구체 시나리오(잎)까지 내려간 뒤 잎마다 중요도·난이도(H/M/L)를 매겨, 구조 평가(ATAM)에서 어디부터 볼지 정합니다.",
      ...
      map: [
        { as: "바람을 가지치기", real: "유틸리티→속성→시나리오", note: "" },
        { as: "'한겨울 실내 20도' 같은 잎", real: "품질 속성 시나리오", note: "" },
        { as: "잎마다 중요·난이 스티커", real: "우선순위", note: "H/M/L" },
        { as: "평가에서 볼 곳 고르기", real: "역할", note: "ATAM" },
      ],
...
"sw-arch-style": {
    guide: {
      hook: "검증된 설계 구조의 '전형적 틀'(아키텍처 스타일) — 계층형·MSA·이벤트 등입니다.",
      scene: "집을 지을 때 한옥·아파트·상가 같은 검증된 틀에서 고르지, 매번 새 구조를 발명하지 않습니다. 소프트웨어 뼈대(아키텍처)도 마찬가지로 계층으로 나눌지(계층형), 서비스로 쪼갤지(MSA), 사건으로 연결할지(이벤트 기반) 문제 유형에 맞는 스타일을 골라 쓰며, 스타일마다 장단과 적합 상황이 다릅니다.",
...
"se-59": {
    guide: {
      hook: "설계 뼈대(아키텍처)가 '품질 요구를 충족하는지' 이해관계자와 검증하는 활동입니다.",
      scene: "다 지은 건물을 부수고 고치는 것처럼, 구현이 끝난 뒤 구조 문제를 발견하면 비용이 몇 배로 듭니다. 그래서 설계 단계에서 '이 구조로 성능·보안·수정용이성이 될까'를 시나리오로 점검해 위험·트레이드오프를 조기에 찾는 활동이 구조 평가(아키텍처 평가)이고, 대표가 ATAM입니다.",
...
"gj-144": {
    guide: {
      ...
      scene: "치킨집을 차릴까 말까 고민할 때 '몇 년이면 본전을 뽑나'를 따져 보는 것처럼, 프로젝트 투자 전 '남는 장사인가'를 재무 지표로 검증합니다. 회수 기간(Payback), 투자 수익률(ROI), 화폐의 시간가치를 반영한 순현재가치(NPV)·내부수익률(IRR)로 대안을 비교해 의사결정을 돕습니다.",
      ...
      map: [
        ...
        { as: "본전이 되는 할인율(NPV=0)", real: "IRR", note: "자본비용 초과" },
...
"pm-24": {
    guide: {
      ...
      scene: "이사 견적을 낼 때 '어디까지 옮겨 주는지'를 먼저 못박는 것처럼, 프로젝트도 무엇을 하고 안 할지가 먼저입니다. 범위 관리는 요구를 모아 만들 것을 정의하고(범위기술서·WBS), 실제로 그 범위대로 됐는지 확인하며, 무단 변경(스코프 크립)을 통제합니다.",
...
"pm-25": {
    guide: {
      ...
      scene: "말 못 하는 환자의 증상을 의사가 문진·촉진·검사로 알아내는 것처럼, 고객도 원하는 것을 정확히 말하지 못하는 경우가 많습니다. 그래서 인터뷰·워크숍·설문·관찰·프로토타입 등 여러 수집 기법을 상황에 맞게 써서 요구사항을 빠짐없이 끌어냅니다.",
...
"pm-27": {
    guide: {
      ...
      scene: "잔칫상 준비를 국·반찬·후식으로 나누고 다시 장보기·조리로 쪼개 나눠 맡기는 것처럼, 큰 프로젝트도 통째로는 관리가 안 됩니다. WBS는 최종 산출물을 점점 작은 작업 패키지로 쪼개 트리로 만들어, 일정·비용·자원 배정과 진척 관리를 가능하게 합니다.",
...
"pm-30": {
    guide: {
      ...
      scene: "짜장면을 시켰는데 '탕수육도 조금만'이 계속 붙는 게 스코프 크립, 주방장이 시키지도 않은 코스 요리를 내오는 게 골드 플레이팅 — 딱 이 구도입니다. 합의 범위를 넘어 요구가 통제 없이 늘거나(크립), 개발자가 과잉 제공하면(골드 플레이팅) 일정·비용을 해치는 범위 이탈입니다.",
...
"duration-estimating": {
    guide: {
      ...
      scene: "이삿짐 견적을 낼 때 '지난번 비슷한 집은 5시간 걸렸다'거나 '박스 수×분당 시간'으로 셈하는 것처럼, 활동 기간도 여러 방법으로 추정합니다. 전문가 판단, 과거 실적(유사·유추 산정), 변수 계산(모수 산정), 불확실성 반영(3점 산정)을 상황에 맞게 씁니다.",
...
"pm-35": {
    guide: {
      ...
      scene: "'빠르면 3일, 늦으면 9일, 보통 5일' 같은 세 답을 받아 평균을 내면 감보다 훨씬 정확해집니다. 3점 산정이 딱 이 방식으로, 낙관(O)·비관(P)·최빈(M) 세 값을 가중 평균해 기대값을 구하고, 편차로 위험까지 계산합니다(PERT).",
...
"pm-36": {
    guide: {
      ...
      scene: "여러 요리를 동시에 준비해도 가장 오래 걸리는 찜이 끝나야 상이 차려지는 것처럼, 선후로 얽힌 활동 네트워크에선 가장 긴 경로(임계경로)가 전체 기간을 결정합니다. 이 경로의 활동이 지연되면 프로젝트 전체가 늦어지므로 집중 관리합니다.",
...
"pm-37": {
    guide: {
      ...
      scene: "'혹시 몰라서'라며 각자 숨겨 둔 여유 시간을 걷어, 공동 비상금처럼 프로젝트 끝에 모아 두는 방식입니다. CPM과 달리 사람·장비의 제약까지 고려한 임계 사슬을 찾고, 활동별 안전 시간을 걷어내 끝의 버퍼로 모아 관리합니다(골드랫 TOC).",
...
"schedule-compression": {
    guide: {
      ...
      scene: "마감이 급한 김장에 일손을 더 부르거나, 절이기와 속 만들기를 동시에 벌이는 것처럼 일정 단축은 두 길입니다. 임계경로에 자원을 더 투입하는 공정 압축(Crashing — 비용 증가)과, 순차 활동을 병렬로 겹치는 공정 중첩(Fast Tracking — 재작업 위험)이며 각각 대가가 있습니다.",
...
"pm-46": {
    guide: {
      ...
      scene: "'감으로 70% 했다'가 아니라, 가계부처럼 계획한 돈·번 돈·쓴 돈을 견줘 보는 방식입니다. EVM은 계획가치(PV)·획득가치(EV)·실제원가(AC) 세 값으로 '얼마나 진척됐고 예산·일정을 지키는지'를 숫자로 보여 주고, 완료 시점까지 예측합니다.",
      ...
      map: [
        ...
        { as: "일정·비용 지수 진단(SPI·CPI)", real: "성과 지수", note: "1미만=문제" },
      ],
...
"pm-50": {
    guide: {
      ...
      scene: "불량을 감이 아니라 건강검진 수치처럼 데이터로 봅니다. 원인을 뼈대로 그리고(특성요인도), 빈도 순으로 정렬하고(파레토), 분포를 보고(히스토그램), 관계를 보고(산점도), 공정 안정을 감시하는(관리도) 통계적 품질 관리의 기본 세트(QC 7)입니다.",
...
"pm-51": {
    guide: {
      ...
      scene: "여럿이 '최종_진짜최종_v3' 파일을 만들며 헤매는 것처럼, 산출물은 누가 뭘 왜 바꿨는지 금세 엉킵니다. 형상 관리는 관리 대상을 식별하고, 변경을 통제하고, 상태를 기록하고, 검증해 산출물의 무결성과 일관성을 지킵니다.",
...
"sw-quality-cost": {
    guide: {
      ...
      scene: "보일러를 미리 점검하는 돈, 검침하는 돈, 한겨울에 터져 물난리로 무는 돈 — 딱 이 구분입니다. 품질 비용도 예방(미리 막기)·평가(검사)·실패(내부·외부) 비용으로 나뉘며, 예방·평가에 투자하면 실패 비용이 크게 줄어드는 것이 핵심입니다.",
...
"pm-53": {
    guide: {
      ...
      scene: "모임 회비는 누가 걷고 장부는 누가 확인하는지 당번표를 붙이는 것처럼, '이 일 누가 하기로 했지?' 혼선을 막습니다. RACI는 작업(행)×역할(열) 표에 실행(R)·책임(A)·자문(C)·통보(I)를 채워 책임 관계를 명확히 합니다.",
...
"pm-40": {
    guide: {
      ...
      scene: "한 알바생에게 주문·서빙·설거지가 몰리면 교대표를 다시 짜는 것처럼 부하를 고르게 폅니다. 자원 평준화는 자원 제약에 맞춰 일정 자체를 조정(임계경로·완료일 변동 가능)하고, 자원 평활화는 여유 시간(Float) 안에서만 조정해 완료일을 지킵니다.",
...
"pm-55": {
    guide: {
      ...
      scene: "월급만 올려 줘도 열심히 하지 않는 직원처럼, 사람은 저마다 다른 것에 움직입니다. 욕구 단계(매슬로), 위생 vs 동기 요인(허즈버그), 기대와 보상(브룸), X·Y 인간관 등 고전 이론으로 팀원 동기부여와 관리 전략을 세웁니다.",
...
"pm-56": {
    guide: {
      ...
      scene: "조별과제 팀이 서먹한 탐색기와 다툼을 지나야 손발이 맞는 것처럼, 팀은 형성(탐색)→혼란(갈등)→규범(규칙)→수행(성과)→해산의 5단계를 거쳐 성숙합니다(터크만 모델). 단계마다 필요한 리더십이 다릅니다.",
...
"conflict-management": {
    guide: {
      ...
      scene: "부부싸움에서 이기려 들거나, 져 주거나, 피하거나, 반씩 물러서거나, 마주 앉아 둘 다 좋은 답을 찾는 것처럼 갈등 대응은 다섯 가지입니다(토마스-킬만). 경쟁·수용·회피·타협·협력 중 협력이 최선이지만, 상황에 따라 맞는 방식을 고릅니다.",
      ...
      map: [
        ...
        { as: "둘 다 만족하는 답(Win-Win)", real: "협력(Collaborating)", note: "최선" },
      ],
...
"pm-59": {
    guide: {
      ...
      scene: "등산 전에 날씨·낙석 위험을 미리 살피고 우비를 챙기는 것처럼, 프로젝트도 불확실성을 미리 다룹니다. 무엇이 위험인지 찾고(식별), 얼마나 위험한지 재고(정성·정량 분석), 어떻게 대응할지 정하고(대응계획), 계속 감시하는(통제) 절차입니다.",
...
"pm-62": {
    guide: {
      ...
      map: [
        ...
        { as: "대안별 기대 손익 비교(EMV)", real: "의사결정 트리", note: "" },
...
"pm-64": {
    guide: {
      ...
      scene: "태풍 예보에 여행을 취소하거나(회피), 보험을 들거나(전가), 창문을 보강하거나(완화), 그냥 감수하는(수용) 것처럼 위협 대응은 4가지입니다. 좋은 위험(기회)은 반대로 활용·공유·증대·수용 4가지로 살립니다. 위험마다 맞는 전략을 고릅니다.",
...
"pm-14": {
    guide: {
      ...
      scene: "정해진 레시피집에서 '좋은 요리의 원칙집'으로 바뀐 셈입니다. 6판이 5프로세스군·10지식영역이라는 '어떻게'였다면, 7판은 특정 개발 방식(예측·애자일)에 얽매이지 않고 지켜야 할 12원칙과 달성할 8성과영역, 즉 '무엇/왜' 중심으로 재편됐습니다.",
...
"pm-90": {
    guide: {
      ...
      scene: "가게 장부를 밖의 세무조사관이 점검하는 것과 본사 지원팀이 안에서 돕는 것의 차이처럼, 감리는 발주자를 대신한 독립 제3자의 점검·검증이고, PMO는 조직 내부의 프로젝트 관리 지원·표준 운영입니다. 관점(외부 vs 내부)과 목적이 다릅니다.",
      ...
      map: [
        ...
        { as: "표준·공통 절차 제공(방법론)", real: "PMO 역할", note: "" },
      ],
...
"agile-manifesto": {
    guide: {
      ...
      scene: "두꺼운 설명서를 쓰느라 정작 요리를 못 내는 식당 같은 개발 관행에 반기를 든 선언입니다. 절차·도구보다 사람과 상호작용을, 방대한 문서보다 작동하는 SW를, 계약 협상보다 고객 협력을, 계획 준수보다 변화 대응을 더 가치 있게 여깁니다(4가치·12원칙).",
...
"pm-73": {
    guide: {
      hook: "짧은 반복(스프린트)으로 '점진적으로 완성'해 가는 대표적 애자일 틀(프레임워크)입니다.",
      scene: "큰 상을 한 번에 차리지 않고 코스 요리처럼 조금씩 내놓는 방식입니다. 2~4주 스프린트마다 작동하는 결과물을 내고, 우선순위 목록(백로그)에서 할 일을 뽑아 스프린트를 돌리고, 매일 짧게 점검(데일리 스크럼)하며, 끝에 리뷰·회고로 개선합니다.",
...
"pm-86": {
    guide: {
      ...
      scene: "방학 숙제의 남은 쪽수가 날짜에 따라 줄어드는 그래프와 같은 그림입니다. 번다운 차트는 남은 작업량(세로축)이 시간(가로축)에 따라 얼마나 줄었는지 하강선으로 보여 주며, 이상적 하강선보다 실제선이 위에 있으면 지연, 아래면 앞섬입니다.",
...
"pm-74": {
    guide: {
      ...
      scene: "기본기 연습을 극단까지 밀어붙이는 운동선수처럼, XP는 좋은 개발 습관을 극한(eXtreme)으로 실천합니다. 둘이 짝지어 코딩하고(페어 프로그래밍), 테스트를 먼저 짜고(TDD), 매일 통합하고(CI), 짧은 주기로 릴리스해 코드 품질과 변화 대응을 함께 잡습니다.",
...
"pm-77": {
    guide: {
      hook: "'낭비를 없애고 흐름을 매끄럽게' 만드는 도요타 생산방식에서 온 개발 철학입니다.",
      ...
      map: [
        ...
        { as: "흐름 시각화·동시작업(WIP) 제한", real: "칸반", note: "" },
...
"ml-learning-methods": {
    guide: {
      ...
      scene: "아이에게 답지를 주며 가르치거나, 혼자 놀며 깨치게 두거나, 잘하면 칭찬으로 길들이는 것처럼 기계도 세 방식으로 배웁니다. 지도학습은 문제-정답 쌍으로(스팸 분류), 비지도는 정답 없이 패턴 발견으로(고객 군집), 강화학습은 시행착오 보상으로(바둑) 배우며, 데이터에 정답이 있느냐가 갈림길입니다.",
...
"transfer-learning": {
    guide: {
      ...
      scene: "요리 고수가 새 요리도 금방 배우는 것처럼, 대량 데이터로 학습한 모델(이미지넷)은 이미 일반적 특징을 압니다. 전이학습은 그 지식을 가져와 내 문제(의료 영상)에 맞게 조금만 더 학습(파인튜닝)해, 데이터가 적어도 좋은 성능을 냅니다.",
...
"self-supervised": {
    guide: {
      ...
      scene: "교과서 문장을 스스로 가리고 빈칸 맞히기 문제를 만들어 푸는 것처럼, 데이터 일부를 가리고 맞히게 해 데이터 스스로 정답을 만듭니다(다음 단어 예측). 사람이 레이블을 달 필요 없이 방대한 무라벨 데이터로 학습하며, LLM의 사전학습이 이 방식입니다.",
...
"federated-learning": {
    guide: {
      ...
      scene: "비법 장부는 각자 가게에 두고 요리 노하우만 모임에 가져와 합치는 것처럼, 연합학습은 데이터를 각 기기·기관에 둔 채 각자 학습한 모델 업데이트만 중앙에서 합칩니다. 원본 데이터 노출 없이 공동 모델을 만들어 프라이버시를 지킵니다.",
...
"machine-unlearning": {
    guide: {
      ...
      scene: "단체사진에서 한 사람만 감쪽같이 지우는 것처럼, 이미 학습된 모델에서 특정 데이터의 영향만 걷어냅니다. '내 데이터를 지워달라'(잊혀질 권리)는 요청에, 모델을 처음부터 재학습하지 않고 그 데이터의 기여를 효율적으로 제거하는 기술입니다.",
...
"vertical-ai": {
    guide: {
      ...
      scene: "동네 만물상과 전문 의료기기상의 차이처럼, 범용 AI(ChatGPT)는 넓게 알지만 특정 분야는 얕습니다. 버티컬 AI는 의료·법률·금융 같은 한 영역에 특화해, 그 분야의 데이터·규제·업무 흐름에 딱 맞춘 깊은 전문성을 제공합니다.",
...
"physical-ai": {
    guide: {
      ...
      scene: "화면 속 상담원과 몸을 쓰는 현장 직원의 차이처럼, 피지컬 AI는 센서로 현실을 인식하고 로봇 몸으로 세상에 작용합니다. 카메라·라이다로 보고, AI로 판단하고, 액추에이터로 움직입니다. 엔비디아가 주도하는 차세대 AI 흐름입니다.",
...
"on-device-ai": {
    guide: {
      ...
      scene: "궁금할 때마다 본사에 전화해 묻는 대신 내 손안의 사전을 바로 펴는 것처럼, 온디바이스 AI는 폰·가전·차량 안에서 직접 추론합니다. 클라우드 왕복이 없어 빠르고(저지연), 오프라인에서도 되며, 데이터가 밖으로 나가지 않아 프라이버시에 강합니다.",
...
"aei": {
    guide: {
      ...
      scene: "표정만 봐도 기분을 알아채는 눈치 빠른 친구처럼, 인공 감성 지능(AEI)은 표정·목소리·텍스트에서 기쁨·분노·슬픔을 읽고 상황에 맞게 공감적으로 반응합니다. 논리 지능을 넘어 인간-AI 상호작용을 자연스럽게 만듭니다.",
...
"activation-function": {
    guide: {
      ...
      scene: "신호를 얼마나 통과시킬지 조절하는 수도꼭지처럼, 각 뉴런의 출력에 씌우는 함수입니다. 이게 없으면 신경망은 아무리 깊어도 하나의 직선 계산일 뿐이라, 비선형 함수(ReLU·시그모이드)를 거쳐야 곡선·복잡한 관계를 학습할 수 있습니다.",
      ...
      map: [
        ...
        { as: "음수는 0, 양수는 그대로", real: "ReLU", note: "은닉층 표준" },
...
"loss-function": {
    guide: {
      ...
      scene: "홀까지 남은 거리를 재 주는 골프 캐디처럼, 손실함수는 모델의 예측이 정답에서 얼마나 틀렸는지를 숫자로 잽니다. 학습은 이 손실을 줄이는 방향으로 가중치(파라미터)를 조정하는 과정이며, 과업(회귀·분류)에 따라 쓰는 손실함수가 다릅니다.",
...
"ml-optimizer": {
    guide: {
      hook: "손실을 줄이는 방향으로 '가중치(파라미터)를 어떻게 갱신할지' 정하는 방법입니다.",
      scene: "안개 낀 산에서 발밑 경사만 보고 골짜기로 내려가는 것처럼, 경사하강법은 손실이 낮아지는 방향(기울기 반대)으로 조금씩 내려갑니다. 옵티마이저는 이 하강이 더 빠르고 흔들림 없도록 학습률·관성(모멘텀)·적응을 조절하며, Adam이 대표입니다.",
...
"svm": {
    guide: {
      hook: "두 클래스를 '가장 넓은 여백으로 나누는 경계'를 찾는 분류 기법입니다.",
      scene: "두 동네 사이에 길을 낼 때 양쪽 집들에서 최대한 멀게 내는 것처럼, SVM은 두 그룹에서 가장 멀리 떨어진(마진 최대) 경계를 고릅니다. 여백이 넓을수록 새 데이터에 강하고, 커널 기법으로 비선형 경계도 만들 수 있습니다.",
...
"data-labeling": {
    guide: {
      ...
      scene: "아이 그림책에 '이건 고양이'라고 이름표를 붙여 주는 것처럼, AI 학습 데이터에 정답(레이블)을 다는 작업입니다. 데이터 라벨링·어노테이션의 품질이 곧 지도학습 모델의 성능을 좌우하므로, 지침·검수 체계가 함께 중요합니다.",
...
"knowledge-distillation": {
    guide: {
      ...
      scene: "노스승의 평생 노하우를 젊은 제자에게 압축해 전수하는 것처럼, 지식 증류는 크고 무거운 교사 모델의 출력(부드러운 확률)을 작은 학생 모델이 흉내 내게 학습시킵니다. 폰에 올릴 만큼 작으면서도 교사에 가까운 성능을 냅니다.",
...
"batch-normalization": {
    guide: {
      hook: "각 층의 입력을 '정규화해' 학습을 빠르고 흔들림 없게 만드는 기법입니다.",
      scene: "릴레이 요리에서 앞사람이 간을 들쭉날쭉 넘기면 뒷사람이 매번 다시 맞춰야 하는 것처럼, 앞 층의 변화는 뒤 층의 입력 분포를 흔듭니다. 배치 정규화는 각 층 입력을 미니배치 단위로 평균 0·분산 1로 맞춰, 학습을 빠르고 안정되게 합니다.",
...
"norm-reg-std": {
    guide: {
      hook: "헷갈리는 세 용어 — 값 범위 맞추기(정규화·표준화)와 과적합 벌점(규제화)입니다.",
      scene: "키를 cm로 재든 등수로 재든 비교하려면 눈금부터 맞춰야 하는 것처럼, 값의 범위를 맞추는 전처리 두 가지(정규화·표준화)가 있습니다. 이름만 비슷한 규제화(Regularization)는 모델이 과적합하지 않게 복잡도에 벌점을 주는 별개의 기법입니다.",
...
"dropout": {
    guide: {
      ...
      scene: "연습 때마다 주전 몇 명을 무작위로 빼고 뛰게 해 누구든 제 몫을 하게 만드는 것처럼, 드롭아웃은 학습마다 일부 뉴런을 무작위로 꺼서 특정 뉴런 의존을 막습니다. 여러 모델을 섞어 쓰는(앙상블) 효과도 얻어 과적합을 줄입니다.",
...
"dbscan": {
    guide: {
      ...
      scene: "위성사진에서 불빛이 빽빽한 곳을 도시로 표시하는 것처럼, DBSCAN은 점이 촘촘히 모인 영역을 군집으로 묶고 외딴 점은 잡음으로 둡니다. K-means와 달리 군집 수를 미리 몰라도 되고, 임의 모양의 군집과 이상치 처리에 강합니다.",
...
"backpropagation": {
    guide: {
      hook: "신경망의 '오차를 뒤로 전파하며 각 가중치의 책임을 계산'하는 학습 방법입니다.",
      scene: "요리가 짜면 마지막 간부터 거꾸로 짚어 각 단계의 책임을 따지는 것처럼, 역전파는 출력의 오차를 연쇄법칙으로 입력 쪽으로 거꾸로 전파하며 각 가중치의 기울기(오차 기여도)를 구합니다. 옵티마이저가 그만큼씩 가중치를 고칩니다.",
...
"knn": {
    guide: {
      hook: "'가장 가까운 이웃 K개의 다수결'로 분류하는 가장 단순한 기법입니다.",
      scene: "이사 온 동네의 맛집을 가장 가까운 이웃 몇 명에게 물어 다수결로 정하는 것처럼, 새 데이터는 가장 가까운 K개 이웃이 많이 속한 부류로 분류합니다. 미리 학습하지 않고 데이터를 기억해 뒀다 예측 때 비교하는 게으른 학습(Lazy Learning)입니다.",
...
"gradient-vanishing": {
    guide: {
      ...
      scene: "말 전하기 놀이에서 사람을 거칠수록 소리가 작아져 끝에선 안 들리는 것처럼, 깊은 신경망의 기울기는 층을 지나며 계속 곱해져 0으로 사라지거나(소실 — 앞 층 학습 불가) 반대로 눈덩이처럼 커져 버립니다(폭주). 딥러닝 학습의 고질적 문제입니다.",
...
"k-means": {
    guide: {
      hook: "데이터를 'K개 군집으로, 중심에 가깝게' 나누는 대표 클러스터링 기법입니다.",
      scene: "광장에 깃발 K개를 꽂아 사람들을 가장 가까운 깃발로 모으고, 모인 무리의 한가운데로 깃발을 옮기기를 반복하는 것처럼, K-means는 중심 배정과 재계산을 반복해 비슷한 것끼리 묶습니다. 고객 세분화 등에 쓰는 대표 군집화입니다.",
...
"pca": {
    guide: {
      ...
      scene: "물체를 가장 잘 알아볼 수 있는 각도에서 그림자를 찍는 것처럼, PCA는 정보(분산)를 가장 많이 담는 새 축(주성분)을 찾아 적은 수의 축으로 데이터를 압축합니다. 수백 개 변수를 줄여 시각화·노이즈 제거·전처리에 씁니다.",
...
"dim-reduction": {
    guide: {
      ...
      scene: "긴 이력서를 한 장으로 요약해도 핵심은 남기는 것처럼, 차원 축소는 정보를 최대한 유지하며 특성 수를 줄입니다. 특성이 너무 많으면 계산 폭발·과적합·거리 무의미(차원의 저주)가 생기므로, 고르기(선택)와 새로 만들기(추출) 두 갈래로 줄입니다.",
...
"genetic-algorithm": {
    guide: {
      hook: "'자연 진화(선택·교차·돌연변이)를 모방해' 최적해를 찾는 탐색 기법입니다.",
      scene: "품종 개량처럼 좋은 개체끼리 교배시키고 가끔 돌연변이를 섞어 세대를 거듭할수록 나은 후손을 얻습니다. 유전 기법(유전 알고리즘)은 정답을 직접 못 구하는 문제에서 후보 해들을 선택·교차·돌연변이로 진화시켜 점점 좋은 해에 다가갑니다.",
...
"ensemble": {
    guide: {
      ...
      scene: "한 명의 진단보다 여러 의사의 협진이 오진을 줄이는 것처럼, 앙상블은 여러 모델의 예측을 투표·평균으로 결합합니다. 개별 모델의 약점을 서로 상쇄해 단일 모델보다 정확도와 안정성이 높아집니다(배깅·부스팅·스태킹).",
...
"similarity": {
    guide: {
      ...
      scene: "소개팅 상대와 취향이 얼마나 겹치는지 따져 보는 것처럼, 유사도는 두 데이터가 얼마나 비슷한지를 수치로 잽니다. 방향이 비슷한지(코사인), 거리가 가까운지(유클리드), 집합이 겹치는지(자카드) 등 데이터 유형에 맞는 척도를 골라 추천·검색·군집에 씁니다.",
...
"lda": {
    guide: {
      ...
      map: [
        ...
        { as: "분산 최대 축 찾기(PCA)", real: "대비", note: "비지도" },
      ],
...
"transformer": {
    guide: {
      hook: "'어텐션만으로' 순차 처리 없이 문맥을 파악하는 현대 AI의 근간 구조입니다.",
      scene: "한 단어씩 받아 적는 속기사와 문장 전체를 한눈에 읽는 속독가의 차이처럼, RNN이 순서대로 처리해 긴 문맥을 잊는 반면 트랜스포머는 셀프 어텐션으로 모든 단어의 관련성을 한 번에 계산합니다. 병렬 처리로 빠르며 GPT·BERT의 토대입니다.",
...
"nlp": {
    guide: {
      ...
      scene: "외국인 친구에게 우리말의 말귀를 틔워 주는 것처럼, NLP는 컴퓨터가 사람의 언어를 알아듣고 만들어 내게 합니다. 비정형 텍스트를 토큰화·임베딩으로 처리해 번역·챗봇·감성 분석·요약을 해내며, 트랜스포머·LLM으로 크게 도약했습니다.",
      ...
      map: [
        ...
        { as: "규칙→통계→거대모델(LLM)", real: "발전", note: "" },
      ],
...
"vae": {
    guide: {
      ...
      scene: "사진을 스케치로 압축했다 다시 그려 내는 화가가 상상으로 새 그림까지 그리는 것처럼, VAE는 압축 공간(잠재 공간)을 확률 분포로 만들어 거기서 샘플링해 새로운 데이터를 생성합니다. 오토인코더를 생성 모델로 확장한 것입니다.",
...
"svd": {
    guide: {
      ...
      scene: "아무리 복잡한 동작도 회전-늘리기-회전 세 동작의 합으로 풀리는 것처럼, SVD는 어떤 행렬이든 세 행렬(U·Σ·V)로 분해해 그 안의 핵심 구조를 드러냅니다. 차원 축소·추천·잠재 의미 분석의 토대가 되는 선형대수 기법입니다.",
      ...
      map: [
        ...
        { as: "추천·잠재 의미 분석(LSA)", real: "활용", note: "잠재요인" },
      ],
...
"rig": {
    guide: {
      ...
      scene: "발표 중간중간 자료를 다시 뒤져 확인하며 말하는 발표자처럼, RIG는 답변을 생성하는 도중 필요할 때마다 검색해 그 결과를 문장 사이에 끼워 넣습니다(인터리빙). 생성 전에 한 번 검색하는 RAG보다 실시간 사실 반영이 촘촘해 할루시네이션을 더 줄입니다.",
...
"rag": {
    guide: {
      ...
      scene: "오픈북 시험처럼 책을 찾아보고 근거를 들며 답하게 하는 방식입니다. LLM은 학습 시점 이후의 일과 사내 문서를 모르므로, 질문과 관련된 문서를 벡터 DB에서 검색해 프롬프트에 함께 넣어 그 근거로 답하게 합니다. 할루시네이션을 줄이고 최신성을 확보합니다.",
...
"hallucination": {
    guide: {
      ...
      scene: "면접에서 모르는 질문에도 그럴듯하게 지어내 답하는 지원자 같은 현상입니다. LLM은 다음 단어를 확률로 생성할 뿐 사실을 검증하지 않아, 존재하지 않는 논문·판례·수치를 자신만만하게 만들어 냅니다. 생성형 AI 신뢰성의 최대 걸림돌입니다.",
...
"llm": {
    guide: {
      hook: "방대한 텍스트로 학습한 '초거대 언어 모델' — 생성형 AI의 중심입니다.",
      scene: "도서관의 책을 몽땅 읽고 어떤 질문에도 말을 이어 가는 사서 같은 모델입니다. 수천억 개의 매개변수(파라미터)를 인터넷 규모 텍스트로 자기지도 학습해 번역·요약·코딩·대화를 하나로 해내며, 규모를 키우자 창발적 능력이 나타났습니다.",
      ...
      map: [
        { as: "수천억 개 매개변수(파라미터)", real: "스케일링", note: "창발" },
...
"attention": {
    guide: {
      hook: "입력에서 '중요한 부분에 집중'하도록 가중치를 주는 장치(메커니즘) — 트랜스포머의 심장입니다.",
      scene: "긴 문장을 번역할 때 사람이 관련 있는 단어에 눈길을 주는 것처럼, 어텐션은 각 출력이 입력의 어느 부분과 관련 있는지를 가중치로 계산해 집중합니다. 덕분에 멀리 떨어진 단어 사이의 관계도 놓치지 않습니다.",
...
"langchain": {
    guide: {
      hook: "여러 LLM·데이터·도구를 레고처럼 조립해 AI 앱을 만드는 개발 틀(프레임워크)입니다.",
      scene: "레고 블록이 규격 덕에 척척 조립되는 것처럼, LangChain은 모델 호출·데이터 연결·도구 사용·기억을 표준 부품(컴포넌트)으로 제공해 체인으로 이으면 LLM 앱이 완성되게 합니다. 매번 밑바닥부터 짤 필요가 없어집니다.",
      ...
      map: [
        ...
        { as: "표준 부품의 순차 연결(체인)", real: "Chains", note: "" },
...
"prompt-tuning": {
    guide: {
      ...
      scene: "무대 장치는 그대로 두고 배우에게 주는 지시문만 바꾸는 것처럼, LLM의 가중치(파라미터)는 동결하고 입력 앞에 붙는 학습 가능한 벡터(소프트 프롬프트)만 학습합니다. 모델 전체를 바꾸는 파인튜닝보다 훨씬 싸게 원하는 응답을 유도합니다.",
      ...
      map: [
        ...
        { as: "경량 조정 계열(PEFT)", real: "경량 튜닝", note: "" },
      ],
...
"context-engineering": {
    guide: {
      ...
      scene: "면접에서 답변 한 줄보다 이력서·포트폴리오·추천서 묶음이 당락을 좌우하는 것처럼, 프롬프트 한 줄이 아니라 모델에 주는 문맥 전체(검색 지식·메모리·도구·이력)를 어떻게 구성·선택·압축할지 설계해 정확도와 일관성을 높입니다.",
...
"prompt-engineering": {
    guide: {
      ...
      map: [
        ...
        { as: "질문 잘 다듬기(프롬프트 설계)", real: "vs 컨텍스트 엔지니어링", note: "" },
      ],
...
"lora": {
    guide: {
      ...
      scene: "큰 기계는 그대로 두고 옆에 작은 보조 장치만 붙이는 것처럼, LoRA는 원래 가중치를 동결하고 그 옆에 작은 저랭크 행렬 두 개(A·B)만 붙여 학습합니다. 수십억 매개변수(파라미터)의 LLM도 적은 GPU 자원으로 내 용도에 맞게 적응시킵니다.",
      ...
      map: [
        ...
        { as: "메모리·저장 급감(VRAM)", real: "효율", note: "" },
...
"llm-enhancement": {
    guide: {
      ...
      scene: "기본기만 갖춘 신입을 연수·자료실·협업·업무 개선으로 키우는 것처럼, LLM 고도화는 추론 강화(CoT), 외부 지식 결합(RAG), 모델 병합, 효율화(양자화), 멀티모달을 조합합니다. 추론 부족·환각·비용이라는 한계를 보완하는 기술 집합입니다.",
      ...
      map: [
        { as: "생각의 사슬·나무(CoT·ToT)", real: "추론 강화", note: "" },
        { as: "외부 지식 결합", real: "RAG", note: "" },
        { as: "전문가 혼합·압축(MoE·양자화)", real: "효율·비용", note: "" },
...
"lcm": {
    guide: {
      ...
      scene: "단어를 한 자씩 읽는 대신 문장의 뜻을 통째로 이해하는 속독가처럼, LCM(Large Concept Model)은 단어 조각(토큰)이 아니라 문장 수준의 의미 단위(개념) 임베딩으로 추론합니다. 언어·양식에 독립적이고 긴 문맥에 강한 구조를 지향하는 메타AI의 모델입니다.",
...
"lam": {
    guide: {
      ...
      scene: "말만 잘하는 컨설턴트와 직접 손을 움직이는 비서의 차이처럼, LAM(Large Action Model)은 LLM의 언어 이해에 행동 계획·실행을 더합니다. 마우스를 움직이고 앱을 조작해 태스크를 자동으로 완수하는 AI로 진화합니다.",
      ...
      map: [
        { as: "말→보기→행동의 진화(LLM→LMM→LAM)", real: "발전 계단", note: "" },
...
"cot": {
    guide: {
      ...
      scene: "수학 시험에서 답만 쓰지 말고 풀이 과정을 쓰게 하면 실수가 줄어드는 것처럼, CoT(Chain of Thought)는 LLM에게 '단계별로 생각해 보라'며 중간 사고 과정을 거치게 합니다. 수학·논리 문제의 정답률이 크게 오릅니다.",
...
"moe": {
    guide: {
      hook: "여러 전문가 중 입력에 맞는 '일부만 골라 쓰는' 모델 구조입니다.",
      scene: "종합병원이 증상에 맞는 전문의만 배정하는 것처럼, MoE(Mixture of Experts)는 여러 전문가 네트워크 중 라우터가 입력에 맞는 소수만 활성화합니다. 거대 모델을 매번 통째로 돌리지 않아 같은 성능을 훨씬 적은 계산으로 냅니다.",
...
"peft": {
    guide: {
      hook: "전체가 아닌 '일부 가중치(파라미터)만' 조정해 적은 자원으로 파인튜닝하는 기법 통칭입니다.",
      scene: "집 전체 리모델링 대신 도배·조명만 바꿔 새집 효과를 내는 것처럼, PEFT는 수십억 매개변수(파라미터) 전체 대신 몇 %만 학습해 비슷한 효과를 냅니다. LoRA·Adapter·프롬프트 튜닝 등이 여기에 속합니다.",
      ...
      map: [
        { as: "작은 끼움 층 삽입(Adapter)", real: "Adapter", note: "" },
...
"mlperf": {
    guide: {
      ...
      scene: "육상 기록을 공인 대회에서 같은 트랙·규정으로 재는 것처럼, MLPerf는 AI 칩·시스템의 학습·추론 성능을 표준 과업으로 측정해 공정하게 비교합니다. 저마다 다른 기준으로 자랑하던 성능을 한 잣대로 겨루는 국제 벤치마크입니다.",
...
"tts": {
    guide: {
      ...
      map: [
        ...
        { as: "여러 풀이 뒤 다수결(CoT)", real: "Self-Consistency", note: "" },
...
"mlops": {
    guide: {
      hook: "ML의 데이터~배포 전 과정을 DevOps와 결합해 자동화하는 운영 체계(프레임워크)입니다.",
      scene: "신차를 개발만 하고 정비·리콜 체계가 없으면 도로에서 멈추는 것처럼, 모델도 운영·재학습이 수동이면 실전에서 무너집니다. MLOps는 데이터 수집·학습·배포·모니터링을 DevOps 방식으로 자동화해, 만드는 것과 운영하는 것 사이 골짜기를 메웁니다.",
...
"st-prob-dist": {
    guide: {
      ...
      scene: "주사위는 1~6이 똑같이 1/6, 키는 평균 근처가 흔하고 극단은 드문 것처럼 값마다 나올 확률이 다릅니다. 확률분포는 이 '값과 발생 확률의 관계'를 함수로 나타낸 것으로, 이산(셀 수 있는 값)과 연속(측정값)으로 나뉩니다.",
...
"st-pdf": {
    guide: {
      ...
      scene: "몸무게가 '정확히 60.000kg'인 사람은 없어 '60~61kg 사이'로 세는 것처럼, 연속값은 한 점의 확률이 0이라 구간으로 잽니다. 확률밀도함수(PDF)는 곡선 아래 넓이(적분)가 그 구간에 속할 확률이 되도록 정의한 함수입니다.",
...
"st-normal-dist": {
    guide: {
      ...
      scene: "키·시험 점수·측정 오차가 평균 근처에 몰리고 극단으로 갈수록 드문, 종을 엎어 놓은 것 같은 좌우 대칭 분포입니다. 평균과 표준편차 두 값만으로 모양이 완전히 정해지며, 통계 추정·검정의 중심에 있는 분포입니다.",
...
"st-clt": {
    guide: {
      ...
      scene: "찌그러진 주사위라도 여러 번 던진 평균을 모으면 종 모양이 되는 것처럼, 모집단이 치우쳐 있어도 표본평균들의 분포는 표본 크기가 클수록 정규분포에 가까워집니다. 이 중심극한정리 덕분에 정규 가정의 추정·검정이 널리 통합니다.",
...
"st-data-type": {
    guide: {
      ...
      scene: "온도 20도가 10도의 '두 배로 더움'은 아니지만 키 2m는 1m의 두 배인 것처럼, 데이터마다 허용되는 연산이 다릅니다. 측정 수준에 따라 명목(성별)·순서(학점)·등간(온도)·비율(키) 4척도로 나누며, 유형을 알아야 맞는 그래프·통계·모델을 고릅니다.",
...
"st-sampling": {
    guide: {
      ...
      scene: "국 전체의 간을 한 숟갈로 보는 것처럼, 전체를 다 조사할 수 없으니 일부를 뽑아 추정합니다. 어떻게 뽑느냐가 대표성을 좌우해 무작위·층화·집락·계통 추출을 상황에 맞게 쓰며, 잘못 뽑으면 편향된 결론이 나옵니다.",
...
"st-missing-value": {
    guide: {
      ...
      scene: "출석부의 빈칸 있는 줄을 무턱대고 찢어 버리면 반 전체 통계가 왜곡되는 것처럼, 결측값을 무작정 지우면 데이터가 줄고 편향됩니다. 결측이 왜 생겼는지 패턴(MCAR·MAR·MNAR)에 따라 삭제·평균 대체·모델 대체 등을 골라야 합니다.",
...
"st-bayes": {
    guide: {
      ...
      scene: "드문 병은 검사가 양성이어도 실제 환자일 확률이 생각보다 낮은 것처럼, 결론은 원래의 비율에 좌우됩니다. 베이즈 정리는 사전 확률(기존 믿음)에 새 증거(검사 결과)의 힘을 곱해 사후 확률(갱신된 믿음)로 갱신하는 공식입니다.",
...
"st-descriptive": {
    guide: {
      ...
      scene: "학급 성적표를 평균 점수와 퍼짐 정도로 요약하는 것처럼, 기술 통계는 수천 개 값을 대표 숫자로 압축합니다. 중심(평균·중앙값·최빈값), 퍼짐(분산·표준편차·사분위), 모양(왜도·첨도)으로 데이터의 성격을 한눈에 봅니다.",
      ...
      map: [
        ...
        { as: "분산·표준편차·사분위(IQR)", real: "산포도(퍼짐)", note: "" },
...
"st-inferential": {
    guide: {
      ...
      scene: "국 한 숟갈로 솥 전체의 간을 판단하는 것처럼, 추론 통계는 표본으로 모집단을 추측합니다. 모수가 얼마쯤인지 범위로 추정하고(신뢰구간), 어떤 주장이 맞는지 검정하며(가설검정), 불확실성을 확률로 다루는 것이 핵심입니다.",
      ...
      map: [
        ...
        { as: "중심극한정리·표준오차(CLT)", real: "이론 근거", note: "" },
      ],
...
"st-estimation": {
    guide: {
      ...
      scene: "과녁의 한 점을 짚거나 '이 원 안에는 있다'고 말하는 것처럼, 추정은 모수를 하나의 값(점추정) 또는 '95% 확신하는 범위'(구간추정)로 짚습니다. 불편성·효율성·일치성 같은 좋은 추정량의 조건이 있습니다.",
...
"st-association": {
    guide: {
      ...
      scene: "키가 크면 몸무게도 대체로 큰 것처럼, 두 변수가 함께 오르내리는 정도를 잽니다. 공분산은 방향을 보여 주고, 상관계수는 단위를 지워 −1~1 사이 값으로 강도와 방향을 보여 줍니다. 단, 상관은 인과가 아닙니다.",
      ...
      map: [
        ...
        { as: "−1~1로 눈금 맞춘 강도(표준화)", real: "상관계수 r", note: "핵심" },
...
"st-regression": {
    guide: {
      ...
      scene: "광고비를 얼마 쓰면 매출이 얼마나 오를지 점들 사이로 자를 대고 선을 긋는 것처럼, 회귀분석은 데이터에 가장 잘 맞는 직선(곡선)을 찾아 Y=aX+b 관계식을 세웁니다. X가 Y를 얼마나 설명하는지(결정계수)도 함께 잽니다.",
...
"st-aic-bic": {
    guide: {
      ...
      scene: "성능만 좋은 차보다 성능 대비 기름값까지 좋은 차를 고르는 것처럼, AIC·BIC는 모델의 설명력에 복잡도 벌점을 매겨 균형 잡힌 모델을 고릅니다. 변수를 늘리면 적합도는 좋아져도 과적합되므로, 값이 작을수록 좋은 모델입니다.",
...
"st-hypothesis-test": {
    guide: {
      ...
      scene: "재판에서 무죄 추정을 뒤집을 만큼 증거가 강해야 유죄가 되는 것처럼, 먼저 '효과 없다(귀무가설)'를 세우고 데이터가 이를 뒤집을 만큼 강한지 봅니다. p값이 유의수준보다 작으면 귀무가설을 기각하고 '효과 있다(대립가설)'고 결론합니다.",
...
"st-anova": {
    guide: {
      ...
      scene: "세 반의 평균을 짝지어 여러 번 비교하면 오심이 쌓이는 것처럼, t검정을 반복하면 오류가 커집니다. ANOVA는 집단 간 분산과 집단 내 분산의 비(F값) 하나로 '적어도 한 집단은 다르다'를 한 번에 검정합니다.",
...
"nw-transmission-coding": {
    guide: {
      ...
      scene: "여행 짐을 압축팩으로 줄이고, 깨질 물건은 뽁뽁이로 싸고, 마지막에 운송 규격 상자에 담는 것처럼 데이터도 3번 옷을 갈아입습니다. 군더더기 제거(소스 코딩=압축), 오류 대비 검사 정보 추가(채널 코딩), 전기 신호화(라인 코딩) — 목적이 다른 3단계입니다.",
...
"nw-pcm": {
    guide: {
      ...
      scene: "굽이치는 산길을 일정 간격의 말뚝으로 표시해 지도에 옮기는 것처럼, 연속 파형을 숫자로 바꿉니다. 일정 간격으로 값을 집고(표본화), 정해진 단계로 반올림하고(양자화), 0·1 비트로 적으면(부호화) 전화·오디오 디지털화가 됩니다.",
      ...
      map: [
        ...
        { as: "전화 품질 기준(64kbps)", real: "8kHz×8bit", note: "예시" },
      ],
...
"nw-qam": {
    guide: {
      ...
      scene: "손짓의 크기와 방향을 함께 쓰면 몇 배 많은 수신호를 만들 수 있는 것처럼, QAM은 진폭과 위상을 조합해 격자(성상도) 위 여러 점을 만듭니다. 한 심볼에 여러 비트를 실어 전송 효율을 크게 높이는 변조 방식입니다.",
...
"nw-ipv6": {
    guide: {
      hook: "IPv4 주소 고갈을 해결한 '128비트 주소' 차세대 인터넷 규약(프로토콜)입니다.",
      scene: "전화번호가 모자라 자릿수를 통째로 늘린 것처럼, IPv6는 주소를 128비트로 넓혀 사실상 무한한 주소(3.4×10^38)를 만듭니다. 바닥난 IPv4의 43억 개 한계를 풀고, 헤더 단순화·자동 설정·보안 내장으로 IoT 시대를 대비합니다.",
...
"nw-sliding-window": {
    guide: {
      ...
      scene: "택배를 하나 보내고 답장을 기다리는 대신 여러 개를 미리 부쳐 놓고 확인되는 대로 다음 것을 보내는 것처럼, 창(윈도우) 크기만큼 연속 전송합니다. 응답(ACK)이 오는 대로 창을 밀어 회선을 놀리지 않으며, 네이글 방식은 반대로 자잘한 패킷을 모아 보냅니다.",
...
"nw-bgp": {
    guide: {
      hook: "인터넷 '자율 시스템(AS)들 사이'의 경로를 정하는 라우팅 규약 — 인터넷의 척추입니다.",
...
"nw-wireless-charging": {
    guide: {
      ...
      scene: "전동칫솔을 거치대에 올리기만 해도 충전되는 것처럼, 코일 사이 자기유도로 선 없이 전력을 보냅니다. 좀 떨어져도 되게 하려면 자기공진을, 멀리 보내려면 전자기파(RF)를 쓰며, 거리와 효율이 반비례하는 트레이드오프가 핵심입니다.",
...
"nw-cdn": {
    guide: {
      hook: "콘텐츠를 '사용자 가까운 서버에 미리 복제'해 빠르고 끊김 없이 전달합니다.",
      scene: "인기 상품을 전국 물류창고에 미리 쌓아 두고 가까운 곳에서 당일 배송하는 것처럼, CDN은 전 세계 엣지 서버에 콘텐츠(이미지·영상·JS)를 캐싱해 두고 사용자를 가장 가까운 서버로 보냅니다. 지연이 줄고 원본 서버의 부하도 낮아집니다.",
...
"nw-net-neutrality": {
    guide: {
      ...
      scene: "고속도로가 특정 회사 트럭만 막거나 돈 받고 전용차로를 내주면 불공정한 것처럼, 망 중립성은 통신사(ISP)가 콘텐츠·출발지·목적지에 따라 차별·차단·우선순위를 두지 말라는 원칙입니다. 반대편에선 망 투자 유인·품질 보장과 충돌한다는 반론도 있습니다.",
      ...
      map: [
        ...
        { as: "투자 유인·품질 보장(QoS)과 충돌", real: "반대 논거", note: "긴장" },
      ],
...
"nw-ibn": {
    guide: {
      ...
      scene: "기사에게 길을 일일이 부르는 대신 '회사로 가 주세요'만 말하는 것처럼, 관리자가 '영업팀 화상회의 우선순위 보장' 같은 의도만 선언하면 시스템이 정책으로 변환·적용하고 지켜지는지 계속 검증합니다. 의도 기반 네트워킹(IBN)입니다.",
...
"nw-sdwan": {
    guide: {
      ...
      scene: "내비게이션이 유료도로·국도·우회로를 상황 따라 갈아타는 것처럼, SD-WAN은 전용선(MPLS)·인터넷·LTE 여러 회선을 함께 쥐고 트래픽을 애플리케이션별로 가장 좋은 경로에 자동 배분합니다. 비싼 전용선 의존을 줄이고 클라우드 접속도 빨라집니다.",
...
"nw-openflow": {
    guide: {
      hook: "SDN 컨트롤러가 '스위치의 전달 규칙(플로우)을 직접 설치'하는 사우스바운드 표준 규약입니다.",
      scene: "본사 관제탑이 각 지점에 업무 지시서를 내려보내는 것처럼, SDN의 중앙 두뇌(컨트롤러)가 각 스위치에 '이런 패킷은 저리로'라는 규칙표(플로우 테이블)를 내려 줍니다. 오픈플로우는 그 명령을 전달하는 표준 규약으로, SDN을 실제로 동작하게 합니다.",
...
"nw-iot-matter": {
    guide: {
      ...
      scene: "충전 단자가 USB-C로 통일돼 어느 케이블이든 꽂히는 것처럼, Matter는 애플·구글·아마존이 함께 만든 스마트홈 공통 표준입니다. 갈라져 있던 생태계와 상관없이, 인증받은 기기라면 어느 앱·허브에서도 제어할 수 있게 합니다.",
...
"db-transaction": {
    guide: {
      ...
      scene: "장바구니 결제처럼 중간에 끊기면 안 되는 하나의 일 묶음입니다. A에서 B로의 송금은 '출금+입금' 두 동작인데 출금만 되고 입금이 실패하면 돈이 증발하므로, 트랜잭션은 둘을 한 묶음으로 묶어 '둘 다 성공(Commit)' 또는 '둘 다 취소(Rollback)'만 허용합니다.",
...
"db-isolation-level": {
    guide: {
      ...
      scene: "도서관 열람실 칸막이를 얼마나 높일지 정하는 것처럼, 격리 수준은 동시성 허용 정도를 4단계로 조절합니다. 느슨하면 빠르지만 남의 미완성 데이터를 읽는 사고(Dirty Read 등)가 나고, 엄격하면(Serializable) 정확하지만 느려집니다.",
...
"db-ansi-sparc": {
    guide: {
      ...
      scene: "건물을 인테리어(외부)·설계도(개념)·기초 배관(내부)으로 나누면 인테리어를 바꿔도 기초가 그대로인 것처럼, DB도 3단계로 나눕니다. 저장 방식이 바뀌어도 응용 프로그램은 안 고치게(데이터 독립성) 만드는 구조입니다.",
...
"db-modeling": {
    guide: {
      ...
      scene: "집을 지을 때 대략 스케치→상세 도면→시공 명세로 구체화하는 것처럼, DB도 무엇을 저장할지 개념 모델부터 잡고 논리(테이블·관계), 물리(실제 저장 구조)로 점점 내려갑니다. 개념→논리→물리의 3단계 설계입니다.",
...
"db-integrity": {
    guide: {
      ...
      scene: "입구에서 신분증 없는 손님을 돌려보내는 문지기처럼, 무결성 제약은 자격 없는 데이터를 입구에서 거부합니다. 학번 없는 학생(개체 무결성), 존재하지 않는 학과 코드(참조 무결성), 형식 밖의 값(도메인)이 입력·수정·삭제로 들어오는 것을 애초에 막습니다.",
...
"db-relation-key": {
    guide: {
      ...
      scene: "반에서 한 명을 부를 때 '번호+이름'도 되지만 번호 하나면 충분한 것처럼, 키도 군더더기 없이 최소로 식별하는 것을 고릅니다. 식별 가능한 모든 조합(슈퍼키)에서 최소 조합(후보키)을 추리고, 그중 대표를 기본키로 삼습니다.",
...
"db-entity": {
    guide: {
      ...
      scene: "연극을 올리기 전 배우·소품·장면 목록부터 정리하는 것처럼, 학사 시스템에선 '학생'·'과목'·'수강신청'이 각각 관리 대상입니다. 이 독립적으로 존재하는 관리 대상 하나하나가 엔티티이고 곧 테이블이 되며, 속성(이름·학번)과 관계(수강)를 가집니다.",
...
"db-functional-dependency": {
    guide: {
      ...
      scene: "주민번호만 알면 생년월일이 자동으로 정해지는 것처럼, '학번을 알면 이름이 하나로 정해진다(학번→이름)'는 결정 관계가 함수적 종속입니다. 어떤 속성이 무엇을 결정하는지 따지면 테이블을 어디서 쪼갤지 보입니다 — 정규화의 이론적 토대입니다.",
...
"db-armstrong": {
    guide: {
      ...
      scene: "'A는 B의 부모, B는 C의 부모면 A는 C의 조상'이 저절로 참인 것처럼, '학번→학과'와 '학과→학과장'에서 '학번→학과장'(이행)이 따라 나옵니다. 암스트롱 공리는 주어진 함수 종속에서 숨은 종속을 빠짐없이 끌어내는 추론 규칙 6개입니다.",
...
"db-normalization": {
    guide: {
      ...
      scene: "한 서랍에 옷·서류·공구를 다 넣으면 꺼낼 때마다 엉키는 것처럼, 한 테이블에 학생·과목·교수를 다 넣으면 삽입·갱신·삭제 이상이 생깁니다. 정규화는 함수 종속에 따라 테이블을 무손실로 나눠 중복과 이상현상을 단계적으로 제거합니다.",
...
"db-denormalization": {
    guide: {
      ...
      scene: "매번 창고에서 부품을 모아 조립하는 대신 잘 나가는 세트를 미리 묶어 두는 것처럼, 자주 함께 읽는 데이터를 일부러 한 테이블에 중복 저장합니다. 정규화로 쪼갠 테이블의 조인 비용을 없애 조회 성능을 올리는 대신, 중복·정합성 부담을 감수합니다.",
...
"db-connection-trap": {
    guide: {
      ...
      scene: "징검다리가 놓여는 있는데 막상 건너면 길이 안 이어지는 것처럼, 관계선은 있는데 경로 해석이 안 되는 함정입니다. '이 사원이 어느 프로젝트인지' 애매해지거나(팬 트랩), 배정 안 된 사원이 조회에서 아예 빠지는(카즘 트랩) 문제로, 관계 재설계로 풉니다.",
      ...
      map: [
        ...
        { as: "관계도 다시 잇기(ERD 재설계)", real: "근본 해결", note: "" },
      ],
...
"db-relational-algebra": {
    guide: {
      ...
      scene: "원하는 데이터를 얻으려면 '먼저 이 조건으로 걸러(선택), 이 열만 뽑고(추출), 저 테이블과 붙여라(조인)'처럼 연산을 순서대로 지정합니다. SQL 옵티마이저가 내부적으로 질의를 이 대수식으로 표현해 실행 순서를 다듬습니다(최적화).",
...
"db-relational-calculus": {
    guide: {
      ...
      scene: "'이 길로 가라' 대신 '역 앞에 있는 식당'이라고 조건만 말하는 것처럼, 관계해석은 '조건을 만족하는 것들'이라고 결과만 선언합니다. 술어논리로 '이런 성질의 튜플 집합'을 기술하면 시스템이 방법을 알아서 찾는 비절차적 언어입니다.",
...
"db-recovery": {
    guide: {
      ...
      scene: "가계부를 꼬박꼬박 적어 두면 지갑을 잃어도 정산할 수 있는 것처럼, 로그에 '누가 무엇을 바꿨는지'를 미리 기록합니다. 장애가 나면 완료(Commit)된 작업은 다시 반영하고(Redo), 진행 중이던 작업은 취소해(Undo) DB를 일관 상태로 되돌립니다.",
...
"db-validation": {
    guide: {
      ...
      scene: "한산한 가게에서 계산대에서만 확인하는 것처럼, 충돌이 드물다고 낙관해 잠금 없이 자유롭게 작업합니다. 커밋 직전에만 '내가 읽는 사이 남이 바꿨나'를 검사해(검증 단계), 충돌이면 롤백하고 아니면 반영하는 낙관적 동시성 제어입니다.",
...
"db-mvcc": {
    guide: {
      ...
      scene: "문서를 고치는 동안에도 남들은 이전 인쇄본을 읽는 것처럼, MVCC는 데이터의 여러 버전을 유지합니다. 수정 중이어도 다른 사람은 수정 전 스냅샷을 읽으니 읽기와 쓰기가 서로 막지 않아(비차단) 동시성 성능이 크게 오릅니다.",
...
"db-distributed": {
    guide: {
      ...
      scene: "전국 지점에 재고를 나눠 두고도 손님에겐 한 매장처럼 보이게 하는 것과 같습니다. 데이터를 여러 사이트에 분산해도 사용자는 어디에 있는지 몰라도 되며(투명성), 과제는 여러 사이트에 걸친 트랜잭션의 일관성과 네트워크 단절 대응입니다.",
...
"db-2pc": {
    guide: {
      ...
      scene: "주례가 '신랑도 예, 신부도 예'를 모두 확인한 뒤에야 성혼을 선언하는 것처럼, 조정자가 먼저 '준비됐나?'를 물어 모두 Yes면 커밋을, 하나라도 No면 전체 취소를 명령합니다. 준비 투표(1단계)와 결정 통보(2단계)의 2단계 합의입니다.",
      ...
      map: [
        ...
        { as: "모두 예면 확정 명령(Commit)", real: "2단계 commit/abort", note: "" },
...
"db-nosql": {
    guide: {
      ...
      scene: "규격 서류함 대신 아무 상자나 쌓을 수 있는 창고처럼, NoSQL은 유연한 스키마로 데이터를 담고 서버를 옆으로 늘려(수평 확장) 폭증하는 트래픽을 감당합니다. 대신 강한 일관성·조인을 포기하는 맞바꿈입니다.",
      ...
      map: [
        ...
        { as: "문서 통째 저장(JSON)", real: "Document", note: "MongoDB" },
...
"db-nosql-modeling": {
    guide: {
      ...
      scene: "손님 동선에 맞춰 진열대를 짜는 편의점처럼, NoSQL 설계는 '어떻게 조회할지'를 먼저 정합니다. 조인이 약하거나 없으므로 정규화 대신 함께 읽을 데이터를 한 문서에 묶거나(임베딩) 참조를 두며, 설계의 출발점이 데이터가 아니라 쿼리입니다.",
...
"db-cap-base": {
    guide: {
      ...
      scene: "전화가 끊긴 두 지점이 각자 영업을 계속할지 함께 멈출지 골라야 하는 것처럼, 분단 순간엔 '최신만 주되 응답 못 할 수도(일관성)'와 '일단 응답하되 옛 데이터일 수도(가용성)'를 골라야 합니다. 분산에선 분단내성이 필수라 실제 선택은 C냐 A냐입니다.",
...
"db-pacelc": {
    guide: {
      ...
      scene: "사고 때 규칙만 있고 평소 규칙이 없으면 반쪽인 것처럼, CAP은 분단 상황만 다룹니다. PACELC은 '분단이면(P) C냐 A냐, 평소면(E) 지연(L)이냐 일관성(C)이냐'까지 함께 따집니다 — 정상일 때도 빠른 응답과 강한 일관성은 상충하기 때문입니다.",
...
"db-newsql": {
    guide: {
      ...
      scene: "두 마리 토끼를 다 잡으려는 것처럼, NewSQL은 NoSQL의 수평 확장과 RDBMS의 SQL·ACID 트랜잭션을 함께 노립니다. 확장은 좋지만 일관성이 약한 NoSQL, 그 반대인 RDBMS의 장점만 합치려는 시도로 Google Spanner가 대표입니다.",
      ...
      map: [
        { as: "질의 언어·거래 보장 유지(SQL·ACID)", real: "RDBMS 정합성", note: "" },
...
"db-vector-db": {
    guide: {
      ...
      scene: "도서관이 제목이 달라도 비슷한 주제의 책을 옆에 꽂는 것처럼, 벡터 DB는 의미가 가까운 것끼리 가깝게 저장·검색합니다. 텍스트·이미지를 임베딩(숫자 벡터)으로 바꾸면 '고양이'와 '고양이과 동물'이 공간에서 가까워, 키워드가 안 겹쳐도 의미로 찾습니다.",
      ...
      map: [
        ...
        { as: "검색증강 생성(RAG)의 지식 저장소", real: "검색 증강 생성 연동", note: "핵심 용도" },
      ],
...
"db-ann": {
    guide: {
      ...
      scene: "전국을 다 돌지 않고 동네 맛집 지도로 '거의 최고'를 고르는 것처럼, ANN은 약간의 정확도를 포기하고 후보를 영리하게 좁힙니다. 수백만 벡터를 전부 비교하는 대신 수십 배 빠르게 '거의 최근접'을 찾아, 벡터 검색을 실용적으로 만듭니다.",
...
"db-sql": {
    guide: {
      ...
      scene: "식당에서 조리법이 아니라 메뉴 이름만 주문하는 것처럼, SQL은 'A 조건인 것들의 B를 줘'라고 결과만 선언합니다. 어떻게 찾을지(순회·인덱스 선택)는 DBMS가 알아서 하며, 이 선언적 성격은 관계해석에서 나옵니다.",
...
"db-join": {
    guide: {
      ...
      scene: "두 명부를 같은 이름 기준으로 나란히 붙여 보는 것처럼, 조인은 학생 테이블과 학과 테이블을 '학과코드'로 이어 학생 이름 옆에 학과명을 붙입니다. 정규화로 나눈 데이터를 다시 합쳐 보는 연산으로, 잇는 방식(내부/외부)과 처리 방식이 나뉩니다.",
...
"db-index": {
    guide: {
      ...
      scene: "1만 페이지 책도 색인을 보면 몇 페이지인지 바로 아는 것처럼, 인덱스는 전체를 안 뒤지고(풀 스캔 회피) 원하는 행을 빨리 찾게 합니다. 대신 데이터가 바뀔 때 색인도 함께 갱신해야 하므로 INSERT·UPDATE는 느려지는 맞바꿈입니다.",
...
"db-query-offloading": {
    guide: {
      ...
      scene: "본점이 붐비면 손님을 분점으로 안내하는 것처럼, 조회 전용 복제본(슬레이브)을 여러 대 두고 읽기를 그쪽으로 보냅니다. 원본(마스터)은 쓰기에만 집중하게 되어, 조회가 폭주해도 전체 처리량이 올라갑니다.",
...
"db-partitioning": {
    guide: {
      ...
      scene: "큰 옷장을 계절별 서랍으로 나누면 겨울옷만 바로 꺼내는 것처럼, 수억 건 테이블을 월별 조각(파티션)으로 나눕니다. 필요한 조각만 스캔하고(파티션 프루닝) 오래된 조각은 통째로 버릴 수 있어, 같은 DB 안에서 관리·조회가 빨라집니다.",
...
"db-sharding": {
    guide: {
      ...
      scene: "한 창고가 넘치면 초성별로 여러 창고에 나눠 보관하는 것처럼, 사용자 ID 기준으로 데이터를 여러 서버(샤드)에 쪼개 담습니다. 각 서버가 자기 몫만 처리해 쓰기 부하와 용량까지 수평 확장되며, 파티셔닝을 여러 서버로 넓힌 것입니다.",
...
"db-data-standard": {
    guide: {
      ...
      scene: "같은 사람을 부서마다 다른 이름으로 부르는 것과 같은 혼란입니다. '고객번호'가 어디선 CUST_NO, 어디선 CUSTOMER_ID이고 날짜 형식도 제각각이면 데이터를 합칠 수 없으니, 이름·형식·코드값·용어를 하나의 기준으로 통일(표준화)해 일관되게 만듭니다.",
...
"db-governance": {
    guide: {
      ...
      scene: "공용 주방이 굴러가려면 당번과 규칙이 필요한 것처럼, 데이터도 '누가 소유하고 누가 품질을 책임지는지' 없으면 혼란입니다. 거버넌스는 데이터의 주인(오너십)·규칙·역할·절차를 정해, 데이터를 전사 자산으로 일관되게 다루는 통제 체계입니다.",
...
"db-profiling": {
    guide: {
      ...
      scene: "겉보기엔 멀쩡해도 건강검진 수치로 이상을 찾는 것처럼, 프로파일링은 데이터의 실제 상태를 통계로 진단합니다. 나이 -5·999 같은 이상치, 결측, 형식 안 맞는 이메일이 얼마나 있는지 값의 분포·패턴을 자동 집계해 숨은 품질 문제를 드러냅니다.",
...
"db-readiness-maturity": {
    guide: {
      ...
      scene: "운동을 시작하기 전엔 체력 검사를 받고, 시작한 뒤엔 급수를 매기는 것처럼 — 분석 전엔 데이터·인력·인프라를 갖췄는지(준비도) 재고, 이미 하고 있다면 어느 수준인지(성숙도) 단계로 평가합니다. 다음에 무엇을 보강할지 로드맵이 나옵니다.",
      ...
      map: [
        ...
        { as: "도입→활용→확산→고도화(최적화)", real: "성숙도 단계", note: "CMMI식" },
...
"db-mining-methodology": {
    guide: {
      ...
      scene: "보물찾기도 지도와 순서가 있어야 하는 것처럼, 무작정 데이터를 돌리면 헤맵니다. 표준 절차(방법론)인 CRISP-DM은 비즈니스 이해→데이터 이해·준비→모델링→평가→배포의 단계를 정해, 분석 프로젝트가 목적을 놓치지 않고 반복·개선되게 합니다.",
...
"db-eda-cda": {
    guide: {
      ...
      scene: "형사가 단서를 뒤지며 가설을 세우고, 검사가 법정에서 그 가설을 입증하는 것처럼 방향이 반대입니다. EDA는 데이터를 탐색해 '무슨 일이 있었나' 가설을 찾고, CDA는 세운 가설을 통계 검정으로 확인합니다. 보통 EDA로 시작해 CDA로 결론짓습니다.",
...
"db-visualization": {
    guide: {
      ...
      scene: "긴 숫자 표보다 그래프 한 장이 추세를 바로 보여 주는 것처럼, 시각화는 표에 숨은 추세·비교·분포를 한눈에 드러냅니다. 핵심은 예쁜 그림이 아니라 '무엇을 말하려는지'에 맞는 표현(선·막대·산점도)을 고르는 것입니다.",
...
"db-lakehouse": {
    guide: {
      hook: "데이터 레이크의 '유연성'과 웨어하우스의 '신뢰성'을 한 구조에 합쳤습니다.",
      scene: "아무거나 싸게 쌓는 헛간과 비싸고 반듯한 진열장의 장점만 합친 것처럼, 레이크하우스는 값싼 레이크 저장소 위에 트랜잭션·스키마·성능 계층을 얹습니다. 정합성이 약한 레이크와 비싸고 경직된 웨어하우스의 한계를 함께 풉니다.",
      ...
      map: [
        ...
        { as: "레이크 위 거래 보장 계층(ACID)", real: "개방형 테이블 포맷", note: "Delta·Iceberg" },
...
"db-kafka": {
    guide: {
      hook: "대량 이벤트를 '실시간 스트림'으로 든든하게 주고받는 분산 메시징 플랫폼입니다.",
      scene: "모두가 서로 전화하는 대신 큰 게시판 하나에 소식을 올리고 필요한 사람이 읽어 가는 것처럼, 카프카는 가운데에 거대한 로그 게시판을 둡니다. 생산자는 이벤트를 올리고(발행) 소비자는 필요할 때 읽어 가(구독), 시스템들이 거미줄 없이 느슨하게 연결됩니다.",
...
"db-public-quality": {
    guide: {
      ...
      scene: "수돗물을 수도꼭지에서 거르지 않고 정수장에서부터 관리하는 것처럼, 공공데이터의 오류도 생성·수집 단계에서 미리 막아야 합니다. 이 가이드는 개방 데이터의 품질 문제를 사후 수정이 아니라 사전 예방 중심으로 진단·차단하는 절차를 제시합니다.",
...
"db-quality-cert": {
    guide: {
      ...
      scene: "위생 관리를 잘한 식당에 인증 마크를 달아 주는 것처럼, 품질 기준을 충족한 공공데이터에 정부가 인증을 부여합니다. 예방 가이드가 '어떻게 관리하나'라면 이 매뉴얼(2025.07)은 그 결과를 심사해 인증하는 절차이고, 인증 데이터는 신뢰 자산으로 개방·활용됩니다.",
...
"db-public-std-guideline": {
    guide: {
      hook: "공공기관 DB의 용어·코드·구조를 통일하기 위한 정부 지침(2023.04 개정)입니다.",
      scene: "기관마다 서식이 다르면 서류가 안 통하는 것처럼, DB 용어·코드가 다르면 데이터 연계·개방이 막힙니다. 이 지침은 공공기관이 DB를 설계·운영할 때 지킬 표준(용어·도메인·코드·구조)을 규정해, 기관 간 데이터가 통하게 만듭니다.",
...
"db-dq-cert": {
    guide: {
      ...
      scene: "농산물이 품질 등급 도장을 받는 것처럼, 데이터도 제3자 심사로 믿을 만함을 증명합니다. DQ인증(2025.02.26 가이드라인)은 데이터 품질을 표준 지표로 측정·심사해 인증을 부여하고, 신뢰할 수 있는 데이터임을 대외에 보증합니다.",
...
"db-value-assessment": {
    guide: {
      ...
      scene: "중고차 값을 원가·시세·수익성으로 감정하는 것처럼, 데이터도 자산이라면 값을 매길 수 있어야 거래·투자·활용 판단이 섭니다. 데이터 가치 평가는 원가·시장·수익 관점 등으로 데이터의 경제적 값어치를 정량 산정하는 방법입니다.",
...
"db-apriori": {
    guide: {
      hook: "'빈발하지 않은 것의 상위집합도 빈발하지 않다'는 성질로 후보를 쳐내는 연관규칙 탐사 기법입니다.",
      scene: "맥주가 안 팔리는 가게에서 '맥주+기저귀 세트'가 팔릴 리 없는 것처럼, 드문 항목의 상위집합도 드뭅니다(반단조성). Apriori는 이 당연한 성질로 빈발하지 않은 조합을 후보에서 아예 제외해, 폭발하는 조합 계산을 줄입니다.",
...
"db-dhp": {
    guide: {
      hook: "해싱으로 후보를 미리 걸러 Apriori의 '후보 폭발'을 줄인 개선 기법입니다.",
      scene: "예선전에서 기준 미달 팀을 미리 떨어뜨려 본선을 가볍게 하는 것처럼, DHP는 스캔하면서 항목 조합을 해시 버킷에 세어 두고, 최소 지지도 미만인 버킷의 조합 후보를 미리 제거(프루닝)합니다. Apriori의 후보 수를 확 줄입니다.",
      ...
      map: [
        ...
        { as: "초기 후보 걸러내기(Apriori 개선)", real: "성능 향상", note: "" },
      ],
...
"db-fp-growth": {
    guide: {
      hook: "'후보 생성 없이' 트리로 빈발 패턴을 찾아 Apriori보다 빠른 기법입니다.",
      scene: "장부 전체를 매번 다시 훑는 대신 요약 장부를 만들어 놓고 파고드는 것처럼, FP-Growth는 데이터를 딱 두 번만 스캔해 압축 트리(FP-Tree)를 만듭니다. 그 트리를 재귀적으로 파고들며 후보 생성 없이 빈발 패턴을 직접 캐냅니다.",
...
"db-daap": {
    guide: {
      ...
      scene: "그냥 쌓아 둔 재고가 아니라 포장·설명서·AS까지 갖춘 상품처럼, 데이터를 소비자가 바로 쓸 수 있게 문서·품질·접근을 갖춰 제공합니다. 각 도메인 팀이 자기 데이터를 제품으로 책임지는 데이터 메시의 핵심 개념으로, 중앙 데이터팀 병목을 없앱니다.",
...
"mg-living-lab": {
    guide: {
      ...
      scene: "신메뉴를 주방에서만 개발하지 않고 단골손님에게 먼저 먹여 보며 고치는 것처럼, 리빙랩은 주민·시민이 실제 생활 공간에서 직접 써 보며 문제를 발굴·개선하는 사용자 참여형 실험장입니다. S.O.S랩은 사회문제 해결형 리빙랩입니다.",
...
"mg-itil4": {
    guide: {
      ...
      scene: "잘되는 식당들의 운영 노하우를 모은 교본과 같은, IT 서비스 관리의 모범사례 모음입니다. v3의 서비스 생명주기에서, 4.0은 서비스 가치 시스템(SVS)과 유연한 실천(Practice) 중심으로 바꿔 가치 공동창출과 애자일·데브옵스 시대에 맞췄습니다.",
...
"mg-itsm": {
    guide: {
      ...
      scene: "전기 회사의 목적이 발전기 자체가 아니라 '불 꺼지지 않는 집'인 것처럼, ITSM은 서버·네트워크가 아니라 사용자가 받는 IT 서비스를 목적으로 둡니다. 프로세스·조직·기술을 갖춰 IT를 서비스로 기획·제공·운영·개선하는 체계입니다.",
...
"mg-bcp": {
    guide: {
      ...
      scene: "소방 훈련과 비상구 안내도를 평소에 갖춰 두는 것처럼, BCP는 화재·지진·해킹으로 시스템이 멈춰도 핵심 업무가 이어지게 미리 준비합니다. 무엇이 핵심 업무인지 파악하고(BIA), 목표 복구 시간을 정하고(RTO/RPO), 대체 수단과 절차를 마련해 둡니다.",
...
"mg-bia": {
    guide: {
      ...
      map: [
        ...
        { as: "연속성 계획의 뼈대(BCP)", real: "선행 분석", note: "" },
      ],
...
"mg-mbco-mtpd-mao": {
    guide: {
      ...
      scene: "환자가 버틸 수 있는 골든타임과 최소한 유지해야 할 혈압 같은 기준선입니다. 업무가 멈췄을 때 이 시간을 넘기면 회사가 위태로운 한계선(MTPD/MAO)이 있고, 복구하더라도 최소 이만큼은 돌려야 하는 수준(MBCO)이 있어, 이 목표들이 복구 전략을 좌우합니다.",
      ...
      map: [
        ...
        { as: "한계 시간 안에 복구(MTPD)", real: "RTO < MTPD", note: "관계" },
        { as: "영향 분석에서 도출(BIA)", real: "복구 지표", note: "" },
      ],
...
"mg-drs": {
    guide: {
      ...
      scene: "본점에 불이 나면 미리 준비한 임시 점포에서 장사를 잇는 것처럼, DRS는 주 전산센터가 멈추면 재해복구 센터로 전환합니다. 백업 인프라와 복구 절차를 갖춘 시스템으로, 얼마나 빨리 전환되느냐에 따라 유형이 갈립니다.",
...
"mg-iso22301": {
    guide: {
      ...
      scene: "소방 대비를 잘한다고 말만 하는 게 아니라 인증을 받아 보이는 것처럼, ISO 22301은 사업 연속성을 PDCA 관리 체계(BCMS)로 운영·인증하는 국제 표준입니다. 조직이 재해 대응 역량을 갖췄음을 제3자가 보증합니다.",
      ...
      map: [
        ...
        { as: "방침·영향분석·전략(BIA)", real: "Plan", note: "PDCA" },
        { as: "계획 구현·훈련(BCP)", real: "Do", note: "" },
...
"mg-draas": {
    guide: {
      ...
      scene: "자가 발전기를 사는 대신 비상 전력 서비스를 구독하는 것처럼, DRaaS는 클라우드 사업자가 재해복구 환경을 서비스로 제공합니다. 자체 DR 센터 없이 평소엔 저렴하게 대기하다, 재해 시 클라우드로 전환(페일오버)합니다.",
...
"mg-it-governance": {
    guide: {
      ...
      scene: "가장이 가계 지출의 우선순위와 규칙을 정하는 것처럼, IT 거버넌스는 이사회·경영진이 IT 의사결정의 권한·책임을 정합니다. IT 투자가 사업 성과로 이어지는지, 위험은 관리되는지 챙기며 IT를 전략과 정렬(Align)시키는 통제 체계입니다.",
...
"mg-iso38500": {
    guide: {
      ...
      scene: "선장이 직접 노를 젓는 대신 항로를 정하고 점검하는 것처럼, ISO 38500은 경영진이 IT를 평가(Evaluate)·지시(Direct)·모니터링(Monitor)하는 EDM 모델을 제시합니다. IT 거버넌스의 6대 원칙을 정한 국제 표준(2024 개정)입니다.",
...
"mg-it-compliance": {
    guide: {
      ...
      scene: "교통법규를 안 지키면 면허가 정지되는 것처럼, IT도 개인정보보호법·전자금융감독규정 등을 어기면 벌금·영업정지를 당합니다. IT 컴플라이언스는 외부 법규와 내부 규정을 식별·이행·점검해 위반 위험을 관리하는 준거성 체계입니다.",
...
"mg-env-analysis": {
    guide: {
      ...
      scene: "등산 전에 날씨와 내 체력을 함께 살피는 것처럼, 전략도 바깥과 안을 먼저 스캔합니다. 거시 환경(정치·경제 등), 산업 구조, 내부 역량을 각각 도구로 분석해 기회·위협·강점·약점을 파악하고 전략 방향을 잡습니다.",
...
"mg-ansoff": {
    guide: {
      ...
      scene: "단골 장사를 더 파고들지, 새 동네에 분점을 낼지, 신메뉴를 낼지, 아예 다른 업종에 갈지 고르는 것처럼, 앤소프 매트릭스는 제품과 시장의 신·구 조합 2×2로 성장 전략 4가지를 정리합니다. 조합마다 위험 수준이 다른 성장 경로를 제시합니다.",
...
"mg-bcg": {
    guide: {
      ...
      scene: "잘 크는 나무엔 물을 주고 다 자란 나무에선 열매를 따는 것처럼, BCG 매트릭스는 각 사업을 시장 성장률·점유율 두 축으로 별·젖소·물음표·개로 분류합니다. 어디에 투자하고 어디서 거둘지 자원 배분 전략을 정하는 도구입니다.",
...
"mg-hw-sizing": {
    guide: {
      ...
      scene: "잔치 인원수에 맞춰 솥 크기를 정하는 것처럼, 서버도 업무량·사용자·데이터를 근거로 적정 용량을 계산합니다. 너무 작게 잡으면 성능 부족, 크게 잡으면 예산 낭비이므로, 규모산정 지침은 CPU·메모리·디스크 산정의 표준 방법을 제시합니다.",
      ...
      map: [
        { as: "처리량으로 두뇌 용량 산정(CPU)", real: "CPU 산정(TPC/SPEC)", note: "" },
...
"mg-value-chain": {
    guide: {
      ...
      scene: "밭에서 식탁까지 오는 동안 단계마다 값이 붙는 것처럼, 가치사슬은 기업 활동을 본원적 활동과 지원 활동으로 나눠 봅니다. 각 단계가 얼마나 가치를 더하고 어디서 원가·차별화 우위가 생기는지 짚는 포터의 분석 틀입니다.",
...
"mg-pdca": {
    guide: {
      ...
      scene: "요리하고 간을 보고 레시피를 고쳐 다시 만드는 것처럼, PDCA는 계획(Plan)→실행(Do)→점검(Check)→개선(Act)을 도는 나선형 개선입니다. 품질·관리 시스템·프로세스 개선의 뼈대로, ISO 경영시스템 표준의 공통 골격입니다.",
      ...
      map: [
        ...
        { as: "개선 후 기준으로 굳히기(표준화)", real: "Act", note: "" },
      ],
...
"mg-mece-liss": {
    guide: {
      ...
      scene: "피자를 겹치지도 남기지도 않게 자르는 것처럼, MECE는 문제를 상호배타·전체포괄로 나누는 원칙입니다. LISS는 논리를 도약·누락 없이 빈틈없이 잇는 원칙으로, 둘은 컨설팅·기술사 답안 구조화의 기본 사고법입니다.",
...
"mg-isp-guide": {
    guide: {
      ...
      scene: "여행 전에 코스·예산 계획서를 정해진 양식으로 쓰게 하는 것처럼, 이 가이드(9판, 2025.05)는 공공 정보화 사업 전 ISP·ISMP의 수립 절차와 산출물을 통일된 기준으로 정합니다. 사업의 품질과 예산 적정성을 확보하는 장치입니다.",
...
"mg-isp": {
    guide: {
      ...
      scene: "도시를 무계획으로 개발하면 난개발이 되는 것처럼, IT를 산발적으로 도입하면 낭비·중복이 생깁니다. ISP는 조직 전체 관점에서 사업 전략과 정렬된 정보화 비전, 목표 청사진(아키텍처), 이행 로드맵을 수립해 중장기 IT 투자의 방향을 정합니다.",
      ...
      map: [
        ...
        { as: "목표 청사진(아키텍처)", real: "To-Be(EA)", note: "" },
...
"mg-ismp": {
    guide: {
      ...
      scene: "집을 짓기 전에 상세 시방서를 써야 시공 분쟁이 없는 것처럼, ISMP는 발주 전에 대상 시스템의 기능·성능 요구사항을 상세히 정의합니다. 제안요청서(RFP)의 품질을 높이고 적정 사업 대가를 산정해 분쟁·재작업을 막습니다.",
      ...
      map: [
        ...
        { as: "제안요청서 품질 제고(RFP)", real: "발주 명확화", note: "" },
...
"mg-trl": {
    guide: {
      ...
      scene: "학생의 성장을 학년으로 재는 것처럼, TRL은 기술의 성숙도를 기초 원리 관찰(1단계)부터 실제 운용 검증(9단계)까지 9단계로 잽니다. R&D 투자·상용화 시점 판단의 공통 언어를 주는 척도로, NASA에서 유래했습니다.",
...
"mg-talc": {
    guide: {
      ...
      scene: "유행 옷이 패션 리더에서 시작해 대중으로 퍼지는 것처럼, 신기술도 혁신가부터 지각수용자까지 5집단에 시간차를 두고 퍼집니다. 특히 초기 시장과 주류 시장 사이의 골짜기(캐즘)를 넘느냐가 성패를 가릅니다.",
...
"mg-it-invest": {
    guide: {
      ...
      scene: "학원비를 썼으면 성적이 올랐는지 확인하는 것처럼, IT에 쓴 돈도 그만한 가치를 냈는지 검증해야 합니다. IT 투자성과 평가는 비용 대비 효익을 재무 지표(ROI·NPV)와 비재무 관점(전략 기여·품질)으로 측정해, 투자 의사결정과 사후 관리를 돕습니다.",
...
"mg-tech-value": {
    guide: {
      ...
      scene: "골동품을 감정사에게 맡겨 값을 매기는 것처럼, 기술(특허·노하우)도 거래·투자·담보로 쓰려면 값이 필요합니다. 기술 가치 평가는 그 기술이 창출할 경제적 이익을 원가·시장·수익 접근으로 산정하며, 데이터 가치 평가와 유사한 틀을 씁니다.",
...
"mg-ipr": {
    guide: {
      ...
      scene: "내 땅에 울타리를 쳐야 남이 못 들어오는 것처럼, 지식재산권은 무형의 창작물에 배타적 권리라는 울타리를 칩니다. 아이디어·기술·디자인·브랜드를 산업재산권과 저작권으로 보호해, 창작 유인과 공정 경쟁을 보장합니다.",
...
"mg-okr": {
    guide: {
      ...
      scene: "'건강해지자' 대신 '3개월에 5kg 감량'처럼 방향과 숫자를 세트로 내거는 방식입니다. OKR은 야심찬 목표(Objective)와 정량 핵심결과(Key Results)를 묶어, 전사부터 개인까지 목표를 투명하게 정렬하고 짧은 주기로 점검합니다(구글이 사용).",
...
"mg-bsc": {
    guide: {
      ...
      scene: "건강을 몸무게 하나로만 재지 않고 혈압·체력까지 보는 것처럼, BSC는 재무 지표만이 아니라 재무·고객·내부프로세스·학습성장 4관점으로 균형 있게 성과를 잽니다. 전략을 실행 가능한 지표로 연결하며, IT-BSC는 이를 IT에 맞춘 것입니다.",
...
"mg-esg": {
    guide: {
      ...
      scene: "성적만 좋은 학생보다 품행까지 좋은 학생이 신뢰받는 것처럼, 기업도 이익만이 아니라 환경(E)·사회(S)·지배구조(G)를 챙겨야 투자자·소비자에게 선택받습니다. ESG는 비재무 요소를 경영·투자 의사결정에 반영하는 흐름으로, 공시·평가가 제도화되고 있습니다.",
...
"mg-design-thinking": {
    guide: {
      hook: "'사용자 공감'에서 출발해 문제를 재정의하고 빠르게 시제품·검증하는 혁신 접근법입니다.",
      scene: "의사가 처방 전에 환자의 생활부터 관찰하는 것처럼, 책상 위 추측 대신 사용자를 관찰·공감해 진짜 문제를 찾습니다. 아이디어를 발산하고 시제품을 만들어 사용자에게 테스트하며, 실패를 빠르게 반복 개선합니다(IDEO·스탠퍼드 d.school).",
...
"mg-servitization": {
    guide: {
      ...
      map: [
        ...
        { as: "사물인터넷 원격 관리(IoT)", real: "데이터 기반 서비스", note: "" },
      ],
...
"mg-protocol-economy": {
    guide: {
      hook: "거대 플랫폼의 독점을 벗어나 '공개 규약(프로토콜)과 참여자 보상'으로 돌아가는 경제 모델입니다.",
      scene: "플랫폼 경제는 중개자(빅테크)가 데이터·수익을 독점합니다. 이 경제 모델(프로토콜 경제)은 마치 공용 규칙만 두고 장이 서는 것처럼, 블록체인 같은 공개 규약 위에서 참여자들이 직접 연결·거래하고 기여에 따라 토큰으로 보상받는 탈중앙 모델을 지향합니다.",
...
"mg-intention-economy": {
    guide: {
      ...
      scene: "구인 공고를 기다리는 대신 '이런 조건이면 일하겠다'고 내거는 구직자처럼, 의도 경제는 소비자가 '이런 걸 이 조건에 사고 싶다'는 구매 의도를 공개하면 기업들이 제안으로 응답합니다. 광고로 관심을 사는 관심 경제의 반대이며, AI 에이전트가 이를 대행합니다.",
...
"mg-growth-hacking": {
    guide: {
      ...
      scene: "대규모 광고 대신, 제품 자체에 성장 장치를 심고 빠른 A/B 실험으로 무엇이 사용자 확보·유지·수익화에 효과적인지 찾아 반복합니다. 드롭박스의 추천 보상처럼 데이터를 근거로 성장 지렛대를 찾습니다.",
...
"sc-shannon-principle": {
    guide: {
      ...
      scene: "밀가루 반죽을 생각하면 쉽습니다. 혼돈(Confusion)은 재료(키)와 결과(암호문)의 관계를 뒤엉키게 해 '맛을 보고 레시피를 못 맞히게' 하는 것, 확산(Diffusion)은 소금 한 톨(평문 1비트)을 바꿔도 반죽 전체 맛이 변하게 퍼뜨리는 것입니다.",
...
"sc-homomorphic": {
    guide: {
      ...
      scene: "잠긴 금고에 손만 넣을 수 있는 장갑 구멍이 있다고 생각하면 됩니다. 세탁소(클라우드)는 금고를 못 열지만 장갑 구멍으로 안의 옷을 다려서(연산) 돌려줍니다. 주인이 열어 보면 다려진 옷(연산 결과)이 나옵니다 — 내용물은 한 번도 노출되지 않았습니다.",
...
"sc-cryptanalysis": {
    guide: {
      ...
      scene: "자물쇠 도둑의 성장기라고 생각하면 됩니다. 처음엔 잠긴 자물쇠만 굴려 보고(암호문 단독), 다음엔 열림-잠김 짝을 몇 개 주워서 비교하고(기지 평문), 나중엔 원하는 내용을 직접 잠가 보며 반응을 관찰하고(선택 평문), 끝판엔 복호화 장치까지 빌려 씁니다(선택 암호문).",
...
"sc-pqc": {
    guide: {
      hook: "양자 컴퓨터로도 못 깨는 '수학 문제'로 만든 차세대 암호 — 풀이법(알고리즘) 자체를 교체합니다.",
      scene: "자물쇠 따개가 진화하면 자물쇠의 원리부터 바꿔야 하는 것처럼, 쇼어 풀이법(알고리즘)을 돌리는 양자 컴퓨터가 나오면 RSA·ECC가 무너집니다. PQC는 양자로도 풀기 어려운 격자·해시 등의 문제로 암호를 새로 만들어, 기존 통신 인프라(고전 컴퓨터)에서 그대로 씁니다.",
...
"sc-deepvoice": {
    guide: {
      ...
      scene: "완벽한 성대모사 사기꾼처럼, AI가 자녀·상사·거래처의 짧은 통화나 유튜브 음성 몇 초만으로 그 사람 목소리를 그대로 흉내 냅니다. '엄마 나야, 폰 고장 나서…'가 진짜 목소리로 걸려 오면 사람은 거의 못 거릅니다.",
...
"sc-apt": {
    guide: {
      ...
      scene: "빈집털이가 아니라 위장 취업한 스파이 같은 공격입니다. 스피어피싱 한 통으로 발판을 만들고, 들키지 않게 조금씩 권한을 넓히며 몇 달간 잠복하다가, 원하는 자료를 찾으면 천천히 빼돌립니다.",
...
"sc-sniffing-spoofing": {
    guide: {
      ...
      scene: "스니핑은 회선에 붙인 도청기처럼 조용히 듣는 것(수동), 스푸핑은 가짜 신분증처럼 남 행세를 하는 것(능동)입니다. 둘을 결합하면 통신 중간에 끼어들어 양쪽을 속이며 엿듣는 중간자 공격이 됩니다.",
...
"sc-bpf-door": {
    guide: {
      ...
      scene: "문 대신 벽 속에 숨어 신호를 기다리는 잠입자처럼, BPF Door는 포트를 열지 않습니다. 커널이 모든 패킷을 훑는 길목에 감시병을 심어 뒀다가 '특정 암호가 담긴 패킷'이 지나갈 때만 깨어나 명령을 실행하므로, 포트 스캔에 걸리지 않습니다.",
...
"sc-side-channel": {
    guide: {
      hook: "암호의 수식이 아니라 '구현이 흘리는 부수 정보'를 쳐서 키를 훔칩니다.",
      scene: "금고 다이얼을 못 풀어도 돌릴 때 나는 소리·걸리는 시간·손끝의 저항으로 번호를 알아내는 도둑처럼, 연산 시간·전력 소모·전자파·소리까지가 단서가 됩니다. 수학이 아니라 구현의 빈틈을 치는 공격입니다.",
...
"sc-drive-by-download": {
    guide: {
      ...
      scene: "지나가며 구경만 했는데 소매치기를 당하는 것처럼, 웹페이지를 '보기만' 해도 악성코드가 깔립니다. 해킹된 정상 사이트에 심긴 악성 스크립트가 방문자의 브라우저·플러그인 취약점을 자동으로 찔러 몰래 설치합니다 — 동의도 클릭도 없습니다.",
...
"sc-dos": {
    guide: {
      ...
      scene: "가게 입구를 사람들로 가득 메워 진짜 손님이 못 들어오게 하는 것처럼, 서버의 자원(대역폭·연결·CPU)을 고갈시켜 정상 사용자의 서비스를 마비시킵니다. 여러 좀비 PC를 동원하면 분산 공격(DDoS)입니다.",
...
"sc-drdos": {
    guide: {
      ...
      scene: "피해자 이름으로 수천 곳에 엽서를 보내 답장이 전부 피해자에게 쏟아지게 하는 것처럼, 공격자는 요청의 출발지 주소를 피해자로 속여 반사 서버(DNS·NTP 등)에 보냅니다. 그 응답이 증폭돼 피해자에게 몰립니다.",
...
"sc-rootkit": {
    guide: {
      ...
      scene: "도둑이 침입한 뒤 CCTV 녹화에서 자기 모습만 지우고, 관리인의 명부에서 자기 이름을 빼는 셈입니다. 프로세스·파일·네트워크 연결 목록에서 자신을 숨겨 백신·관리자 눈에 안 띄게 합니다.",
      ...
      map: [
        { as: "녹화에서 자기만 삭제(CCTV)", real: "목록에서 자기 은닉", note: "탐지 회피" },
        { as: "관리자 명부 조작(API 후킹)", real: "사용자/커널 모드 후킹", note: "거짓 보고" },
...
"sc-owasp-2021": {
    guide: {
      ...
      scene: "웹 개발자가 '가장 자주 틀리는 실수 10개'를 모은 오답 노트 같은 순위입니다. 2021년판은 접근통제(권한 검사 누락)를 1위로 올리고, '안전하지 않은 설계'라는 설계 단계 항목을 새로 넣어 '코딩 후 점검'에서 '설계부터 보안'으로 무게를 옮겼습니다.",
...
"sc-owasp-2025": {
    guide: {
      ...
      scene: "2021판을 4년 만에 다시 매긴 성적표 같은 순위입니다. 접근통제는 여전히 상위, 여기에 '공급망'과 확대된 '보안 설정 오류'가 부상해, 코드 자체보다 '무엇을 가져다 쓰고 어떻게 구성했나'가 더 위험해진 흐름을 반영합니다.",
...
"sc-secure-coding": {
    guide: {
      ...
      scene: "완공 후 하자 보수보다 시공 기준을 지키는 게 싸고 확실한 것처럼, 취약점은 고치기보다 처음부터 안 만드는 게 최선입니다. 입력값을 항상 의심하고, 권한을 최소로 주고, 오류 메시지에 내부 정보를 안 흘리는 습관을 코딩 규칙으로 못 박습니다.",
...
"sc-ssrf": {
    guide: {
      ...
      scene: "외부인이 직원을 시켜 금고 서류를 대신 꺼내 오게 하는 것처럼, 서버를 심부름꾼으로 부립니다. '이 URL의 이미지를 가져와 줘' 기능을 악용해 서버가 내부 주소(관리 콘솔·클라우드 메타데이터)를 대신 조회하게 시키면, 서버는 내부에 있으니 요청이 통합니다.",
...
"sc-sw-obfuscation": {
    guide: {
      ...
      scene: "설계도를 알아볼 수 없게 뒤섞어 경쟁사가 베끼지 못하게 하는 것처럼, 코드를 일부러 꼬아 놓습니다. 기능은 그대로 두되 변수명을 무의미하게 바꾸고, 제어 흐름을 스파게티로 만들고, 문자열을 암호화해 역공학·변조의 분석 비용을 폭증시킵니다.",
...
"sc-devsecops": {
    guide: {
      ...
      scene: "출고 직전 검수 한 번이 아니라 조립 라인 공정마다 자동 검사기를 다는 것처럼, DevOps의 CI/CD 파이프라인 곳곳에 보안 자동 점검을 심습니다. 마지막 관문 방식보다 빠르고 싸게 결함을 잡는 문화입니다.",
...
"sc-pbd": {
    guide: {
      ...
      scene: "안전벨트를 사고 후 다는 게 아니라 차 설계 때부터 넣는 것처럼, 서비스를 기획할 때부터 개인정보 보호를 기본값으로 심습니다. 사용자가 설정을 안 만져도 가장 안전한 상태가 기본이어야 합니다.",
...
"sc-pbd-cert": {
    guide: {
      ...
      scene: "PbD 7원칙을 말로만 지킨다고 하면 못 믿으니, 독립 기관이 설계·구현을 심사해 도장을 찍어 주는 품질 인증 마크 같은 제도입니다. 소비자에게는 신뢰 표시, 기업에게는 차별화 근거가 됩니다.",
...
"sc-pseudonymization": {
    guide: {
      ...
      scene: "환자 명단에서 '홍길동'을 'P-0421'로 바꾸고 매핑표는 따로 금고에 잠그는 것처럼, 추가 정보 없이는 못 알아보게 만듭니다. 매핑표 없이는 누군지 모르지만(가명) 필요하면 복원할 수 있습니다 — 이 '복원 가능성'이 익명화와의 결정적 차이입니다.",
...
"sc-pseudonym-guideline": {
    guide: {
      ...
      scene: "요리 개념을 따라 하기 쉬운 레시피로 풀어 주는 것처럼, 가명처리를 현장에서 그대로 따라 할 수 있게 만든 매뉴얼입니다. 목적을 정하고 → 위험을 따져 처리 수준을 정하고 → 가명처리하고 → 안전하게 관리하고 → 활용·파기하는 절차를 규정합니다.",
...
"sc-ssdf": {
    guide: {
      ...
      scene: "개인의 습관을 회사의 업무 매뉴얼로 격상하는 것처럼, SSDF는 시큐어 코딩·DevSecOps의 실천을 조직 차원의 표준 항목으로 목록화합니다. 준비→보호→생산→대응의 네 묶음으로 '무엇을 갖춰야 하나'를 정의합니다(NIST SP 800-218).",
...
"sc-dns-sinkhole": {
    guide: {
      ...
      scene: "수상한 전화를 몰래 경찰서로 돌려 버리는 것처럼, 좀비 PC가 공격자 지휘 서버(C2)의 주소를 물으면 DNS가 진짜 대신 '싱크홀' 서버의 주소를 돌려줍니다. 좀비는 명령을 못 받아 무력화되고, 동시에 감염 현황이 파악됩니다.",
...
"sc-dnssec": {
    guide: {
      ...
      scene: "서명 없는 전화번호부에 가짜 번호를 끼워 넣어도 모르는 것처럼, DNS는 원래 위조 응답(DNS 스푸핑)을 구별하지 못했습니다. DNSSEC은 각 응답에 공개키 전자서명을 붙여, 위조된 응답을 검증 단계에서 걸러냅니다.",
...
"sc-ipsec": {
    guide: {
      hook: "IP 계층에서 통째로 암호화·인증하는 VPN의 뼈대 규약(프로토콜)입니다.",
      scene: "편지 한 통씩이 아니라 우편 행낭 자체를 잠그는 것처럼, IPSec은 IP 계층에서 그 위를 지나는 모든 통신을 한꺼번에 보호합니다. 특정 앱(브라우저)만 지키는 TLS와 달리, 네트워크 계층에서 동작해 응용을 가리지 않습니다.",
...
"sc-tls-ssl": {
    guide: {
      ...
      scene: "편지를 보내기 전 상대를 신분증(인증서)으로 확인하고 둘만의 임시 열쇠를 나눠 갖는 것처럼, TLS는 인증→키 교환→암호화 순서로 통신을 지킵니다. 이 준비 과정이 핸드셰이크이고, 브라우저 자물쇠 아이콘의 정체입니다.",
...
"sc-cwpp-cspm": {
    guide: {
      ...
      scene: "CWPP는 건물 안 각 사무실(VM·컨테이너)에 경비를 두는 것, CSPM은 건물 도면을 보며 잠기지 않은 문(설정 실수)을 찾는 것 — 딱 이 역할 분담입니다. 클라우드 사고의 대부분이 잘못된 설정이라 안과 밖, 둘 다 필요합니다.",
...
"sc-sase": {
    guide: {
      ...
      scene: "모든 우편을 본사 우체국까지 보내 검사하던 것을 동네 우체국 검사로 바꾼 것처럼, SASE는 보안 기능을 사용자 가까운 클라우드 엣지로 옮깁니다. 트래픽을 본사로 끌어오는 백홀 없이 그 자리에서 검사하고 바로 목적지로 보내, 원격근무·클라우드 시대에 맞습니다.",
...
"sc-secaas": {
    guide: {
      ...
      scene: "정수기를 사지 않고 렌털하는 것처럼, SECaaS는 방화벽·백신·SIEM 같은 보안 기능을 클라우드 서비스로 구독합니다. 비싼 장비 구매와 전문 인력 없이 필요한 만큼 쓰고, 운영은 사업자에게 맡기는 모델입니다.",
...
"sc-dual-signature": {
    guide: {
      ...
      scene: "처방전과 진료기록을 각자 필요한 곳만 보게 나누는 것처럼, 쇼핑몰은 카드번호를, 카드사는 구매 내역을 몰라야 합니다. 이중서명은 두 정보를 각각 해시한 뒤 합쳐 한 번 서명해, 상인은 주문만·은행은 결제만 보되 '이 결제가 이 주문의 것'임은 검증하게 합니다.",
...
"sc-multi-signature": {
    guide: {
      ...
      scene: "회사 금고를 3명 중 2명이 동시에 열쇠를 돌려야 열리게 하는 것처럼, 다중서명은 N명 중 M명이 서명해야 승인됩니다. 하나의 개인키에 의존하지 않아, 키 하나가 털려도 자금이 안전합니다.",
...
"sc-simple-auth": {
    guide: {
      ...
      scene: "충전 규격을 통일해 어느 폰이든 꽂히게 하는 것처럼, 이 가이드라인은 카카오·네이버·PASS 등 간편인증의 요청·응답 공통 규격(인터페이스)을 정합니다. 이용자·서비스·인증사업자가 한 규격으로 연동돼, 서비스마다 제각각 붙이는 혼란이 사라집니다.",
...
"sc-digital-envelope": {
    guide: {
      ...
      scene: "큰 짐은 빠른 자물쇠로 잠그고 그 열쇠만 수신자의 우편함에 넣어 보내는 것처럼, 데이터는 대칭키로 암호화하고 그 대칭키를 수신자의 공개키로 잠가 함께 보냅니다. 받는 사람은 개인키로 열쇠를 꺼내 짐을 엽니다 — 빠르면서도 열쇠 배송이 안전합니다.",
...
"sc-drm": {
    guide: {
      ...
      scene: "빌린 책에 '복사 금지·반납 기한' 딱지가 붙은 것처럼, 콘텐츠에 사용 규칙(라이선스)을 붙입니다. 영화를 내려받아도 복사·캡처·기한 초과 재생이 안 되게 하고, 규칙을 지킬 때만 복호화 열쇠를 내주는 방식입니다.",
...
"sc-biometric": {
    guide: {
      ...
      scene: "몸에 늘 지니고 다니는 열쇠 같은 것이라, 지문·얼굴·홍채는 잊거나 잃어버리지 않습니다. 다만 유출되면 바꿀 수 없다는 게 치명적이라, 원본 대신 특징점만 변환해 보관하고 통신은 텔레바이오(원격 생체) 표준으로 보호합니다.",
...
"sc-biometric-guide": {
    guide: {
      ...
      scene: "재발급이 안 되는 신분증을 다루는 것처럼 조심하라는 안내서입니다. 지문·얼굴은 유출돼도 바꿀 수 없어 비밀번호보다 훨씬 위험하므로, 생체정보를 수집·이용·보관·파기하는 전 단계에서 지켜야 할 구체 기준(2024.12)을 제시합니다.",
...
"sc-oauth": {
    guide: {
      ...
      scene: "구글 비밀번호 대신 '이 앱은 네 사진만 볼 수 있다'는 임시 출입증을 주는 것처럼, OAuth는 권한을 토큰으로 위임합니다. 앱은 그 토큰으로만 접근하고 비밀번호는 결코 모르니, 토큰이 유출돼도 피해가 그 범위로 제한됩니다.",
...
"sc-passkey": {
    guide: {
      ...
      scene: "훔칠 열쇠 자체를 없앤 문처럼, 패스키에는 피싱당할 비밀번호가 없습니다. 기기에 개인키, 서비스에 공개키를 두고 로그인 때 생체(지문·얼굴)로 개인키 잠금을 풀어 서명만 보냅니다. 비밀번호가 없으니 피싱·유출·재사용 공격이 원천 무력화됩니다.",
...
"sc-asm": {
    guide: {
      ...
      scene: "도둑이 동네를 돌며 열린 창문을 찾는 것처럼, 공격자는 방치된 서버·테스트 도메인·노출된 API·클라우드 버킷을 스캔으로 찾아냅니다. ASM은 그 열린 문들을 공격자보다 먼저, 지속적으로 발견해 줄여 나갑니다.",
...
"sc-siem": {
    guide: {
      ...
      scene: "지점마다 따로 쓰던 일지를 한 상황실에 모아 보는 것처럼, SIEM은 방화벽·서버·단말의 로그를 한곳에 모읍니다. '이 실패 로그인 + 저 비정상 접속'을 상관분석으로 이어 붙여 하나의 사건으로 알려 주며, 차세대는 AI·자동대응(SOAR)을 얹습니다.",
...
"sc-threat-hunting": {
    guide: {
      hook: "경보를 기다리지 않고 '이미 들어와 숨어 있다'고 가정해 먼저 찾아 나섭니다.",
...
"sc-threat-modeling": {
    guide: {
      ...
      scene: "집을 짓기 전 도둑 입장에서 '어디로 들어올까'를 따져 창문·자물쇠를 배치하는 것처럼, 위협 모델링은 설계 단계에서 공격 시나리오를 미리 그립니다. 자산·진입점·신뢰경계를 그린 뒤 위협을 체계적으로 나열하고 대응을 설계에 반영합니다.",
...
"sc-waap": {
    guide: {
      ...
      scene: "성문 하나만 지키다 성벽 전체를 지키게 된 것처럼, 웹 앱만 막던 WAF를 넘어 트래픽의 대부분인 API와 자동화 봇, DDoS까지 함께 지킵니다. WAAP은 WAF+API 보호+봇 관리+DDoS 방어를 한 세트로 묶어 클라우드에서 제공합니다.",
      ...
      map: [
        ...
        { as: "규격 위반 호출 감지(API 스키마)", real: "API 보호", note: "핵심 추가" },
...
"sc-edr": {
    guide: {
      ...
      scene: "도난 신고만 받던 매장에 상시 녹화 CCTV와 실시간 분석을 붙이는 것처럼, EDR은 PC·서버의 프로세스·파일·네트워크 행위를 계속 기록합니다. 아는 악성코드만 막는 백신과 달리 이상 행위 패턴을 탐지하고, 원격으로 격리·차단까지 합니다.",
      ...
      map: [
        { as: "상시 녹화 감시카메라(CCTV)", real: "단말 행위 지속 기록", note: "가시성" },
...
"sc-xdr": {
    guide: {
      ...
      scene: "매장·주차장·창고의 감시카메라를 한 관제실에서 통합해 보는 것처럼, XDR은 단말(EDR)에 네트워크·이메일·클라우드 신호까지 모읍니다. 여러 계층의 신호를 자동 상관분석해, 흩어진 단서를 하나의 공격 스토리로 엮습니다.",
      ...
      map: [
        { as: "여러 감시망을 한 관제실로(CCTV)", real: "다계층 텔레메트리 통합", note: "" },
...
"sc-dmarc": {
    guide: {
      ...
      scene: "봉투의 발신 주소를 누구나 마음대로 쓸 수 있는 것처럼, 메일의 From은 위조가 쉽습니다. DMARC는 SPF(발송 서버 대조)·DKIM(서명 검증) 결과를 발신 도메인과 정렬(Alignment)해 확인하고, 실패한 메일의 처리(격리·거부)를 도메인 주인이 정책으로 선언합니다.",
...
"sc-cyber-deception": {
    guide: {
      ...
      scene: "진짜 금고 옆에 그럴듯한 가짜 금고(허니팟)를 두는 것처럼, 정상 사용자는 건드릴 일 없는 미끼 자산을 깔아 둡니다. 공격자가 만지는 순간 그 자체가 침입 신호라 오탐이 거의 없고, 공격자의 도구·의도까지 드러납니다.",
...
"sc-dis": {
    guide: {
      ...
      scene: "감기 바이러스가 들어오면 몸이 알아서 항체를 만들고 회복하는 것처럼, 소프트웨어가 공격·장애를 스스로 감지해 격리하고 복구합니다. 사람이 일일이 대응하지 않아도 회복탄력성을 갖도록 설계하는 면역계형 보안입니다.",
...
"sc-pec": {
    guide: {
      ...
      scene: "원본 장부는 못 보여 줘도 합산 결과는 함께 낼 수 있는 것처럼, PEC은 원본 노출 없이 계산·학습·분석을 가능하게 합니다. 여러 병원이 환자 데이터를 안 넘기고도 공동 연구를 하는 식이며, 가트너가 꼽은 프라이버시 강화 계산의 우산 개념입니다.",
...
"sc-zkp": {
    guide: {
      hook: "'비밀을 밝히지 않고도 그 비밀을 안다는 사실만 증명'하는 마법 같은 절차(프로토콜)입니다.",
...
"sc-confidential-computing": {
    guide: {
      ...
      scene: "은행 안에서도 아무나 못 들어가는 금고실이 따로 있는 것처럼, CPU 안에 외부(OS·관리자·클라우드 사업자)도 못 들여다보는 격리 구역(TEE)을 만듭니다. 저장·전송 중엔 암호화돼도 처리 순간 평문이 되는 '사용 중 데이터'를 그 안에서만 처리합니다.",
      ...
      map: [
        { as: "칩 안의 금고방(CPU·TEE)", real: "TEE·엔클레이브", note: "사용 중 보호" },
...
"sc-iso-27017": {
    guide: {
      ...
      scene: "일반 건물 소방 규정만으론 고층 빌딩을 못 다루는 것처럼, 일반 보안 통제(27001)만으론 클라우드 특유의 문제를 못 다룹니다. 27017은 사업자-이용자의 책임 경계, 가상자원 격리, 관리자 접근 등에 대해 제공자·이용자 각각의 추가 통제를 제시합니다.",
...
"sc-iec-62443": {
    guide: {
      ...
      scene: "정보가 새는 것보다 공장이 멈춰 폭발·정전이 나는 게 더 무서운 것처럼, 제어망(ICS/OT)은 IT와 우선순위가 다릅니다(가용성·안전 최우선). 62443은 OT 환경에 맞춰 구역을 나누고(Zone) 통로를 통제하며(Conduit) 보안 등급(SL)을 요구합니다.",
...
"sc-iso-27018": {
    guide: {
      ...
      scene: "창고 보안 규정 중 귀중품 칸만 더 엄격히 다루는 것처럼, 27018은 클라우드 보안(27017) 중 개인정보(PII)에 초점을 맞춥니다. 클라우드 사업자(PII 처리자)가 고객 개인정보를 목적 외로 쓰지 않고, 하위 위탁·국외 이전을 투명하게 하도록 요구합니다.",
...
"sc-iso-21434": {
    guide: {
      ...
      scene: "인터넷에 연결된 차는 달리는 컴퓨터와 같은 처지라, 해킹이 브레이크·조향까지 노립니다. 21434는 기획·개발·생산·운영·폐차까지 차량 사이버 보안을 전 생애주기로 관리하도록 요구하며, 기능안전 표준(ISO 26262)과 짝을 이룹니다.",
      ...
      map: [
        ...
        { as: "완성차-부품사 책임 분담(OEM)", real: "공급망 보안", note: "" },
...
"sc-iso-27701": {
    guide: {
      ...
      map: [
        { as: "보안 체계에 개인정보 얹기(ISMS)", real: "PIMS(27001 확장)", note: "" },
        { as: "수집·동의·권리는 컨트롤러", real: "컨트롤러 통제", note: "" },
        { as: "위탁·삭제는 프로세서", real: "프로세서 통제", note: "" },
        { as: "개인정보법제와 대조표(GDPR)", real: "법령 매핑", note: "컴플라이언스" },
      ],
...
"sc-iso-20889": {
    guide: {
      ...
      scene: "같은 요리를 나라마다 다른 이름으로 부르면 혼란스러운 것처럼, 가명처리·마스킹·총계처리·잡음추가 등 비식별 기법도 문서마다 이름이 달랐습니다. 20889는 이 기법들을 체계적으로 분류하고 재식별 위험·효용을 정리해 공통 언어를 제공합니다.",
...
"sc-e-discovery": {
    guide: {
      ...
      scene: "종이 서류 대신 이메일·메신저·클라우드 파일이 법정 증거가 된 시대의 제도라고 생각하면 됩니다. e-Discovery는 소송에서 전자적으로 저장된 정보(ESI)를 원형·무결성을 유지한 채 찾아내고 검토해 법정에 제출하는 전자증거개시 절차입니다.",
...
"sc-zerotrust-2": {
    guide: {
      ...
      scene: "담장 안이라고 믿었다가 내부자에게 다 털리는 것처럼, 경계 방어는 한 번 뚫리면 끝입니다. 제로트러스트는 위치와 무관하게 모든 접근을 매번 검증하고 최소 권한만 주며, 2.0은 이를 성숙도 모델·구현 절차로 구체화한 국내 가이드라인입니다.",
...
"sc-sdp": {
    guide: {
      ...
      scene: "문을 두드려 신원을 밝히기 전엔 건물 자체가 안 보이는 것처럼, SDP는 인증·인가를 통과하기 전까지 서버를 네트워크에서 아예 가립니다(블랙 클라우드). 접속하면 내부망이 다 보이는 VPN과 달리, 스캔해도 포트가 안 잡혀 공격 표면 자체가 사라집니다.",
      ...
      map: [
        ...
        { as: "가상사설망 과신뢰 대체(VPN)", real: "제로트러스트 구현", note: "" },
      ],
...
"sc-access-control": {
    guide: {
      ...
      scene: "건물 출입처럼 — 이름표를 대고(식별), 진짜 본인인지 확인하고(인증), 어느 층에 갈 수 있는지 정하고(인가), 누가 언제 드나들었는지 기록합니다(책임추적성). 이 4단계 흐름이 접근통제의 뼈대입니다.",
...
"sc-pia": {
    guide: {
      ...
      scene: "건물을 다 짓고 나서 소방 점검을 받으면 늦는 것처럼, 대규모 개인정보 시스템은 구축 전에 위험을 봐야 합니다. PIA는 '어떤 개인정보를, 어떻게 흐르게 하고, 무슨 위험이 있는지'를 사전에 분석해 설계에 반영하게 하는 제도로, PbD의 실행 도구입니다.",
...
"sc-isms-p": {
    guide: {
      ...
      scene: "따로 받던 두 검진을 한 번의 종합검진으로 합친 것처럼, ISMS-P는 정보보안(ISMS)과 개인정보(PIMS) 인증을 통합했습니다. 관리체계+보호대책+개인정보 흐름을 한 번에 심사하며, 개인정보를 안 다루면 ISMS만, 다루면 ISMS-P를 받습니다.",
...
"sc-anti-forensic": {
    guide: {
      ...
      scene: "범인이 지문을 닦고 CCTV 녹화를 지우는 것처럼, 안티포렌식은 수사관이 찾을 증거를 없앱니다. 지우거나(완전 삭제), 숨기거나(스테가노그래피·암호화), 가짜로 오염시켜(타임스탬프 조작) 디지털 포렌식 분석을 어렵게 만듭니다.",
...
"sc-blockchain-crypto": {
    guide: {
      ...
      scene: "블록체인의 신뢰는 마법이 아니라 세 암호기술의 합작이라고 생각하면 됩니다. 해시로 블록을 사슬처럼 엮고(변조 시 연쇄 붕괴), 전자서명으로 거래를 인증하고, 합의 절차(합의 알고리즘)로 분산 원장을 일치시킵니다.",
...
"sc-autonomous-vehicle": {
    guide: {
      ...
      scene: "눈과 귀를 속이면 몸이 잘못 움직이는 것처럼, 자율주행차는 센서와 통신이 곧 공격면입니다. 표지판에 스티커를 붙여 카메라를 속이거나(적대적 공격), V2X 통신을 위조하거나, 내부 CAN 버스를 장악하면 조향·제동까지 노려집니다.",
...
"sc-cmmc": {
    guide: {
      ...
      scene: "'우리는 안전하다'는 말 대신 급수 심사를 받게 하는 것처럼, 미 국방 협력업체는 제3자에게 보안 성숙도 등급을 인증받아야 합니다. 자기 선언에서 외부 인증으로 바꿔 공급망 보안을 강제하는 제도입니다.",
      ...
      map: [
        ...
        { as: "민감정보 보호 110개 통제(CUI)", real: "Level 2(SP 800-171)", note: "제3자 인증" },
        { as: "지능형 위협까지 대응(APT)", real: "Level 3(정부 평가)", note: "" },
      ],
...
"sc-cyber-genome": {
    guide: {
      ...
      scene: "범죄 현장의 DNA로 범인의 계보를 밝히는 것처럼, 악성코드의 코드 조각·행위 특징을 유전자처럼 추출해 '이 변종은 저 조직의 계열'임을 밝힙니다. 시그니처가 조금 바뀐 변종도 계보로 잡아냅니다.",
      ...
      map: [
        { as: "현장 유전자로 계보 추적(DNA)", real: "악성코드 유전자 추출", note: "" },
...
"sc-digital-forensic": {
    guide: {
      ...
      scene: "범죄 현장을 보존 테이프로 둘러치는 것처럼, 디지털 증거도 원본을 건드리면 법정에서 무효가 됩니다. 원본을 그대로 복제(이미징)하고, 해시로 '안 바뀌었음'을 증명하며, 누가 언제 다뤘는지 기록(연계보관)해 무결성을 지킵니다.",
...
"sc-cloud-forensic": {
    guide: {
      ...
      scene: "남의 건물에 세 들어 살며 사건 조사를 하는 것처럼, 클라우드 포렌식은 통제권이 사업자에게 있습니다. 물리 장비 접근이 불가하고 자원이 여러 고객과 섞여 있으며(멀티테넌시) 로그도 사업자가 쥐고 있어, 수집 자체가 특수한 절차를 요구합니다.",
...
"sc-smart-city": {
    guide: {
      ...
      scene: "도시 전체가 한 몸처럼 연결된 만큼, 한 곳의 취약점이 교통·전력·상수도로 연쇄 파급됩니다. 수많은 센서·CCTV·교통신호·에너지 관리가 네트워크로 얽혀 있고, 시민 데이터도 대량 수집돼 프라이버시 위험이 큽니다.",
      ...
      map: [
        { as: "센서·감시카메라 취약(CCTV)", real: "디바이스 계층 위협", note: "IoT 보안" },
...
"sc-smart-factory": {
    guide: {
      ...
      scene: "닫혀 있던 공장 문이 사무실과 이어진 것처럼, 스마트팩토리는 제어망(OT)이 IT와 연결돼 사무망을 통한 침입이 생산라인·로봇까지 도달합니다. 멈추면 손실, 오작동하면 안전 사고로 이어집니다.",
      ...
      map: [
        ...
        { as: "낡은 제어기 무인증(PLC)", real: "레거시 제어기기 취약", note: "" },
...
"sc-cloud-computing": {
    guide: {
      ...
      scene: "전셋집의 골조는 집주인, 집 안 단속은 세입자 몫인 것처럼, 클라우드도 물리 인프라는 사업자가, 그 위 설정·데이터는 내가 책임집니다(책임 공유). 대부분의 사고는 사업자 잘못이 아니라 '내가 잘못 설정한' 공개 버킷·과권한 계정에서 납니다.",
...
"sc-digital-twin": {
    guide: {
      ...
      scene: "거울이 조작되면 내 모습을 잘못 고치게 되는 것처럼, 디지털 트윈은 현실-가상을 잇는 데이터가 공격면입니다. 연결 데이터가 조작되면 가상의 판단이 틀리고, 그 틀린 판단이 현실 설비를 잘못 제어해 물리 피해로 이어집니다.",
...
"sc-n2sf": {
    guide: {
      ...
      scene: "모든 서류를 금고에 넣는 대신 등급별 캐비닛으로 나누는 것처럼, N2SF는 업무를 기밀(C)·민감(S)·공개(O) 등급으로 나눕니다. 일률적 물리 망분리의 경직성을 걷어내고 등급에 맞는 보안만 차등 적용해, 클라우드·AI 도입을 유연하게 합니다.",
...
"sc-owasp-agentic": {
    guide: {
      ...
      scene: "계획하고 도구를 부리고 협업하는 능력이 그대로 흉기가 되는 것처럼, 자율 에이전트의 세 능력이 곧 공격면입니다. OWASP는 이 신종 위협을 15개(T1~T15)로 정리했고, 실행 파이프라인 순서(기억·목표·도구·권한·감사·인간·다중)로 묶으면 외워집니다.",
      ...
      map: [
        ...
        { as: "'톱10'이 아니라 15개", real: "출처 주의", note: "LLM Top 10과 구분" },
      ],
...
"dx-ap2": {
    guide: {
      ...
      scene: "비서에게 심부름을 시킬 때 위임장 3장에 매번 서명을 받아 두는 것처럼, '무엇을 사라(Intent)', '이걸 담았다(Cart)', '이렇게 결제한다(Payment)'에 내 서명을 남깁니다. 나중에 문제가 나면 어디까지 승인했는지 되짚을 수 있습니다.",
...
"dx-ucp": {
    guide: {
      hook: "AI 에이전트가 여러 쇼핑몰을 하나의 규격으로 상대하게 만드는 상거래 규약(프로토콜)입니다(구글).",
      scene: "몰마다 다른 말을 배우는 대신 공용어 하나로 통하는 것처럼, UCP는 상품 탐색부터 결제·주문까지의 데이터 교환을 한 규격으로 통일합니다. 에이전트가 쇼핑몰마다 다른 API를 다 배울 필요가 없어지며, 결제 실행은 AP2에 맡깁니다.",
...
"dx-acp": {
    guide: {
      hook: "ChatGPT 안에서 바로 물건을 사게 하는 OpenAI 주도 상거래 규약 — 위험을 '범위 제한 토큰'으로 막습니다.",
      scene: "이 가게에서 이 금액까지만 쓸 수 있는 상품권처럼, ACP는 '이 금액·이 판매자에만 쓰는' 토큰으로 위험을 좁힙니다. 위임장 3장으로 증명하는 AP2와 달리, 셀러가 붙일 것은 REST 엔드포인트 4개뿐이라 도입이 가볍습니다.",
...
"dx-stablecoin": {
    guide: {
      ...
      map: [
        ...
        { as: "수식만으로 공급 조절(알고리즘형)", real: "무담보 알고리즘형", note: "Terra 붕괴 위험" },
...
"dx-data-space": {
    guide: {
      ...
      scene: "각자 집 열쇠는 쥔 채 왕래 규칙만 정하는 마을처럼, 데이터 스페이스는 데이터를 한곳에 모으지 않고 각자 보유한 채 공통 규칙·신뢰 체계로만 교환합니다. 핵심어는 '데이터 주권' — 넘겨줘도 이용 조건은 내가 정합니다.",
...
"dx-dslm": {
    guide: {
      ...
      map: [
        ...
        { as: "산업 특화 AI 계보(Vertical AI)", real: "sLLM·수직 AI", note: "" },
      ],
...
"sc-ai-privacy-risk": {
    guide: {
      ...
      scene: "시험지를 통째로 외운 학생이 문제를 그대로 뱉는 것처럼, AI는 학습 데이터를 기억했다 노출할 수 있습니다. 합성 콘텐츠로 사람을 해치거나 자동화된 결정으로 권리를 약화시키는 위험까지, 개인정보보호위원회가 4단계 절차로 관리하게 한 모델입니다.",
...
"dx-data-interop": {
    guide: {
      ...
      scene: "길이 뚫려 있는 것과 그 길로 이사를 요구할 권리가 다른 것처럼, 상호 운용성은 시스템이 달라도 데이터를 주고받게 하는 기술적 능력이고, 이동권은 내 데이터를 지정한 곳으로 옮기라고 요구할 권리입니다. 하나는 수단, 하나는 권리입니다.",
...
"sc-ai-agent-threat": {
    guide: {
      ...
      scene: "결재 라인의 단계마다 빈틈이 생길 수 있는 것처럼, 에이전트의 실행 파이프라인 각 단계가 공격면입니다. 결정·기억·도구 호출·인증·인간 개입·협업의 6단계에서 목표 조작, 메모리 오염, 권한 탈취 같은 신종 위협이 생깁니다(금융보안원).",
...
"dx-ai-dlc-sdd": {
    guide: {
      hook: "AI가 개발을 주도하는 두 접근 — '생명주기를 돌리는' AI-DLC와 '명세에서 파생하는' SDD입니다.",
      scene: "감독이 주도하고 사람이 검수하는 촬영장처럼, AI-DLC는 AI가 계획·코딩을 주도하고 사람이 검증합니다. SDD는 기계가 읽는 명세(Spec)를 단일 진실 원천으로 삼아 코드·테스트·문서를 자동 파생하며, 프로세스냐 산출물 기준이냐로 갈립니다.",
...
"dx-aios": {
    guide: {
      ...
      scene: "지금 OS가 프로세스에 CPU·메모리를 나눠 주는 것처럼, AI OS는 에이전트에 LLM과 컨텍스트를 나눠 줍니다. 대응으로 외우면 쉽습니다 — 두뇌·기억은 LLM·컨텍스트로, 커널은 AI OS 커널로, 프로세스는 에이전트로 짝지어집니다.",
      ...
      map: [
        { as: "두뇌·기억의 대응(CPU·RAM↔LLM)", real: "자원 치환", note: "핵심 대응" },
        { as: "작업 배분의 대응(스케줄링)", real: "LLMScheduler", note: "" },
...
"nw-nwdaf": {
    guide: {
      hook: "5G 코어 안에서 '데이터를 분석해 망을 스스로 조율'하는 AI 분석 기능입니다.",
      scene: "몸속에 심어 둔 주치의처럼, NWDAF는 5G 코어가 쏟아내는 로그·상태를 모아 머신러닝 모델로 '앞으로 무슨 일이 생길지' 예측하고 그 결과로 망을 실시간 제어합니다. 학습(모델 만들기)과 추론(예측)이 분리된 게 핵심입니다.",
      ...
      map: [
        ...
        { as: "망 자동 조율(최적화)", real: "예측 기반 제어", note: "용도" },
      ],
...
"nw-network-intelligence": {
    guide: {
      hook: "네트워크가 스스로 '보고·판단·조율'하는 자율 지능화 — AI를 망 운영에 심습니다.",
      scene: "자율주행차가 스스로 핸들을 꺾는 것처럼, 사람이 일일이 튜닝하던 망을 AI가 트래픽·장애를 예측해 자동으로 라우팅·자원·정책을 조정합니다. 관찰(데이터)→분석(AI)→실행(제어)의 자율 루프를 망 안에 넣습니다.",
...
"nw-6g": {
    guide: {
      ...
      scene: "5G가 사람·사물을 이었다면, 6G는 홀로그램까지 실어 나르는 초고속도로 같은 망입니다. 초당 테라비트급 속도와 마이크로초급 지연으로 디지털 트윈·완전 자율을 지원하고, 지상망과 위성망을 하나로 묶어 어디서나 연결을 목표로 합니다(2030년경).",
...
"nw-ntn": {
    guide: {
      ...
      scene: "기지국이 못 닿는 곳에 하늘의 중계탑을 띄우는 것처럼, 바다·산악·재난 지역을 저궤도 위성(스타링크 등)이나 성층권 무인기(HAPS)로 커버합니다. 6G는 이 하늘 망을 지상망과 하나로 통합해 전지구 연결을 목표로 합니다.",
...
"nw-wifi7": {
    guide: {
      ...
      scene: "차선을 넓히고 화물을 빽빽이 싣고 여러 도로를 동시에 쓰는 것처럼, Wi-Fi 7은 채널을 더 넓게(320MHz), 신호를 더 촘촘하게(4096-QAM) 쓰고 여러 대역을 동시에 묶습니다(MLO). 지연·속도가 크게 개선돼 초고화질 무선·XR용입니다.",
...
"nw-wifi8": {
    guide: {
      ...
      scene: "최고 속도 자랑 대신 정시 운행을 약속하는 열차처럼, Wi-Fi 8(802.11bn)은 '끊김 없고 일관된' 연결을 지향합니다. 혼잡한 환경·이동 중에도 지연이 튀지 않게 여러 AP가 협력해 안정성을 보장하는 초고신뢰(UHR) 방향입니다.",
...
"nw-passive-wifi": {
    guide: {
      ...
      scene: "제 목소리 대신 메아리에 말을 실어 보내는 것처럼, Passive WiFi는 주변에 이미 있는 신호를 반사·변조(백스캐터)해 데이터를 보냅니다. 전파를 직접 만들지 않아 전력을 1만분의 1 수준으로 낮춘, 배터리 없는 IoT용입니다.",
...
"nw-sdn": {
    guide: {
      ...
      scene: "관제탑과 활주로를 분리한 공항처럼, SDN은 경로 결정(제어)과 패킷 전달을 나눕니다. 장비마다 흩어져 있던 제어를 중앙 컨트롤러로 빼내, 소프트웨어로 전체 망을 한눈에 보고 프로그래밍하듯 제어합니다.",
...
"nw-oran": {
    guide: {
      hook: "폐쇄적이던 기지국 장비를 '개방형 표준 연결 규격'으로 열어 벤더 종속을 깬 RAN입니다.",
      scene: "부품 규격을 공개해 어느 회사 부품이든 조립되게 한 것처럼, O-RAN은 기지국 구성요소 간 연결 규격(인터페이스)을 표준·개방합니다. 한 제조사 종속·고비용이던 RAN에 서로 다른 벤더 장비를 섞어 쓰고(믹스앤매치), AI로 지능화합니다.",
      ...
      map: [
        ...
        { as: "인공지능으로 지능화(RIC)", real: "RIC(지능형 컨트롤러)", note: "" },
...
"nw-ran-sharing": {
    guide: {
      ...
      map: [
        ...
        { as: "접속망 장비까지 공유(RAN)", real: "능동 공유", note: "" },
...
"nw-5g-private": {
    guide: {
      ...
      scene: "우리 마당에만 놓는 전용 수영장처럼, 5G 특화망은 공장·항만·병원 부지 전용으로 5G를 구축합니다. 공용 이동통신에 의존하지 않고, 초저지연·고신뢰가 필요한 스마트팩토리·로봇을 자체 통제 하에 운영합니다.",
...
"nw-network-slicing": {
    guide: {
      ...
      map: [
        ...
        { as: "초다수 사물 연결(mMTC)", real: "mMTC 슬라이스", note: "" },
      ],
...
"nw-rarp": {
    guide: {
      hook: "ARP의 반대 — 자기 'MAC 주소로 IP를 알아내는' 초기 부팅용 규약입니다.",
      scene: "이름 없이 태어난 아이가 관청에서 이름을 받아 오는 것처럼, 디스크 없는 단말은 켜질 때 자기 IP를 모릅니다. RARP는 '내 MAC은 이건데 IP 뭐야?'를 서버에 물어 IP를 받으며, 지금은 기능이 많은 DHCP로 대체됐습니다.",
      ...
      map: [
        { as: "내 물리주소로 IP 묻기(MAC)", real: "L2→L3(ARP 반대)", note: "" },
        { as: "부팅 시 자기 IP 획득", real: "디스크리스 단말", note: "" },
        { as: "IP만 주고 끝", real: "기능 한계", note: "게이트웨이·DNS 없음" },
        { as: "자동 설정으로 대체(DHCP)", real: "BOOTP→DHCP", note: "" },
      ],
...
"nw-dhcp": {
    guide: {
      hook: "네트워크에 접속하면 'IP·게이트웨이·DNS를 자동으로' 나눠 주는 설정 규약입니다.",
...
"nw-sctp": {
    guide: {
      hook: "TCP와 UDP의 장점을 합친 '멀티스트림·멀티호밍' 전송 규약입니다.",
      scene: "차로 하나가 막혀도 다른 차로로 달리는 다차선 도로처럼, SCTP는 한 연결에 여러 스트림을 두어 하나가 막혀도 나머지가 흐릅니다(HOL 격리). 여러 IP 경로를 동시에 쥐고 있어(멀티호밍) 한 경로가 죽어도 이어집니다.",
      ...
      map: [
        ...
        { as: "쿠키로 위조 연결 방어(SYN)", real: "4-way 핸드셰이크", note: "보안" },
      ],
...
"nw-cran": {
    guide: {
      ...
      scene: "동네마다 두던 주방을 중앙 조리센터로 모으고 매장엔 서빙만 남기는 것처럼, C-RAN은 신호 처리부(BBU)를 중앙 데이터센터에 풀(Pool)로 모으고 현장엔 안테나부(RRH)만 남깁니다. 자원을 공유·집중 관리해 효율을 높입니다.",
...
"nw-hamming": {
    guide: {
      ...
      scene: "'몇 번째 자리가 틀렸는지'까지 짚어 주는 채점표 같은 코드입니다. 패리티 1개는 틀렸다는 사실만 알지만, 해밍코드는 패리티를 2의 거듭제곱 위치에 여러 개 넣어 오류 비트의 위치를 이진수로 지목하고 그 비트를 뒤집어 고칩니다(1비트 오류 정정).",
...
"nw-qos": {
    guide: {
      ...
      scene: "응급차에 길을 먼저 내주는 것처럼, QoS는 중요한 트래픽에 우선순위를 줍니다. 조금만 늦어도 끊기는 화상회의·VoIP는 먼저, 느려도 되는 파일 다운로드는 나중 — 트래픽을 분류해 대역·지연·손실을 관리합니다.",
...
"nw-arp": {
    guide: {
      hook: "IP 주소로 '같은 랜의 MAC 주소'를 알아내는 주소 변환 규약입니다.",
      scene: "강의실에서 '홍길동 씨 누구세요?'라고 외치면 본인이 손드는 것처럼, ARP는 '이 IP 쓰는 사람 MAC이 뭐야?'를 브로드캐스트로 묻습니다. 해당 호스트가 자기 물리 주소(MAC)로 응답하면 캐시에 저장해 두고 씁니다.",
      ...
      map: [
        { as: "IP로 물리주소 묻기(MAC)", real: "L3→L2 매핑", note: "핵심" },
...
"nw-dns": {
    guide: {
      ...
      scene: "전화번호부에서 이름으로 번호를 찾는 것처럼, DNS는 사람이 읽는 도메인(www.example.com)을 컴퓨터가 쓰는 IP로 번역합니다. 전 세계 서버가 계층적으로 나눠 관리하는 분산 데이터베이스입니다.",
      ...
      map: [
        ...
        { as: "뿌리→최상위→권한 서버 순회", real: "계층 구조", note: "분산" },
        { as: "리졸버가 대신 반복 질의", real: "재귀·반복 질의", note: "" },
        { as: "유효시간 동안 기억(TTL)", real: "캐싱", note: "성능" },
      ],
...
"nw-routing": {
    guide: {
      ...
      scene: "옆집 소문만 믿고 길을 고르는 사람과 지도를 직접 그려 보는 사람의 차이처럼, 거리벡터는 이웃이 알려 준 '거기까지 몇 홉'으로 경로를 정하고, 링크상태는 전체 망 지도를 각자 그려 최단경로를 계산합니다. 정보 공유 방식이 다릅니다.",
...
"nw-fec-bec": {
    guide: {
      ...
      map: [
        ...
        { as: "되돌림 재전송 3방식(GBN·SR)", real: "ARQ 방식", note: "BEC 종류" },
      ],
...
"nw-tcp-congestion": {
    guide: {
      ...
      scene: "고속도로에 차를 한꺼번에 풀면 정체가 심해지는 것처럼, TCP는 망 상태를 보며 속도를 조절합니다. 처음엔 빠르게 늘리다가(느린 시작) 어느 선부터 천천히 늘리고, 혼잡 신호(패킷 손실)가 오면 확 줄이는 식으로 창(Window) 크기를 조절합니다.",
      ...
      map: [
        ...
        { as: "중복 응답 시 즉시 재전송(ACK)", real: "빠른 재전송", note: "" },
      ],
...
"nw-tcp-udp": {
    guide: {
      hook: "'신뢰의 TCP'와 '속도의 UDP' — 목적이 정반대인 두 전송 규약입니다.",
      scene: "등기우편과 일반 엽서의 차이처럼, 중요한 파일은 빠짐없이 순서대로 와야 하니 TCP(연결·확인·재전송), 실시간 영상·게임은 조금 빠져도 빨리 와야 하니 UDP(비연결·무보장·저지연)를 씁니다. 신뢰성과 속도를 맞바꿉니다.",
      ...
      map: [
        ...
        { as: "실시간 영상·질의·통화(DNS·VoIP)", real: "UDP 응용", note: "" },
      ],
...
"nw-ipv4-ipv6-tunneling": {
    guide: {
      ...
      scene: "국제 소포를 현지 규격 상자에 넣어 보내는 것처럼, 터널링은 IPv6 패킷을 IPv4 패킷 안에 통째로 넣어(캡슐화) IPv4 바다를 건너보냅니다. 반대편에서 껍질을 벗겨 IPv6로 복원하는 과도기 전환 기술입니다.",
      ...
      map: [
        { as: "새 주소를 옛 상자에 감싸기(캡슐화)", real: "캡슐화 터널링", note: "핵심" },
        { as: "양쪽 다 지원", real: "듀얼스택", note: "다른 전환법" },
        { as: "규약 자체를 변환(주소·헤더 변환)", real: "NAT64/변환", note: "다른 전환법" },
        { as: "주소변환기 뒤에서도(NAT)", real: "Teredo", note: "터널 방식" },
      ],
...
"nw-csma-ca": {
    guide: {
      ...
      scene: "말하는 동안엔 남의 소리를 못 듣는 무전기처럼, 무선은 전송 중 충돌을 감지할 수 없습니다(숨은 단말). 그래서 미리 회피합니다 — 회선이 비어도 임의 시간 더 기다리고(백오프), 필요하면 '보내도 되냐' 예약(RTS/CTS)을 먼저 합니다.",
...
"nw-multiplexing": {
    guide: {
      ...
      scene: "버스 한 대에 승객 여럿을 태우는 것처럼, 다중화는 값비싼 회선 하나에 여러 신호를 함께 싣습니다. 주파수·시간·파장·코드로 자리를 나눠 겹쳐 보내고, 수신 측에서 다시 분리(역다중화)합니다.",
...
"nw-service-primitive": {
    guide: {
      ...
      scene: "손님과 주방 사이의 '주문→접수→조리 완료→확인' 같은 정해진 대화입니다. 상위 계층이 하위 계층에 서비스를 요청하고 결과를 받는 과정을 '요청(Request)→표시(Indication)→응답(Response)→확인(Confirm)'의 4가지 표준 동작으로 정의합니다.",
...
"nw-osi-7layer": {
    guide: {
      ...
      scene: "우편 시스템이 접수·분류·운송으로 분업하는 것처럼, OSI는 통신을 7계층으로 나눠 각 층이 제 역할만 하게 합니다. 각 층은 아래층 서비스를 쓰고 위층에 서비스를 제공하며, 한 층을 바꿔도 다른 층은 그대로입니다.",
      ...
      map: [
        ...
        { as: "물리주소·프레임(MAC)", real: "2 데이터링크", note: "스위치" },
        { as: "IP·라우팅", real: "3 네트워크(패킷)", note: "라우터" },
        { as: "신뢰 전송·포트(TCP)", real: "4 전송(세그먼트)", note: "" },
      ],
...
"nw-http3": {
    guide: {
      ...
      scene: "한 명이 넘어지면 줄 전체가 멈추는 단체 달리기 같은 문제(HOL 블로킹)가 TCP엔 있었습니다. HTTP/3는 UDP 기반 QUIC로 갈아타 스트림을 독립시키고, 연결·암호화 핸드셰이크를 한 번에 끝내 접속을 빠르게 합니다.",
      ...
      map: [
        ...
        { as: "무보장 전송 위에 신뢰 구현(UDP)", real: "QUIC", note: "TCP 대체" },
...
"nw-tcp-handshake": {
    guide: {
      ...
      scene: "전화 걸 때 '여보세요(SYN)→네 들려요(SYN-ACK)→저도요(ACK)' 하고 대화를 시작하는 것처럼, TCP는 3번의 악수로 서로 준비를 확인하고 연결을 엽니다. 끊을 때는 양쪽이 각자 '끊자'와 '알겠다'를 주고받아 4-way로 닫습니다.",
...
"nw-csma-cd": {
    guide: {
      ...
      scene: "여럿이 한 회선을 나눠 쓰는 사내 방송처럼, 유선 이더넷은 조용한지 먼저 듣고(반송파 감지) 말합니다. 그래도 동시에 말하면(충돌) 즉시 멈추고, 각자 랜덤 시간 기다렸다 재시도합니다 — 유선이라 충돌을 '감지'할 수 있습니다.",
...
"al-perf-eval": {
    guide: {
      hook: "풀이 절차(알고리즘)가 '얼마나 빠르고 메모리를 쓰는지'를 입력 크기 기준으로 평가합니다.",
      scene: "손님이 100배로 늘면 요리사의 실력 차가 드러나는 것처럼, 같은 문제를 푸는 풀이법도 데이터가 커지면 성능 차이가 극명합니다. 실행 시간을 초로 재면 컴퓨터·언어마다 다르니, 입력 크기 n이 커질 때 연산 횟수의 증가율(시간·공간 복잡도)로 평가합니다.",
...
"al-big-o": {
    guide: {
      ...
      scene: "손님이 10배로 늘 때 일이 100배로 느는 가게처럼, O(n²)은 데이터 10배에 시간 100배라는 뜻입니다. 빅오는 상수와 낮은 차수를 무시하고 가장 지배적인 증가율만 남겨, 최악의 경우 확장성을 한눈에 비교하게 합니다.",
...
"al-insertion-sort": {
    guide: {
      ...
      scene: "카드 게임에서 새 카드를 이미 정렬된 카드들 사이 알맞은 위치에 끼우는 것처럼, 원소를 하나씩 앞의 정렬된 부분과 비교해 제자리에 삽입합니다. 거의 정렬된 데이터엔 매우 빠릅니다.",
...
"al-bubble-sort": {
    guide: {
      ...
      scene: "물속 거품이 위로 떠오르는 것처럼, 인접한 쌍을 비교해 순서가 틀리면 바꾸며 한 바퀴 돌면 가장 큰 값이 끝에 놓입니다. 이해는 쉽지만 느려서 주로 교육용으로 쓰입니다.",
...
"al-merge-sort": {
    guide: {
      ...
      scene: "카드 뭉치를 반씩 나눠 각자 정렬한 뒤 맞대어 합치는 것처럼, 배열을 더 못 쪼갤 때까지 나눈 뒤(분할) 정렬된 두 부분을 비교하며 하나로 병합합니다(정복). 데이터 상태와 무관하게 늘 O(n log n)으로 꾸준히 빠릅니다.",
...
"al-hash-table": {
    guide: {
      ...
      scene: "사전에서 단어를 찾을 때 처음부터 넘기지 않고 바로 그 쪽을 펴는 것처럼, 해시 테이블은 키를 해시 함수로 배열 인덱스로 바꿔 즉시 접근합니다. 평균 O(1) 저장·검색으로, 딕셔너리·맵의 기반입니다.",
...
"al-dynamic-programming": {
    guide: {
      hook: "'큰 문제를 작은 문제로 나누고, 답을 저장해 재사용'하는 풀이 기법입니다.",
...
"al-greedy": {
    guide: {
      hook: "'매 순간 최선의 선택'만으로 전체 최적을 노리는 기법 — 빠르지만 항상 맞진 않습니다.",
      scene: "거스름돈을 줄 때 큰 동전부터 주는 것처럼, 각 단계에서 지금 가장 좋아 보이는 것을 고릅니다. 특정 조건(탐욕 선택 속성)이 성립하면 전체 최적이 되지만, 아니면 국소 최적에 갇힙니다.",
...
"al-beam-search": {
    guide: {
      ...
      scene: "오디션에서 라운드마다 상위 K명만 남기는 것처럼, 빔 서치는 각 단계에서 가장 유망한 K개(빔 폭)만 남기고 나머지는 버립니다. 전부 보면 폭발하고 하나만 보면 놓치니, 최적성을 일부 포기하고 메모리·속도를 확보합니다. LLM 텍스트 생성에 쓰입니다.",
...
"al-graph-traversal": {
    guide: {
      ...
      scene: "미로를 한 길로 끝까지 파고들다 막히면 되돌아오는 것처럼 탐색하면 DFS, 지금 위치에서 가까운 곳부터 동심원처럼 넓혀 가면 BFS입니다. 그래프의 모든 정점을 방문하는 두 방식으로, 무엇을 찾느냐에 따라 고릅니다.",
...
"al-tf-idf": {
    guide: {
      ...
      scene: "어디서나 흔한 말은 흘려듣고 그 사람만 자주 쓰는 말에 귀 기울이는 것처럼, TF-IDF는 문서 내 빈도(TF)와 희소성(IDF)을 곱해 단어의 중요도를 수치화합니다. 'the'는 모든 문서에 흔해 점수가 낮고, 특정 문서에만 잦은 단어가 핵심어가 됩니다.",
      ...
      map: [
        ...
        { as: "빈도×희소성의 곱(TF-IDF)", real: "중요도 가중치", note: "핵심" },
...
"al-mst": {
    guide: {
      ...
      scene: "여러 마을을 최소 비용의 도로로 모두 잇는 공사 계획처럼, MST는 모든 정점을 사이클 없이 연결하되 간선 가중치 합이 최소인 트리입니다. 크루스칼·프림 같은 그리디 방식으로 구합니다.",
...
"al-tree-traversal": {
    guide: {
      ...
      scene: "집안 족보를 읽는 순서를 정하는 것처럼, 트리를 빠짐없이 훑으려면 방문 규칙이 필요합니다. 루트를 언제 방문하느냐에 따라 전위(먼저)·중위(중간)·후위(나중)로 나뉘고, 층별로 훑는 레벨 순회도 있습니다.",
...
"al-dijkstra": {
    guide: {
      hook: "'가중치 그래프에서 최단경로'를 찾는 대표 기법 — 음수 간선은 안 됩니다.",
      scene: "내비게이션이 최단 경로를 찾는 것처럼, 시작점에서 각 정점까지의 최소 비용을 구합니다. 아직 확정 안 된 정점 중 가장 가까운 것을 하나씩 확정해 나가는 그리디 방식입니다.",
...
"al-run-length": {
    guide: {
      ...
      map: [
        { as: "같은 값 5개를 '값+5'로", real: "값+반복 횟수", note: "" },
...
"al-huffman": {
    guide: {
      hook: "'자주 나오는 글자엔 짧은 코드'를 주어 데이터를 압축하는 그리디 압축 기법입니다.",
...
"ds-linear-nonlinear": {
    guide: {
      ...
      scene: "구슬을 한 줄로 꿰는 목걸이와 가지를 치는 나무처럼, 자료구조는 크게 둘로 나뉩니다. 한 원소 뒤에 하나만 오는 일렬(선형)과, 하나가 여러 갈래로 이어지는 계층·망(비선형)으로, 용도가 다릅니다.",
...
"ds-linked-list": {
    guide: {
      ...
      scene: "손을 잡고 줄지어 선 사람들처럼, 연결 리스트는 각 노드가 다음 노드의 주소를 가리켜 이어집니다. 크기가 고정되고 중간 삽입이 느린 배열과 달리 필요할 때 노드를 만들어 잇고, 삽입·삭제가 빠른 대신 임의 접근이 느립니다.",
...
"ds-queue": {
    guide: {
      ...
      map: [
        ...
        { as: "너비 탐색·대기열·버퍼(BFS)", real: "활용", note: "" },
      ],
...
"ds-bst": {
    guide: {
      ...
      scene: "'크면 오른쪽, 작으면 왼쪽'의 스무고개처럼, 이진 탐색 트리는 찾는 값과 비교하며 한쪽으로만 내려가 범위를 절반씩 좁힙니다. 정렬·탐색·범위 질의가 빠르지만, 균형이 깨지면 느려집니다.",
...
"ds-heap": {
    guide: {
      ...
      scene: "반에서 1등이 늘 맨 앞줄에 서 있는 것처럼, 힙은 루트에 항상 최대(또는 최소)가 오도록 유지합니다. 최우선 원소를 O(1)에 보고 O(log n)에 꺼내니, 우선순위 큐의 기반이 됩니다.",
...
"ds-btree": {
    guide: {
      ...
      scene: "서랍 하나에 견출지를 여러 장 붙여 한 번에 찾는 것처럼, B-트리는 한 노드에 키를 여러 개 담아 자식을 많이 둡니다. 느린 디스크 접근 횟수(트리 높이)를 줄여 방대한 데이터를 적은 높이로 탐색하며, DB·파일시스템 인덱스의 기본입니다.",
...
"ds-dag": {
    guide: {
      ...
      map: [
        ...
        { as: "작업 의존·커밋 이력(git)", real: "활용", note: "" },
      ],
...
"llmops": {
    guide: {
      ...
      scene: "일반 정비소와 전기차 전문 정비소가 다른 것처럼, LLM 앱은 프롬프트·임베딩·벡터DB·환각 관리 등 일반 ML과 다른 요소가 많습니다. LLMOps는 LLM 특유의 개발·배포·모니터링을 체계화해, 프롬프트부터 운영까지 전 주기를 관리합니다.",
      ...
      map: [
        ...
        { as: "기계학습·개발운영·데이터의 교집합", real: "정의", note: "" },
      ],
...
"ai-watermark": {
    guide: {
      ...
      scene: "지폐에 숨긴 위조 방지 무늬처럼, AI 워터마크는 이미지·영상·오디오·텍스트에 사람 눈에 안 보이는 표식을 심습니다. 진짜와 구별이 안 되는 딥페이크·AI 생성물을 검출·증명해 사회적 혼란을 막습니다.",
...
"genai-user-protection": {
    guide: {
      ...
      scene: "놀이기구에 안전 수칙을 먼저 붙여 두는 것처럼, 이 가이드라인(방통위, 2025.02.28)은 생성형 AI의 허위·차별·인격권 침해 위험을 사전에 막을 기본 원칙과 실천 방안을 제시합니다. 서비스 제공자가 지켜야 할 이용자 권익 보호 기준입니다.",
...
"genai-user-protection-2502": {
    guide: {
      ...
      scene: "제품 출시 전에 소비자 보호 기준부터 마련해 두는 것처럼, 방통위가 2025.2.28 발표한 이 가이드라인은 생성형 AI 이용 과정의 잠재 위험(허위정보·프롬프트 남용·차별)을 사전 방지할 기본 원칙과 실천 방식을 담습니다.",
...
"iso-42119-2": {
    guide: {
      ...
      scene: "일반 차 정비 지침으로 전기차를 못 고치는 것처럼, 비결정성·데이터 의존성이 있는 AI는 기존 테스트 표준을 그대로 쓰기 어렵습니다. ISO/IEC 42119-2는 SW 테스트 국제표준(29119)을 AI 시스템에 적용하는 방법과 AI 특화 용어·기법을 제시합니다.",
...
"brainbody-llm": {
    guide: {
      ...
      scene: "머리 좋은 감독과 손 빠른 선수가 분업하는 것처럼, Brain-Body LLM은 큰 모델이 계획·추론(뇌)을, 작고 빠른 모델이 도구 조작·실행(몸)을 맡습니다. 하나의 LLM이 다 맡을 때의 비효율·오류를 계층 분리로 줄입니다.",
...
"confusion-matrix": {
    guide: {
      ...
      scene: "'맞혔다'만 세지 않고 오답의 종류까지 나누는 채점표처럼, 혼동 행렬은 예측·실제의 일치를 TP·FN·FP·TN 네 칸으로 나눕니다. '정확도 99%'에 속지 않고 정밀도·재현율 등 다양한 지표로 분류 성능을 평가하는 출발점입니다.",
...
"diffusion": {
    guide: {
      ...
      scene: "조각가가 돌덩이에서 불필요한 부분을 깎아 형상을 드러내는 것처럼, 디퓨전은 랜덤 노이즈에서 시작해 노이즈를 거꾸로 반복 제거(Denoise)하며 이미지를 만듭니다. 노이즈를 점점 더하는 과정을 학습해 두고 그 역방향을 실행하는 생성 모델입니다(Stable Diffusion·DALL-E).",
...
"automl": {
    guide: {
      hook: "피처 추출·설정값(하이퍼파라미터) 튜닝 등 ML의 반복 작업을 자동화합니다.",
      scene: "밥솥이 알아서 물 조절을 해 주는 것처럼, AutoML은 피처 엔지니어링과 설정값(하이퍼파라미터) 탐색이라는 지루한 시행착오를 자동화합니다. 전문가가 아니어도 좋은 모델을 얻게 합니다.",
      ...
      map: [
        ...
        { as: "격자 탐색·베이지안(Grid)", real: "하이퍼파라미터 최적화", note: "" },
...
"ai-bias": {
    guide: {
      ...
      scene: "색안경을 끼고 세상을 보는 것처럼, AI 편향은 학습 데이터나 계산 절차(알고리즘)에 스며든 편견으로 AI가 객관성·공정성을 잃는 현상입니다. 채용·대출 AI의 특정 집단 차별로 이어지므로, 원인 규명과 완화가 신뢰 AI의 핵심입니다.",
...
"ai-trism": {
    guide: {
      hook: "AI의 신뢰·위험·보안을 관리하는 가트너의 관리 체계(프레임워크)입니다.",
      ...
      map: [
        { as: "설명 기법·상시 감시(SHAP)", real: "설명 가능성", note: "" },
...
"prompt-injection": {
    guide: {
      ...
      scene: "명령서와 손님 쪽지를 한 바구니에 섞어 두는 것처럼, LLM은 시스템 명령과 사용자 입력을 한 텍스트로 처리합니다. 프롬프트 인젝션은 이 틈에 악성 입력을 주입해 지시를 덮어쓰고, 시스템 프롬프트 탈취·데이터 유출·탈옥을 일으킵니다(OWASP LLM 1위).",
...
"adversarial-attack": {
    guide: {
      ...
      scene: "사람 눈엔 그대로인데 AI만 속는 마술 그림처럼, 적대적 공격은 사람이 못 느끼는 미세한 교란(Adversarial Perturbation)으로 신경망을 속입니다. 표지판에 스티커 몇 개로 자율주행차가 '정지'를 '속도제한'으로 오인하는 오작동을 일으킵니다.",
...
"model-drift": {
    guide: {
      ...
      scene: "여름 옷차림 그대로 겨울을 나면 몸살이 나는 것처럼, 모델은 그대로인데 세상이 변하면 예측이 빗나갑니다. 모델 드리프트는 환경 변화로 배포된 모델의 성능이 점점 떨어지는 현상으로, 지속 모니터링과 재학습이 필요합니다.",
      ...
      map: [
        ...
        { as: "분포 변화 지표로 탐지(PSI·KS)", real: "드리프트 탐지", note: "" },
...
"ai-redteam": {
    guide: {
      ...
      scene: "은행이 제 금고를 스스로 털어 보며 경비를 점검하는 것처럼, AI 레드팀은 배포 전에 모델을 의도적으로 공격합니다. 프롬프트 인젝션·탈옥·편향 유도로 취약점과 사회적 해악을 사전에 발굴하는 탐색적 테스팅입니다.",
...
"ai-system-test": {
    guide: {
      ...
      scene: "채점 기준 없는 논술을 채점하는 것과 같은 난제입니다. AI는 확률적이라 '무엇이 정답인지' 판정하기 어려워(오라클 문제), 메타모픽·조합·뉴런 커버리지 등 AI 특화 기법으로 이 한계를 넘는 테스트 방법을 제시합니다.",
...
"foundation-model": {
    guide: {
      ...
      scene: "한 번 배운 기본기로 여러 종목을 뛰는 만능 선수처럼, 파운데이션 모델은 방대한 데이터로 한 번 사전학습해 두고 파인튜닝·프롬프트로 수많은 태스크에 적응시켜 씁니다. 태스크마다 새로 만들던 비효율을 없앤 범용 기반 모델입니다(GPT·BERT).",
...
"multimodal-ai": {
    guide: {
      ...
      scene: "사람이 눈·귀·입을 함께 쓰는 것처럼, 멀티모달 AI는 이미지·텍스트·음성 등 여러 양식(모달리티)을 동시에 받아들여 통합 추론합니다. 단일 입력만 받는 유니모달보다 넓은 문제를 풉니다(사진을 보며 대화하는 GPT-4V).",
      ...
      map: [
        { as: "언어 이해·생성(NLP)", real: "언어 지능", note: "" },
        { as: "음성 인식·신호처리(STT)", real: "음성 지능", note: "" },
        { as: "영상 인식 모델(CNN·ViT)", real: "시각 지능", note: "" },
        { as: "교차 주의로 융합(Cross-Attention)", real: "통합", note: "" },
      ],
...
"gpai-risk-framework": {
    guide: {
      ...
      scene: "댐이 넘치기 전에 수위를 관리하는 것처럼, 예상 못한 능력이 출현할 수 있는 범용 AI(AGI)의 위험을 미리 다룹니다. GPAI 위험관리 지침 체계(프레임워크)는 개발·활용 위험을 사전에 식별·관리하며, 인류 우선 원칙 아래 통제합니다.",
...
"ai-agent": {
    guide: {
      ...
      scene: "답만 주는 상담원과 일을 끝내 주는 비서의 차이처럼, AI 에이전트는 환경을 인식하고 계획을 세워 도구를 써서 목표를 완수합니다. 사람이 매 단계 지시하지 않아도 스스로 결정·행동하는 자율 시스템입니다.",
...
"a2a": {
    guide: {
      hook: "AI 에이전트끼리 조직·플랫폼 경계를 넘어 통신하는 개방형 규약(프로토콜)입니다.",
      scene: "다른 회사 직원들이 공용어로 회의하는 것처럼, 서로 다른 회사가 만든 에이전트들이 협업하려면 공통 통신 규약이 필요합니다. A2A(Agent-to-Agent, 구글 주도)는 에이전트 간에 안전하게 정보를 교환하고 작업을 위임하게 하는 표준입니다.",
      ...
      map: [
        ...
        { as: "웹 표준 위에서 동작(HTTP)", real: "기존 표준 기반", note: "" },
...
"vibe-coding": {
    guide: {
      ...
      scene: "인테리어를 말로 주문하고 시공은 업자가 하는 것처럼, 바이브 코딩은 자연어로 의도를 전하면 AI가 코드를 생성합니다. 개발자는 한 줄씩 타이핑하는 대신, AI 생성 결과를 검토·조정하며 반복하는 새로운 개발 방식입니다.",
...
"mcp": {
    guide: {
      ...
      map: [
        { as: "거대모델 앱·조율(LLM 호스트)", real: "Host", note: "" },
        { as: "서버 1:1 연결", real: "Client", note: "" },
        { as: "데이터·기능 제공", real: "Server", note: "" },
        { as: "자원·도구·프롬프트 3요소", real: "맥락 3요소", note: "" },
      ],
...
"mcp-security": {
    guide: {
      ...
      scene: "만능 멀티탭에 아무 플러그나 꽂으면 위험한 것처럼, MCP로 외부 도구를 연결하면 악성 도구·서버가 끼어들 위험이 생깁니다. MCP 보안은 도구·연동·서버·클라이언트 각 층위의 위협을 식별하고 방어하는 방안을 다룹니다(137회 정보관리 기출).",
...
"synthetic-data": {
    guide: {
      ...
      map: [
        ...
        { as: "생성 모델 3계열(VAE·GAN·확산)", real: "AI 기반 생성", note: "" },
...
"sovereign-ai": {
    guide: {
      ...
      scene: "식량을 수입에만 의존하면 흉년에 휘둘리는 것처럼, 외국 빅테크 AI 의존은 데이터 유출·문화 미반영·통제 불능의 위험이 있습니다. 소버린 AI는 자국 인프라·데이터·인력으로 AI를 구축해 데이터 주권과 규제 준수를 보장합니다.",
...
"ax": {
    guide: {
      ...
      scene: "전등만 갈던 집을 아예 스마트홈으로 다시 짓는 것처럼, AX(AI Transformation)는 AI를 전사에 적용해 사업 모델·프로세스·제품을 근본적으로 바꿉니다. 프로세스를 디지털화한 DX의 다음 단계로, AI를 도구가 아닌 핵심 동력으로 삼습니다.",
...
"agentic-ai": {
    guide: {
      ...
      scene: "시키는 일만 하는 직원과 알아서 일을 벌여 끝내는 창업가의 차이처럼, 에이전틱 AI는 스스로 목표를 세우고 계획·도구 사용·학습까지 자율적으로 결정합니다. 정해진 작업을 자동화하는 단순 에이전트에서 한 단계 진화한 AI입니다.",
      ...
      map: [
        ...
        { as: "거대모델·검색증강 추론(LLM·RAG)", real: "추론(Reason)", note: "" },
        { as: "자율 계획·도구 호출(API)", real: "행동(Act)", note: "" },
...
"data-quality-v3": {
    guide: {
      ...
      scene: "'쓰레기가 들어가면 쓰레기가 나온다'는 말처럼, AI 성능은 학습 데이터 품질에 달렸습니다. 이 가이드(NIA)는 AI 학습용 데이터의 품질을 확보할 조직·절차·품질기준·관리 활동을 정의하고 점검·조치하게 합니다.",
...
"public-genai-guideline": {
    guide: {
      ...
      scene: "관공서가 새 장비를 들일 때 조달 기준부터 정하는 것처럼, 공공기관의 초거대 AI 도입에도 보안 등급·데이터 학습 방식·조달의 기준이 필요합니다. 이 가이드라인(2.0, 2025.04)은 공공 AI 도입 절차와 성과 관리 방법을 체계적으로 제시합니다.",
      ...
      map: [
        ...
        { as: "기반모델·검색증강 구분(RAG)", real: "학습 방식", note: "" },
...
"ai-trust-cert": {
    guide: {
      ...
      scene: "식품에 위생 기준이 있는 것처럼, AI에도 믿고 쓸 수 있는 가치 기준이 필요합니다. 신뢰할 수 있는 AI는 데이터·모델의 편향과 내재 위험을 해결하고 확산 부작용을 막기 위해, 안전성·설명 가능성·투명성 등 준수해야 할 기준을 제시합니다.",
...
"ai-ready-data": {
    guide: {
      ...
      scene: "손질을 끝내 바로 조리할 수 있는 밀키트처럼, AI Ready 데이터는 정제·라벨링을 거쳐 AI·ML의 훈련·검증·테스트에 즉시 투입할 수 있게 준비·구조화된 데이터입니다. 현실의 원시 데이터는 그대로는 학습에 쓸 수 없기 때문입니다.",
...
"ai-basic-law": {
    guide: {
      ...
      scene: "도로가 생기면 교통법이 필요한 것처럼, AI 확산에도 육성과 규제를 함께 담을 법적 틀이 필요합니다. AI 기본법(2026.1 시행)은 인공지능의 건전한 발전과 신뢰 기반 조성의 기본 사항을 규정한, EU에 이은 세계 두 번째 AI 종합법입니다.",
...
"ai-cost-estimation": {
    guide: {
      ...
      scene: "리모델링 견적을 자재비·시공비·설계비로 나눠 뽑는 것처럼, AI 도입비도 서비스 이용료·커스터마이징 작업비·구축 개발비로 나눠 셈합니다. 사업 유형별로 이 항목들을 계산해 AI 서비스 도입 사업비를 체계적으로 산정합니다.",
...
"distance-formula": {
    guide: {
      ...
      scene: "두 집 사이를 직선으로 잴지 골목길 따라 잴지에 따라 거리가 다른 것처럼, 거리 공식도 여러 가지입니다. 직선의 유클리드, 격자의 맨해튼, 최대 축 차이의 체비쇼프 등 상황에 맞는 거리를 쓰며, KNN·K-means·유사도 계산의 기반입니다.",
  ...
  "vla-model": {
    guide: {
      hook: "눈으로 보고, 말을 알아듣고, 몸을 움직이는 것까지 한 모델이 다 하는 기술입니다.",
      scene: "'파란색 컵을 잡아서 올려줘'라고 말하면 로봇이 카메라로 컵을 찾고, 말뜻을 이해하고, 팔을 뻗어 집습니다. 보고-이해하고-행동하는 세 가지가 따로 놀지 않고 한 모델 안에서 이어집니다.",
      why: "'보고-이해하고-행동하는' 세 축과 동작 토큰화(Action Tokenizer), 폐루프 피드백이 출제 핵심입니다.",
      mechanism: "구성요소: 입력 데이터(다중 모달 데이터·사용자 명령·센서 데이터) → VLA 핵심 모델(VLM Backbone·Fusion Module·Task Planner·동작 생성 헤드) → 출력 및 피드백(Action Tokenizer·Controller·폐루프 피드백). 작동원리: 입력 및 통합(멀티모달 데이터의 공통 언어화, ViT) → 맥락 추론(상호 참조를 통한 상황 이해, Cross-modal Attention) → 행동 예측(자기회귀적 다음 동작 예측, Autoregressive Decoder) → 물리적 실행(추상 토큰의 물리신호 변환, Low-level Controller) → 실시간 자가 교정(폐루프 기반 환경 적응, Closed-loop Feedback).",
      map: [
        { as: "카메라로 컵을 봄", real: "다중 모달 데이터", note: "시각 정보" },
        { as: "말뜻을 알아들음", real: "VLM Backbone", note: "사전 학습 모델" },
        { as: "무엇부터 할지 정함", real: "Task Planner", note: "추론 엔진" },
        { as: "팔을 얼마나 움직일지", real: "Action Tokenizer", note: "동작 토큰" },
        { as: "잘 잡혔는지 다시 봄", real: "폐루프 피드백", note: "상태 업데이트" },
      ],
      usage: "로봇·자율주행차의 핵심 기술입니다. 시험은 구성요소, 작동원리 5단계, 동작 토큰화입니다.",
      links: [
        { topic: "VLM(Vision Language Model)", how: "VLA의 백본으로 쓰입니다." },
        { topic: "월드 파운데이션 모델(World Foundation Model)", how: "VLA가 행동 계층을 맡습니다." },
      ],
      exam: "VLA 모델은 시각 정보·자연어 명령·물리적 행동을 통합한 AI 모델로, 로봇이나 자율주행차에 '보고-이해하고-행동하는' 능력을 부여하는 피지컬 AI의 핵심 기술이다.",
    },
    image: "/concept/book/vla-model.png",
  },
  "world-foundation-model": {
    guide: {
      hook: "글이나 그림을 만드는 데서 멈추지 않고, 현실 세계가 어떻게 굴러가는지를 배운 기초 모델입니다.",
      scene: "공을 던지면 포물선을 그리며 떨어진다는 것을 우리는 겪어서 압니다. 글만 읽은 AI는 이걸 모릅니다. 월드 파운데이션 모델은 중력·인과관계·시간에 따른 변화를 배워, 머릿속으로 다음에 일어날 일을 시뮬레이션합니다.",
      why: "기존 LLM과의 비교(언어 기반 지능 ↔ 물리 기반 지능)와 계층 구조가 출제 핵심입니다.",
      mechanism: "동작 메커니즘: Perception Layer(Vision/Sensor, 물리적 환경 데이터 수집) → Reasoning Layer(VLM, 멀티모달 기반 상황 인지 및 추론) → World Model(Environment Simulation, 내부 환경 시뮬레이션 및 미래 예측) → Planning Layer(RL/MPC, 예측 기반 최적 행동 계획) → Action Layer(VLA, 로봇 제어 정책 생성) → Robot Control(실제 물리적 모터/액추에이터 구동).",
      map: [
        { as: "공이 떨어지는 걸 봄", real: "인지 Perception", note: "Vision/Sensor Fusion" },
        { as: "무슨 상황인지 파악", real: "추론 Reasoning", note: "VLM" },
        { as: "머릿속으로 다음을 그림", real: "World Model", note: "Dynamics Simulator" },
        { as: "어떻게 받을지 정함", real: "계획 Planning", note: "RL / MPC" },
        { as: "손을 뻗음", real: "행동 Action", note: "VLA" },
      ],
      usage: "로봇 제어·자율주행·도시 계획 시뮬레이션에 쓰입니다. 시험은 LLM과의 비교, 계층별 구성요소입니다.",
      links: [
        { topic: "VLA(Vision-Language-Action) 모델", how: "행동 계층을 담당합니다." },
        { topic: "파운데이션 모델(Foundation Model)", how: "기초 모델의 일반 개념입니다." },
      ],
      exam: "월드 파운데이션 모델은 단순히 텍스트나 이미지를 생성하는 것을 넘어, 현실 세계의 물리적 법칙·인과 관계·시공간적 역동성을 이해하고 시뮬레이션할 수 있는 기초 모델(Foundation Model)이다.",
    },
    image: "/concept/book/world-foundation-model.png",
  },
  "xai-methods": {
    guide: {
      hook: "AI가 왜 그렇게 판단했는지를 사람이 알아볼 수 있게 설명해 주는 방법들입니다.",
      scene: "대출이 거절됐는데 이유를 안 알려 주면 승복할 수 없습니다. XAI는 '소득 대비 부채 비율이 이만큼 영향을 줬다'처럼 판단에 기여한 요소를 짚어 줍니다.",
      why: "방법론 5가지(특성 중요도·LIME·SHAP·LRP·탐색적 샘플링)의 기술 키워드와 한계가 출제 핵심입니다.",
      mechanism: "방법론의 종류: 특성 중요도(Feature Importance — 지니 불순도, 트리 분할, 순열 중요도 / 전역 설명, 계산이 빠름, 트리 모델에 적합), LIME(슈퍼픽셀·마스킹, 대체 모델, 국소 선형 근사 / 국소 설명, 모델 독립적), SHAP(Shapley Value, 협력 게임이론, 특성 조합 / 국소·전역 설명, 일관된 기여도, 계산량 큼), LRP(관련성 전파, 층별 역전파, 히트맵 / 신경망 특화, 픽셀별 기여도), 탐색적 샘플링(GAN·VAE, 잠재 공간, 결정 경계 샘플링 / 모델 독립적, 경계 분석).",
      map: [
        { as: "어떤 항목이 중요했나", real: "특성 중요도", note: "전역 설명" },
        { as: "이 한 건만 따로 설명", real: "LIME", note: "국소 선형 근사" },
        { as: "공정하게 공 나누기", real: "SHAP", note: "Shapley Value" },
        { as: "그림에 색칠해 보여 줌", real: "LRP", note: "히트맵" },
      ],
      usage: "의료·금융 등 고위험 분야의 설명 책임에 쓰입니다. 시험은 방법론 5종 비교와 한계(성능·설명력 상충)입니다.",
      links: [
        { topic: "AI RMF(AI Risk Management Framework)", how: "설명가능성(XAI) 검증이 산출물입니다." },
        { topic: "고영향 인공지능(AI) 판단 가이드라인", how: "사업자 책무로 설명가능성을 요구합니다." },
      ],
      exam: "XAI 방법론은 AI의 판단 과정과 근거를 사람이 이해할 수 있게 설명가능한 인공지능으로, 특성 중요도·LIME·SHAP·LRP·탐색적 샘플링 기법을 적용한다.",
    },
    image: "/concept/book/xai-methods.png",
  },
  "ai-rmf": {
    guide: {
      hook: "AI를 믿고 쓸 수 있게, 위험을 다스리는 네 가지 활동으로 정리한 미국 표준기관의 틀입니다.",
      scene: "거버넌스로 규칙을 세우고(Govern), 어디에 위험이 있는지 지도를 그리고(Map), 얼마나 큰지 재고(Measure), 실제로 손을 씁니다(Manage). 네 글자만 외우면 나머지가 따라옵니다.",
      why: "절차 4단계(Governance·Map·Measure·Manage)와 산출물, ISO/IEC 23894와의 비교가 출제 핵심입니다.",
      mechanism: "절차: Governance(AI 정책·조직·역할·책임 정의, 거버넌스 구축 → AI 거버넌스 정책, AI 윤리원칙, 역할·책임(RACI), 위험관리 계획) → Map(AI 시스템 목적·환경 분석, 이해관계자 식별, 위험 식별 → AI 위험 프로파일(Risk Profile), 시스템 맥락(Context) 정의서, 위험 식별 목록(Risk Register)) → Measure(위험 측정·분석·평가, 성능 및 신뢰성 검증 → 위험평가서, TEVV 결과서, 편향 분석보고서, 설명가능성(XAI) 검증 결과) → Manage(위험 대응, 개선, 모니터링, 운영관리 → 위험 대응계획(Risk Treatment Plan), 개선조치 보고서(CAPA), 모니터링 보고서). 특징: 신뢰성 중심, 생명주기 적용, 자율적 적용(비강제 가이드라인).",
      map: [
        { as: "규칙과 책임을 정함", real: "Governance", note: "정책·조직·책임체계" },
        { as: "위험 지도를 그림", real: "MAP", note: "위험 식별" },
        { as: "얼마나 큰지 잼", real: "MEASURE", note: "위험 측정" },
        { as: "손을 써서 줄임", real: "MANAGE", note: "위험 대응" },
      ],
      usage: "AI 신뢰성 확보 체계입니다. 시험은 4단계와 산출물, ISO/IEC 23894 비교(NIST↔ISO)입니다.",
      links: [
        { topic: "ISO/IEC 23894", how: "ISO31000 기반 국제 AI 위험관리 표준입니다." },
        { topic: "AI 기본법", how: "국내 AI 규제의 근거법입니다." },
      ],
      exam: "AI RMF는 AI 시스템의 신뢰성과 안전성을 확보하기 위해 AI 전 생명주기의 위험을 식별·측정·관리하는 NIST 위험관리 프레임워크다.",
    },
    image: "/concept/book/ai-rmf.png",
  },
  "harness-engineering": {
    guide: {
      hook: "AI 에이전트가 제멋대로 굴지 않도록 일할 환경 자체를 설계해 두는 기술입니다.",
      scene: "말에게 목적지를 잘 설명하는 것이 프롬프트, 지도와 표지판을 쥐여 주는 것이 컨텍스트라면, 하네스는 고삐·안장·울타리·도로를 아예 깔아 두는 일입니다. 말이 어디로 가든 길 밖으로는 못 나갑니다.",
      why: "프롬프트·컨텍스트·하네스 엔지니어링의 비교와 구성 요소 3가지가 출제 핵심입니다.",
      mechanism: "구성 요소: 지침·컨텍스트 체계(지침 파일, 구조화 문서 저장소 → 판단 기준 제공 / System of Record, ARCHITECTURE.md, AGENTS.md, Instruction Files), 가드레일·아키텍처 제약(입출력 통제, 구조 규칙, 강제 검증 → 행동 범위 통제 / 구조 규칙, 명명 규칙, 정적 검사), 검증·피드백 루프(CI/CD, 린터(Linter), 구조 테스트, 자동 리뷰 → 결과 검증 및 재주입). 하네스의 역할: 제어(Control — 입력 제한, 권한 범위, 정책 적용), 감시(Monitoring — 상태 추적, 로그 수집, 출력 기록), 개선(Feedback — 오류 반영, 재실행, 규칙 보정).",
      map: [
        { as: "지도·표지판을 줌", real: "지침·컨텍스트 체계", note: "판단 기준 제공" },
        { as: "울타리를 침", real: "가드레일·아키텍처 제약", note: "행동 범위 통제" },
        { as: "달린 뒤 점검하고 고침", real: "검증·피드백 루프", note: "CI/CD, 자동 리뷰" },
        { as: "고삐를 쥠", real: "제어(Control)", note: "권한 범위" },
      ],
      usage: "AI 에이전트 운영 환경 설계에 쓰입니다. 시험은 세 엔지니어링 비교와 구성 요소입니다. 140회 컴시응 1교시 출제.",
      links: [
        { topic: "에이전틱 AI(Agentic AI)", how: "하네스가 감싸는 실행 주체입니다." },
        { topic: "프롬프트 엔지니어링(Prompt Engineering)", how: "지시문 설계 단계의 기법입니다." },
      ],
      exam: "하네스 엔지니어링은 AI 에이전트가 일관된 구조와 품질로 작업하도록 컨텍스트, 제약, 피드백 루프를 기계적으로 설계·운영하는 환경 중심의 엔지니어링이다.",
    },
    image: "/concept/book/harness-engineering.png",
  },
  "paged-attention": {
    guide: {
      hook: "운영체제가 메모리를 쪽(페이지)으로 쪼개 쓰던 방법을 그대로 GPU의 KV 캐시에 가져온 기술입니다.",
      scene: "긴 책을 책장에 꽂을 때 '이만큼 늘어날지 모르니 책장 한 칸을 통째로 비워 두자'고 하면 대부분이 빈칸으로 낭비됩니다. 쪽 단위로 잘라 빈 곳 아무 데나 꽂고 목차(블록 테이블)만 들고 있으면 낭비가 사라집니다.",
      why: "기존 방식의 한계(연속 할당·내부 단편화로 GPU 메모리 최대 60~80% 낭비)와 블록 테이블이 출제 핵심입니다.",
      mechanism: "작동원리: ① 가상 메모리 개념 도입하여 각 시퀀스의 KV 캐시를 고정된 크기(예: 16개 토큰 분량)의 '논리적 블록'으로 분할 → ② 논리적 블록들을 GPU 물리 메모리 상의 비연속적인 '물리적 블록'에 동적으로 매핑 → ③ 운영체제의 페이지 테이블처럼, 논리적 블록과 물리적 블록의 연결 정보를 담은 '블록 테이블(Block Table)'을 유지(관리) → ④ 모델이 어텐션 연산을 수행할 때, 블록 테이블을 참조하여 물리적으로 떨어져 있는 KV 캐시 블록들을 순서대로 읽어와 연산.",
      map: [
        { as: "책을 쪽 단위로 자름", real: "Logical Block", note: "고정크기 논리블록" },
        { as: "빈 곳 아무 데나 꽂음", real: "Physical GPU Block", note: "동적 할당" },
        { as: "어디 꽂았는지 적은 목차", real: "Block Table", note: "매핑 관계 주소 테이블" },
        { as: "같은 책은 같이 봄", real: "Block Sharing", note: "프롬프트 데이터 공유" },
      ],
      usage: "LLM 추론 서빙(vLLM)의 핵심입니다. 시험은 한계점 3가지와 작동원리 4단계입니다. 140회 컴시응 1교시 출제.",
      links: [
        { topic: "어텐션 메커니즘(Attention Mechanism)", how: "KV 캐시가 생기는 원리입니다." },
        { topic: "대규모 언어 모델(LLM) 성능 향상 기술", how: "추론 처리량을 높이는 기법군입니다." },
      ],
      exam: "페이지드 어텐션은 언어 모델(LLM)의 추론 속도와 처리량을 높이기 위해 운영체제(OS)의 가상 메모리 페이징 기법을 KV 캐시(Key-Value Cache)에 적용한 메모리 관리 기술이다.",
    },
    image: "/concept/book/paged-attention.png",
  },
  "vlm": {
    guide: {
      hook: "그림을 보고 말로 설명할 수 있게, 컴퓨터 비전과 자연어 처리를 한 모델에 붙인 것입니다.",
      scene: "사진을 보여 주며 '여기 뭐가 있어?'라고 물으면 대답하는 모델입니다. 이미지는 이미지대로, 말은 말대로 각각 숫자로 바꾼 뒤 같은 공간(Shared Embedding Space)에 놓아야 서로를 알아봅니다.",
      why: "비전·언어 통합 기술 3가지(Cross Attention·PrefixLM·Contrastive Learning)의 비교가 출제 핵심입니다.",
      mechanism: "구성요소: 언어 인코더(BERT, RoBERTa, MPNet), 비전 인코더(ViT / CNN / CLIP), 멀티모달 융합(Cross Attention, PrefixLM, Contrastive Learning), 출력 레이어(LLM 기반 디코더). 학습 방법: 대조적 학습, 마스킹, 생성형 모델 학습, 사전 학습 모델. 도입 시 3대 핵심: 맥락 이해, Few-shot + 파인튜닝 전략, 적정 규모 선택(7B~10B).",
      map: [
        { as: "사진을 숫자로 바꿈", real: "Image Encoder", note: "ViT / CNN / CLIP" },
        { as: "말을 숫자로 바꿈", real: "Tokenizer + embedding layer", note: "" },
        { as: "같은 책상에 나란히 둠", real: "Shared Embedding Space", note: "공유 임베딩 공간" },
        { as: "보고 말로 대답", real: "Language Model", note: "Decoder Component" },
      ],
      usage: "멀티모달 질의응답·캡션 생성·이미지 검색에 쓰입니다. 시험은 구성요소와 융합 기술 3종 비교입니다.",
      links: [
        { topic: "VLA(Vision-Language-Action) 모델", how: "VLM에 행동(Action)을 더한 모델입니다." },
        { topic: "멀티모달(Multimodal) AI", how: "비전·언어 결합의 상위 개념입니다." },
      ],
      exam: "VLM은 이미지인 컴퓨터 비전과 자연어 처리 기능을 결합하여 함께 처리할 수 있도록 설계된 멀티모델 AI 모델이다.",
    },
    image: "/concept/book/vlm.png",
  },
  "iso-iec-23894": {
    guide: {
      hook: "AI가 일으킬 수 있는 위험을 찾고 재고 다루는 절차를 국제 표준으로 못 박은 것입니다.",
      scene: "공장에 새 기계를 들일 때 '무슨 사고가 날 수 있나, 얼마나 큰가, 어떻게 막을까'를 문서로 정해 두고 점검합니다. ISO 31000(일반 위험관리)을 AI에 맞춰 옮겨 놓은 것이 ISO/IEC 23894입니다.",
      why: "위험관리 절차 5단계와 AI RMF와의 비교가 출제 핵심입니다.",
      mechanism: "위험관리 절차: Context 설정(AI 거버넌스 — 조직의 목표, 이해관계자, 위험관리 기준을 정의) → 위험평가(AI 위험평가 Risk Assessment — AI 위험을 식별·분석·평가하여 우선순위를 결정) → 위험처리(AI 위험처리 Risk Treatment — 위험을 회피·완화·전가·수용하는 대응방안을 수립) → 운영 및 검증(신뢰가능 AI Trustworthy AI — 공정성, 설명가능성, 투명성, 안전성을 확보) → 지속적 개선(모니터링 Monitoring & Review — 성능·드리프트·규제 변화 등을 지속적으로 점검 및 개선).",
      map: [
        { as: "무엇을 지킬지 정함", real: "Context 설정", note: "AI 거버넌스" },
        { as: "무슨 사고가 날지 찾음", real: "위험평가", note: "식별·분석·평가" },
        { as: "피하거나 줄이거나 떠넘김", real: "위험처리", note: "회피·완화·전가·수용" },
        { as: "계속 지켜봄", real: "지속적 개선", note: "Monitoring & Review" },
      ],
      usage: "AI 위험관리 체계 수립의 국제 기준입니다. 시험은 절차 5단계와 AI RMF 비교입니다.",
      links: [
        { topic: "AI RMF(AI Risk Management Framework)", how: "NIST의 AI 특화 프레임워크와 짝입니다." },
        { topic: "범용 인공지능 위험관리 프레임워크", how: "AI 위험관리 체계의 한 갈래입니다." },
      ],
      exam: "ISO/IEC 23894는 AI 시스템의 위험을 식별·분석·평가·처리·모니터링하기 위한 AI 위험관리 국제표준이다.",
    },
    image: "/concept/book/iso-iec-23894.png",
  },
  "ai-bom": {
    guide: {
      hook: "AI 시스템에 무엇이 들어갔는지를 성분표처럼 적어 두는 문서입니다.",
      scene: "식품 포장 뒤 원재료명처럼, 어떤 모델을 어떤 데이터로 어떤 라이브러리 위에서 만들었는지 적어 둡니다. 나중에 취약점이 터졌을 때 '우리 것에 그게 들어 있나'를 바로 찾을 수 있습니다.",
      why: "SBOM과의 비교와 표준 포맷(CycloneDX v1.5, Hugging Face Model Cards)이 출제 핵심입니다.",
      mechanism: "구성 요소 체계: 모델 명세(아키텍처, 버전, 훈련 환경, 성능 지표), 데이터 명세(훈련 데이터셋, 출처, 라이선스, 전처리), 라이브러리(의존 패키지, 버전, 라이선스), 알고리즘(학습 방법론, 하이퍼파라미터, 평가 기준). 구성 요소: 모델카드(Model Card — 모델 목적·성능·한계·사용 지침을 표준 형식으로 문서화), 데이터시트(Datasheet — 학습 데이터 출처·수집 방법·편향 분석을 명세화), SBOM 통합(기존 소프트웨어 BOM(CycloneDX/SPDX)과 AI 명세 연계), 취약점 관리(NVD/CVE 기반 AI 구성요소 취약점 지속 모니터링).",
      map: [
        { as: "원재료명 표기", real: "데이터 명세", note: "출처·라이선스" },
        { as: "제품 사양서", real: "모델카드", note: "목적·성능·한계" },
        { as: "부품 목록", real: "라이브러리", note: "의존 패키지" },
        { as: "리콜 대상 조회", real: "취약점 관리", note: "NVD/CVE" },
      ],
      usage: "AI 공급망 보안·규제 대응에 쓰입니다. 시험은 SBOM 비교와 표준 포맷입니다. 140회 정보관리 2교시 출제.",
      links: [
        { topic: "AI RMF(AI Risk Management Framework)", how: "규제 근거로 연결됩니다." },
        { topic: "오픈웨이트(Open-weight) 모델", how: "공개 범위에 따라 명세가 달라집니다." },
      ],
      exam: "AI BOM은 AI 시스템을 구성하는 데이터, 모델, 소프트웨어 라이브러리, 인프라 등 모든 구성요소를 체계적으로 목록화하고 추적하는 문서다.",
    },
    image: "/concept/book/ai-bom.png",
  },
  "open-weight-model": {
    guide: {
      hook: "설계도와 재료는 안 주고, 다 만들어진 결과물만 주는 모델입니다.",
      scene: "요리로 치면 오픈소스는 레시피·재료·조리 과정까지 전부 공개해 똑같이 재현할 수 있고, 오픈 웨이트는 완성된 요리만 줘서 먹거나 간을 더할(파인튜닝) 수는 있지만 어떻게 만들었는지는 알 수 없습니다.",
      why: "오픈소스 모델과 오픈 웨이트 모델의 공개 범위 차이가 출제 핵심입니다.",
      mechanism: "Open Source: 모델의 코드, 학습 데이터, 훈련 과정, 그리고 가중치까지 전부 공개 — 누구나 모델 구조와 학습 방법을 수정하거나 재현 가능(예: 초기 Stable Diffusion 공개 모델). Open Weights: 훈련이 끝난 모델의 가중치만 공개 — 모델을 그대로 실행하거나 파인튜닝해 활용 가능, 하지만 학습 데이터나 학습 코드 전체가 공개되지 않을 수 있음.",
      map: [
        { as: "레시피까지 다 공개", real: "오픈소스 모델", note: "재현 가능" },
        { as: "완성품만 줌", real: "오픈 웨이트 모델", note: "학습된 모델 가중치" },
        { as: "간을 더해 먹음", real: "추가 학습(파인튜닝)", note: "활용 가능" },
        { as: "레시피는 비공개", real: "학습 데이터·학습 코드", note: "공개하지 않음" },
      ],
      usage: "모델 도입 시 라이선스·상업 이용 판단에 쓰입니다. 시험은 오픈소스와의 공개 범위 비교입니다. 140회 정보관리 2교시 출제.",
      links: [
        { topic: "파운데이션 모델(Foundation Model)", how: "공개 방식에 따라 나뉩니다." },
        { topic: "AI BOM(Artificial Intelligence Bill of Materials)", how: "공개 범위를 명세로 남깁니다." },
      ],
      exam: "오픈웨이트 모델은 학습 데이터와 소스 코드는 비공개하며, 학습된 가중치만 공개하여 추론 및 추가 파인튜닝만 허용하는 AI 모델이다.",
    },
    image: "/concept/book/open-weight-model.png",
  },
  "public-ax-strategy": {
    guide: {
      hook: "공공 서비스에 AI를 들일 때, 솔루션 하나 사는 게 아니라 판을 통째로 바꾸는 방식입니다.",
      scene: "예전에는 사업 단위로 물건을 납품받았다면, 이제는 플랫폼을 깔고 그 위에 서비스를 설계합니다. 정적 시스템이 동적 AI 파이프라인으로, 단순 자동화 도구가 업무 지능화 파트너로 바뀝니다.",
      why: "성공적인 AX의 3요소와 7D 도입 방법론이 출제 핵심입니다.",
      mechanism: "성공적인 AX의 3요소: ① AX 대상·서비스(무엇을 AI로 전환할 것인가 — 고객 경험, 운영 및 생산성, 제품 및 서비스) ② AX 구현(어떻게 AI를 구축·적용할 것인가 — AI as a Service, AI Infra, AI Governance) ③ AX 운영·거버넌스(어떻게 AI를 지속 운영·관리할 것인가 — Active Learning, MLOps, Compliance). 도입 방법론(7D): 목표 정의(Define) → Data 정립(Discover) → Data 운영 방안 설계(Develop) → AX 투자 모델 수립(Design) → AI Full Stack 구성(Deploy) → 서비스 제공 채널 선택(Deliver) → AX 활용 진단·모니터링(Diagnose).",
      map: [
        { as: "무엇을 바꿀지 정함", real: "AX 대상·서비스", note: "업무·서비스·의사결정" },
        { as: "어떻게 지을지 정함", real: "AX 구현", note: "데이터·모델·인프라" },
        { as: "계속 굴러가게 함", real: "AX 운영·거버넌스", note: "MLOps, Compliance" },
        { as: "한 업체에 묶이지 않기", real: "종속 회피", note: "AI Full Stack 표준화" },
      ],
      usage: "공공 AI 전환 사업의 기획 틀입니다. 시험은 3요소와 7D 단계입니다.",
      links: [
        { topic: "공공부문 초거대AI 도입, 활용 가이드라인 2.0(2025.04)", how: "공공 도입 지침입니다." },
        { topic: "MLOps", how: "운영·거버넌스의 실행 체계입니다." },
      ],
      exam: "공공 AX는 단편적 AI 솔루션 도입이 아닌, AI Full Stack(인프라·데이터·모델·오케스트레이션·응용 등) 관점에서 표준화, 종속 회피, 민첩 대응이 가능한 방향으로의 접근이 핵심이다.",
    },
    image: "/concept/book/public-ax-strategy.png",
  },
  "ai-transparency-guideline": {
    guide: {
      hook: "AI를 쓰고 있다는 사실과 AI가 만든 결과물이라는 사실을 알리게 하는 제도입니다.",
      scene: "광고에 '협찬'을 표시하듯, AI 서비스에는 'AI를 쓰고 있다'를, AI가 만든 그림·글에는 'AI 생성물'을 표시합니다. 서비스 안에서 보여 줄 때와 파일로 내보낼 때 표시 방법이 다릅니다.",
      why: "인공지능기본법 제31조의 1항(사전 고지)·2항(표시)·3항(고지 또는 표시) 구분이 출제 핵심입니다.",
      mechanism: "법 제31조: 제1항(고영향 AI 및 생성형 AI를 이용한 제품·서비스 제공시 → 제품·서비스의 고영향 또는 생성형 AI기반 운용 사실 → 사전 고지), 제2항(생성형 AI 및 이를 이용한 제품·서비스 제공시 → 결과물이 AI로 생성되었다는 사실 → 표시), 제3항(AI시스템으로 실제와 구분하기 어려운 가상의 생성 결과물 제공시 → 고지 또는 표시). 적용 대상: ① AI 개발사업자 ② AI 이용사업자 ③ 해외 사업자. 사전 고지 방법: 이용약관·계약서, 화면·단말기 표시, 제공 장소 게시.",
      map: [
        { as: "들어가기 전 안내문", real: "사전 고지(1항)", note: "이용약관·화면 표시" },
        { as: "결과물에 찍는 도장", real: "표시(2항)", note: "문구·로고·툴팁" },
        { as: "진짜 같은 가짜 경고", real: "고지 또는 표시(3항)", note: "딥페이크" },
        { as: "파일로 내보낼 때", real: "외부 반출 시 표시", note: "워터마크·메타데이터" },
      ],
      usage: "생성형 AI 서비스의 법적 의무입니다. 시험은 제31조 1~3항 구분과 표시 방법입니다.",
      links: [
        { topic: "AI 기본법", how: "투명성 의무의 근거법입니다." },
        { topic: "인공지능 생성물 워터마크 적용 기술", how: "표시를 구현하는 기술입니다." },
      ],
      exam: "인공지능 투명성 확보 가이드라인은 이용자가 AI를 사용하고 있다는 사실과 AI가 생성한 결과물이라는 사실을 알 수 있도록 고지·표시하는 제도적 장치다.",
    },
    image: "/concept/book/ai-transparency-guideline.png",
  },
  "high-impact-ai-guideline": {
    guide: {
      hook: "사람의 생명·안전·기본권에 크게 영향을 주는 AI인지 가려내는 기준과 절차입니다.",
      scene: "같은 AI라도 음악 추천과 채용 심사는 무게가 다릅니다. 후자처럼 사람의 삶을 좌우하는 영역에 쓰이면 '고영향 AI'로 보고 더 무거운 의무를 지웁니다.",
      why: "판단 절차 6단계와 사업자 책무(기술·관리)가 출제 핵심입니다.",
      mechanism: "판단 절차: ① 자가진단(사업자의 1차 사전 검토 의무) → ② 장관확인 요청(과학기술정보통신부 장관에게 확인 요청, 고영향AI확인 요청서) → ③ 전문위원회 자문(전문위원회 설치 및 자문) → ④ 장관의 판단(고영향 인공지능 해당 여부 판단) → ⑤ 고영향 여부 통지(해당 여부 결정, 사업자에게 통지) → ⑥ 후속 의무 이행(시행령 제27조 사업자 책무 이행). 영향평가 법적 근거: AI기본법 제35조, 시행령 제28조. 사업자 책무: 기술(위험관리 방안 수립·운영, 설명가능성(Explainability), 이용자 보호·사람의 감독), 관리(문서화·보관 의무, 정보공개(투명성), 평가-조치 연계).",
      map: [
        { as: "스스로 먼저 따져 봄", real: "자가진단", note: "1차 사전 검토" },
        { as: "관청에 확인 요청", real: "장관확인 요청", note: "과기정통부" },
        { as: "전문가에게 물어봄", real: "전문위원회 자문", note: "" },
        { as: "해당되면 의무 이행", real: "후속 의무 이행", note: "시행령 제27조" },
      ],
      usage: "고영향 AI 해당 여부 판단과 규제 대응에 쓰입니다. 시험은 절차 6단계와 사업자 책무입니다.",
      links: [
        { topic: "인공지능 영향평가 가이드라인", how: "고영향 판정 후 수행하는 평가입니다." },
        { topic: "AI 기본법", how: "제35조가 영향평가의 근거입니다." },
      ],
      exam: "고영향 인공지능은 사람의 생명, 신체의 안전 및 기본권에 중대한 영향을 미치거나 위험을 초래할 우려가 있어, AI기본법에서 지정한 특정 영역에서 활용되는 인공지능시스템이다.",
    },
    image: "/concept/book/high-impact-ai-guideline.png",
  },
  "ai-impact-assessment-guideline": {
    guide: {
      hook: "고영향 AI가 사람과 사회에 어떤 영향을 줄지 미리 따져 보고 위험을 줄이는 절차입니다.",
      scene: "건물을 짓기 전 환경영향평가를 하듯, AI를 내놓기 전에 누가 영향을 받는지, 어떤 기본권이 걸리는지, 무슨 시나리오로 사고가 날지 미리 따져 보고 대책을 세웁니다.",
      why: "수행 절차 3단계(사전 준비·본 평가 수행·사후 관리)와 개인정보 영향평가(PIA)와의 비교가 출제 핵심입니다.",
      mechanism: "수행 절차: 사전 준비(평가 필요성 검토 — 고영향 AI 판별·체크리스트 → 고영향 AI 확인서 / 평가대상 정의 — 이해관계자 분석, 범위 정의 / 평가계획 수립 — WBS, 일정·역할 정의) → 본 평가 수행(피영향자 분석 — Stakeholder Mapping / 작동원리 분석 — 데이터 흐름 분석, Process Mapping, Model Card / 기본권 영향 식별 — 기본권 매핑, 체크리스트 / 위험 시나리오 및 영향평가 — 시나리오 분석, STPA, FMEA, 위험도 매트릭스 / 위험 완화 계획 수립) → 사후 관리(개선조치 수행 — CAPA(시정·예방조치) / 모니터링 및 재평가 — KPI 모니터링, 재평가). 핵심 흐름: 평가대상 정의 → 영향 식별 및 분석 → 위험 평가 → 완화 및 개선 → 지속적 관리.",
      map: [
        { as: "평가할 대상 정하기", real: "사전 준비", note: "고영향 AI 확인서" },
        { as: "누가 영향받는지 살핌", real: "피영향자 분석", note: "Stakeholder Mapping" },
        { as: "어떤 사고가 날지 그려 봄", real: "위험 시나리오", note: "STPA, FMEA" },
        { as: "고치고 계속 지켜봄", real: "사후 관리", note: "CAPA, 재평가" },
      ],
      usage: "고영향 AI의 법정 평가 절차입니다. 시험은 3단계 절차와 PIA 비교입니다.",
      links: [
        { topic: "고영향 인공지능(AI) 판단 가이드라인", how: "영향평가 대상인지 먼저 가립니다." },
        { topic: "AI 기본법", how: "제35조가 영향평가 실시 근거입니다." },
      ],
      exam: "인공지능 영향평가는 고영향 인공지능이 사람의 기본권과 사회에 미치는 영향을 사전에 식별·평가하고 위험을 완화하기 위한 체계적인 평가 절차다.",
    },
    image: "/concept/book/ai-impact-assessment-guideline.png",
  },
  "omni-modal-ai": {
    guide: {
      hook: "텍스트·이미지·음성·영상·행동을 한 모델이 한꺼번에 배우고 만들어 내는 AI입니다.",
      scene: "사람은 상대의 말과 표정과 몸짓을 따로 처리하지 않고 한 번에 알아듣습니다. 멀티모달이 모달별로 따로 처리했다면, 옴니모달은 모두 같은 토큰으로 바꿔 한 공간에 모아 두고 한 번에 추론합니다.",
      why: "멀티모달(모달별 개별 처리)과의 차이, 공유 잠재공간·인터리브가 출제 핵심입니다.",
      mechanism: "절차: 토큰화(Tokenization — 모든 모달리티를 공통 토큰으로 변환, BPE·ViT·Whisper) → 공유 잠재공간(Shared Latent Space — 모든 토큰을 하나의 공간에 정렬, 의미적 유사성을 반영한 공통 표현) → 통합 추론(Transformer — 단일 Transformer 모델로 통합 처리, Unified-IO2) → 인터리브(Interleaved — 텍스트·이미지·음성·행동 토큰을 자유롭게 혼합해 입력/출력 시퀀스 구성).",
      map: [
        { as: "말·표정·몸짓을 다 받아들임", real: "Multi-modal Input", note: "입력" },
        { as: "같은 말로 옮겨 적음", real: "토큰화", note: "BPE, ViT, Whisper" },
        { as: "한 책상 위에 모아 둠", real: "공유 잠재공간", note: "Shared Latent Space" },
        { as: "한 번에 판단", real: "통합 추론", note: "Unified-IO2" },
        { as: "원하는 형태로 대답", real: "인터리브 생성", note: "Any-to-Any" },
      ],
      usage: "피지컬 AI·제조 물류·헬스케어·AI Agent·XR 메타버스에 쓰입니다. 시험은 절차 4단계와 멀티모달 대비입니다.",
      links: [
        { topic: "멀티모달(Multimodal) AI", how: "모달별 개별 처리라는 점이 다릅니다." },
        { topic: "트랜스포머(Transformer)", how: "통합 추론의 단일 모델입니다." },
      ],
      exam: "옴니모달 AI는 텍스트·이미지·음성·영상·행동(Action) 등 모든 모달리티를 하나의 모델에서 통합 학습하고 이해·생성하는 범용 인공지능이다.",
    },
    image: "/concept/book/omni-modal-ai.png",
  },
  "test-time-compute": {
    guide: {
      hook: "AI에게 '더 오래 생각해 보라'고 시간을 더 주는 방식입니다.",
      scene: "어려운 문제를 받았을 때 바로 답하지 않고 종이에 풀어 보고, 다른 방법으로도 풀어 보고, 답이 맞는지 검산합니다. 카너먼이 말한 System 2(느린 사고)를 AI가 추론할 때 하도록 만든 것입니다.",
      why: "목적(가성비 향상·할루시네이션 감소)과 TTA/TTR 두 유형, 기법 이름이 출제 핵심입니다.",
      mechanism: "개념도: 입력(질문/프롬프트) → 모델 추론 시작(초기 응답 생성) → 추론 연산 확장(① 단계적 추론(CoT) ② 다중 경로 탐색(후보 생성) ③ 반복 개선(자기검토·수정), 문제 난이도에 따라 연산량 증가) → 검증·평가(후보 답안의 타당성 평가) → 최종 출력(최적 답안 생성). 유형: 테스트 시간 적응(TTA — TENT, 프롬프트 적응), 테스트 시간 추론(TTR — CoT, Self-Consistency, Best-of-N, Weighted Best-of-N, STaR, MCTS·ToT).",
      map: [
        { as: "종이에 차근차근 풀기", real: "CoT", note: "단계적 추론" },
        { as: "여러 방법으로 풀어 보기", real: "Self-Consistency", note: "다중 경로, 다수결" },
        { as: "제일 잘 푼 것 고르기", real: "Best-of-N", note: "보상 모델" },
        { as: "검산하고 고치기", real: "TTR", note: "자가 검증" },
      ],
      usage: "추론 모델의 성능 향상 기법입니다. 시험은 System 1/2 대응, TTA·TTR 구분과 기법입니다.",
      links: [
        { topic: "테스트 타임 스케일링(Test-Time Scaling, TTS)", how: "연산량을 늘려 성능을 높이는 같은 갈래입니다." },
        { topic: "대규모 언어 모델(LLM) 성능 향상 기술", how: "학습이 아닌 추론 시점의 향상법입니다." },
      ],
      exam: "테스트 타임 컴퓨팅은 AI 모델이 작업을 수행하는 추론(Inference) 시 사용하는 연산 자원과 시간의 총량으로, 가성비 향상과 할루시네이션 감소를 목적으로 TTA·TTR 기법을 적용한다.",
    },
    image: "/concept/book/test-time-compute.png",
  },
  "multimodal-data-quality": {
    guide: {
      hook: "여러 종류가 섞인 학습 데이터가 쓸 만한지, 만들어 낸 결과가 제대로인지 재는 방법입니다.",
      scene: "사진과 설명글이 짝지어진 데이터를 쓴다면, 설명이 사진과 맞는지(변환성), 사진 속 물건과 글 속 단어가 제대로 대응하는지(정렬성)를 봐야 합니다. 짝이 어긋난 데이터로 배우면 모델도 어긋나게 배웁니다.",
      why: "품질특성 3가지와 이미지·텍스트 생성 지표의 선택 방법이 출제 핵심입니다.",
      mechanism: "품질특성: 표현성(Representation — 유니모달별 라벨링 정보와 실제 참값이 부합하는지 확인하는 특성, 개체식별 판단), 변환(일치)성(Translation — 멀티모달간의 매핑이 정확한지를 판단), 정렬(관계)성(Alignment — 둘 이상의 양식에서 인스턴스의 하위 구성요소간의 관계와 대응이 정확한지를 평가, 시간정렬·공간정렬·관계정렬). 이미지 생성 지표: IS, FID, Improved Precision and Recall, Density and Coverage. 텍스트 생성 지표: BLEU, ROUGE-N, PPL, Meteor, CIDEr, SPICE.",
      map: [
        { as: "라벨이 실물과 맞나", real: "표현성", note: "개체식별 판단" },
        { as: "사진↔설명 짝이 맞나", real: "변환(일치)성", note: "매핑 정확도" },
        { as: "부분끼리도 대응하나", real: "정렬(관계)성", note: "시간·공간·관계" },
        { as: "만든 그림이 진짜 같나", real: "FID", note: "성능 정량 비교" },
      ],
      usage: "학습 데이터 검수와 생성 모델 평가에 쓰입니다. 시험은 품질특성 3가지와 지표별 선택방법입니다.",
      links: [
        { topic: "인공지능 학습용 데이터 품질관리 가이드라인 v3.1", how: "학습 데이터 품질의 기준입니다." },
        { topic: "옴니모달(Omni-modal) AI", how: "여러 모달을 함께 다루는 모델입니다." },
      ],
      exam: "멀티모달 데이터의 품질검증 방법은 “멀티모달 데이터”의 품질특성을 정의하고, 대표 학습업무별 의미 정확성과 생성형 멀티모달 모델의 유효성을 검증하기 위한 방법을 제시하는 활동이다.",
    },
    image: "/concept/book/multimodal-data-quality.png",
  },
  "ai-supercomputing-platform": {
    guide: {
      hook: "초거대 AI를 돌리기 위해 GPU 수천 장을 하나처럼 묶어 쓰는 컴퓨팅 기반입니다.",
      scene: "혼자서는 한 달 걸릴 일을 천 명이 나눠 하면 하루에 끝납니다. 다만 천 명이 서로 말을 주고받아야 하므로, 계산기만큼이나 사람 사이를 잇는 통신망(InfiniBand·NVLink)이 중요합니다.",
      why: "플랫폼 아키텍처 5계층과 계층별 주요기술이 출제 핵심입니다.",
      mechanism: "플랫폼 아키텍처: ① Compute(컴퓨트 계층 — CPU, GPU, NPU, TPU, AI Accelerator) ② Network(네트워크 계층 — InfiniBand, RoCE, NVLink, 고속 인터커넥트) ③ Storage(스토리지 계층 — NVMe, Parallel File System, Object Storage, 분산 스토리지) ④ Software(소프트웨어 계층 — OS, CUDA, AI Framework, PyTorch, TensorFlow, Distributed Training, MLOps) ⑤ Management(관리 계층 — Scheduler, Kubernetes, Resource Management, Monitoring, Security, Provisioning).",
      map: [
        { as: "일하는 사람들", real: "AI Compute", note: "GPU, NPU, TPU" },
        { as: "사람 사이 통신망", real: "High-Speed Network", note: "InfiniBand, NVLink" },
        { as: "자료 창고", real: "High-Performance Storage", note: "Parallel File System" },
        { as: "작업 배분 반장", real: "Cluster / Resource Management", note: "Scheduler, Kubernetes, Slurm" },
      ],
      usage: "초거대 AI 학습·추론 인프라입니다. 시험은 5계층 구조와 계층별 기술입니다. 140회 정보관리 2교시 출제.",
      links: [
        { topic: "AI 네이티브 개발 플랫폼(AI-Native Development Platform)", how: "그 위에서 개발이 이뤄집니다." },
        { topic: "MLOps", how: "관리 계층의 운영 체계입니다." },
      ],
      exam: "AI 슈퍼컴퓨팅 플랫폼은 GPU·NPU 등 AI 가속기와 고속 네트워크·스토리지를 결합하여 초거대 AI 모델의 학습·추론을 대규모 병렬·분산 처리하는 고성능 컴퓨팅 플랫폼이다.",
    },
    image: "/concept/book/ai-supercomputing-platform.png",
  },
  "ai-native-dev-platform": {
    guide: {
      hook: "코드 짜기부터 테스트·배포까지 개발 전 과정을 AI가 맡아 주는 플랫폼입니다.",
      scene: "예전에는 사람이 한 줄씩 쳤다면, 이제는 자연어로 원하는 것을 말하면 AI 에이전트가 코드를 만들고 테스트하고 배포까지 돌립니다. 사람은 무엇을 만들지 정하고 결과를 확인합니다.",
      why: "구성도 3계층(개발·테스트·플랫폼)과 전통 개발과의 비교가 출제 핵심입니다.",
      mechanism: "구성요소: AI 개발(AI Developer Tools, Framework — 코드 생성 및 애플리케이션 개발), AI 테스트(AI Agent, AI Gateway, Model Studio — 테스트 및 AI 협업), 플랫폼(LLM, MCP, Database, AI Infra — AI 개발환경 및 실행 기반). 개발절차: 요구 분석(자연어 기반 요구사항 입력 — Prompt, AI Agent) → 코드 생성(LLM, Copilot) → 테스트(AI Agent, Model Studio) → 배포(CI/CD 및 운영 — MCP, AI Gateway) → 개선(코드 리팩토링 및 최적화 — Feedback, LLM).",
      map: [
        { as: "말로 주문하기", real: "Prompt", note: "자연어 입력" },
        { as: "대신 써 주는 사람", real: "AI 개발도구", note: "Claude Code, Cursor 등" },
        { as: "심부름꾼끼리 연결", real: "MCP Server", note: "Model Context Protocol" },
        { as: "작업장 전체", real: "플랫폼 계층", note: "Framework, DB, AI Infra" },
      ],
      usage: "개발 생산성 향상 수단입니다. 시험은 구성요소, 개발절차, 전통 개발 비교입니다. 140회 정보관리 2교시 출제.",
      links: [
        { topic: "하네스 엔지니어링", how: "에이전트가 일할 환경을 설계합니다." },
        { topic: "에이전틱 AI(Agentic AI)", how: "개발을 수행하는 주체입니다." },
      ],
      exam: "AI 네이티브 개발 플랫폼은 생성형 AI와 AI 에이전트를 활용하여 코드 생성부터 테스트·배포까지 소프트웨어 개발 전 과정을 지능화하는 AI 기반 개발 플랫폼이다.",
    },
