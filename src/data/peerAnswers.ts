...
export const PEER_ANSWERS: PeerAnswer[] = [
  ...
  // ── ITPE NS·단합반 19기 02주차(2026-09-13) 해설집 — 문항별 모범답안 원본 페이지 ──
  {
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-101-1.jpg", label: "1쪽 — 멀티 프로세싱 환경에서의 성능저하, 프로세스 스레싱(Thrashing) " },
      { src: "/answers/sol-ns19w02-101-2.jpg", label: "2쪽 — 스레싱 예방을 위한 기법 설명" },
      { src: "/answers/sol-ns19w02-101-3.jpg", label: "3쪽 — 효과적인 스레싱 발생 최소화를 위한 예방 기법" },
    ],
  },
  {
    id: "peer-sol-ns19w02-102",
    period: "1교시",
    no: "2",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-102-1.jpg", label: "1쪽 — 실시간 스케줄링 우선순위 이상현상. 우선순위 역전(Priority Inv" },
      { src: "/answers/sol-ns19w02-102-2.jpg", label: "2쪽 — 우선순위 역전(Priority Inversion)현상의 해결 기법" },
    ],
  },
  {
    id: "peer-sol-ns19w02-103",
    period: "1교시",
    no: "3",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-103-1.jpg", label: "1쪽 — Process Control Block 과 Thread Control B" },
      { src: "/answers/sol-ns19w02-103-2.jpg", label: "2쪽 — 운영체제에서 PCB 및 TCB 가 스케줄링에 활용되는 방식 · PCB 와" },
    ],
  },
  {
    id: "peer-sol-ns19w02-104",
    period: "1교시",
    no: "4",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-104-1.jpg", label: "1쪽 — 가상메모리 페이지 교체 알고리즘의 개요 · 주요 페이지 교체 알고리즘의 " },
      { src: "/answers/sol-ns19w02-104-2.jpg", label: "2쪽 — 빈도기반, 기타 알고리즘 동작원리" },
      { src: "/answers/sol-ns19w02-104-3.jpg", label: "3쪽 — 페이지 교체의 문제점 및 해결방안" },
    ],
  },
  {
    id: "peer-sol-ns19w02-105",
    period: "1교시",
    no: "5",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-105-1.jpg", label: "1쪽 — 인터럽트의 개념 및 종류" },
      { src: "/answers/sol-ns19w02-105-2.jpg", label: "2쪽 — 인터럽트 백터 테이블과 인터럽트 서비스 루틴 설명" },
      { src: "/answers/sol-ns19w02-105-3.jpg", label: "3쪽 — 우선순위 보장을 위한 다중 인터럽트의 처리 동작" },
    ],
  },
  {
    id: "peer-sol-ns19w02-106",
    period: "1교시",
    no: "6",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-106-1.jpg", label: "1쪽 — HBM 한계 보완, HBF(High Bandwidth Flash)의 개념" },
      { src: "/answers/sol-ns19w02-106-2.jpg", label: "2쪽 — HBM 과 HBF 의 비교" },
    ],
  },
  {
    id: "peer-sol-ns19w02-107",
    period: "1교시",
    no: "7",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-107-1.jpg", label: "1쪽 — AI의 새로운 패러다임의 비교, GPU와 TPU의 개념 비교 · GPU와" },
      { src: "/answers/sol-ns19w02-107-2.jpg", label: "2쪽 — GPU와 TPU의 협업을 통한 시스템의 설계" },
    ],
  },
  {
    id: "peer-sol-ns19w02-108",
    period: "1교시",
    no: "8",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-108-1.jpg", label: "1쪽 — 데이터 전송 길의 확장. CXL(Compute Express Link) " },
      { src: "/answers/sol-ns19w02-108-2.jpg", label: "2쪽 — CXL(Compute Express Link)의 서브 프로토콜(proto" },
      { src: "/answers/sol-ns19w02-108-3.jpg", label: "3쪽 — 앞 항목 계속" },
      { src: "/answers/sol-ns19w02-108-4.jpg", label: "4쪽 — 앞 항목 계속" },
    ],
  },
  {
    id: "peer-sol-ns19w02-109",
    period: "1교시",
    no: "9",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-109-1.jpg", label: "1쪽 — 교착상태 탐지 및 회피를 위한 자원과 프로세스 관계, 자원할당 그래프 ·" },
      { src: "/answers/sol-ns19w02-109-2.jpg", label: "2쪽 — 자원할당 그래프 교착상태 발견 시 해결방안" },
    ],
  },
  {
    id: "peer-sol-ns19w02-110",
    period: "1교시",
    no: "10",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-110-1.jpg", label: "1쪽 — 장치간의 속도차이 극복을 위한 Cache Memory의 개념 및 구조" },
      { src: "/answers/sol-ns19w02-110-2.jpg", label: "2쪽 — 지역성(Locality)의 개념과 유형" },
      { src: "/answers/sol-ns19w02-110-3.jpg", label: "3쪽 — 캐쉬 일관성(Coherence) 문제의 원인과 해결 방법" },
      { src: "/answers/sol-ns19w02-110-4.jpg", label: "4쪽 — 앞 항목 계속" },
    ],
  },
  {
    id: "peer-sol-ns19w02-111",
    period: "1교시",
    no: "11",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-111-1.jpg", label: "1쪽 — 고가용성과 성능향상, RAID 개요 · RAID 종류 및 상세설명" },
      { src: "/answers/sol-ns19w02-111-2.jpg", label: "2쪽 — 앞 항목 계속" },
      { src: "/answers/sol-ns19w02-111-3.jpg", label: "3쪽 — Hybrid RAID 1+0 설명 (Netsted RAID)" },
    ],
  },
  {
    id: "peer-sol-ns19w02-112",
    period: "1교시",
    no: "12",
    ...
    maxScore: 10,
    pages: [
      { src: "/answers/sol-ns19w02-112-1.jpg", label: "1쪽 — 기아현상(Starvation)의 정의과 발생조건" },
      { src: "/answers/sol-ns19w02-112-2.jpg", label: "2쪽 — 기아현상(Starvation)의 방지 기법 · 교착상태와 기아현상의 비교" },
      { src: "/answers/sol-ns19w02-112-3.jpg", label: "3쪽 — 교착상태와 기아현상의 상세 비교" },
    ],
  },
  {
    id: "peer-sol-ns19w02-113",
    period: "1교시",
    no: "13",
  ...
  },
  {
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-201-1.jpg", label: "1쪽 — 효율적인 프로세스 배분의 처리절차, CPU 스케줄링의 개념" },
      { src: "/answers/sol-ns19w02-201-2.jpg", label: "2쪽 — 멀티 프로그래밍(Multiprogramming) 핸들러. 운영체제 스케줄" },
      { src: "/answers/sol-ns19w02-201-3.jpg", label: "3쪽 — CPU 자원의 상태 번화, 프로세스 상태 전이도" },
      { src: "/answers/sol-ns19w02-201-4.jpg", label: "4쪽 — 프로세스 상태 전이도에서 문맥교환이 발생되는 시점" },
    ],
  },
  {
    id: "peer-sol-ns19w02-202",
    period: "2교시",
    no: "2",
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-202-1.jpg", label: "1쪽 — 프로세스간 정보교환, 문맥 및 문맥교환의 개념과 문맥의 유형 및 내용" },
      { src: "/answers/sol-ns19w02-202-2.jpg", label: "2쪽 — 문맥교환 절차와 PCB(Process Control Block)" },
      { src: "/answers/sol-ns19w02-202-3.jpg", label: "3쪽 — 문맥교환 시 발생하는 오버헤드 해결 방법" },
    ],
  },
  {
    id: "peer-sol-ns19w02-203",
    period: "2교시",
    no: "3",
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-203-1.jpg", label: "1쪽 — 메모리의 확장적 사용 위한, 가상 메모리 관리의 개념 · 가상 메모리 관" },
      { src: "/answers/sol-ns19w02-203-2.jpg", label: "2쪽 — 페이징(Paging) 기법과 세그멘테이션(Segmentation) 기법 " },
      { src: "/answers/sol-ns19w02-203-3.jpg", label: "3쪽 — 동적 분할 기법, 세그멘테이션(Segmentation) 기법 설명" },
      { src: "/answers/sol-ns19w02-203-4.jpg", label: "4쪽 — 메모리 단편화 설명" },
      { src: "/answers/sol-ns19w02-203-5.jpg", label: "5쪽 — 앞 항목 계속" },
    ],
  },
  {
    id: "peer-sol-ns19w02-204",
    period: "2교시",
    no: "4",
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-204-1.jpg", label: "1쪽 — 멀티 프로세싱 환경에서의 캐시 일관성(Cache coherency) 개념" },
      { src: "/answers/sol-ns19w02-204-2.jpg", label: "2쪽 — Write through와 Write back의 비교 설명 · 캐시 일관" },
      { src: "/answers/sol-ns19w02-204-3.jpg", label: "3쪽 — 앞 항목 계속" },
    ],
  },
  {
    id: "peer-sol-ns19w02-205",
    period: "2교시",
    no: "5",
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-205-1.jpg", label: "1쪽 — 페이지 교체 알고리즘을 사용하는 이유 설명" },
      { src: "/answers/sol-ns19w02-205-2.jpg", label: "2쪽 — 페이지 교체 알고리즘의 종류, 각 종류별 동작 과정" },
      { src: "/answers/sol-ns19w02-205-3.jpg", label: "3쪽 — 페이지 교체 알고리즘의 동작 과정 설명" },
      { src: "/answers/sol-ns19w02-205-4.jpg", label: "4쪽 — FIFO Anomaly 와 해결방안" },
      { src: "/answers/sol-ns19w02-205-5.jpg", label: "5쪽 — FIFO Anomaly 해결방안" },
    ],
  },
  {
    id: "peer-sol-ns19w02-206",
    period: "2교시",
    no: "6",
    ...
    maxScore: 25,
    pages: [
      { src: "/answers/sol-ns19w02-206-1.jpg", label: "1쪽 — 멀티 프로세스 동시 접근 자원 영역, 임계 영역 개요 · 프로세스 자원 " },
      { src: "/answers/sol-ns19w02-206-2.jpg", label: "2쪽 — 소프트웨어 측면 임계 영역 제어 기법 설명" },
