...
const SE_1: CurriculumTopic[] = [
  ...
  { title: "클래스 다이어그램 (Class Diagram)", priority: "중" },
  { title: "유즈케이스 다이어그램", priority: "중" },
  { title: "상태 다이어그램 (State Diagram)", priority: "하" },
  { title: "시퀀스 다이어그램 (Sequence Diagram)", priority: "중" },
...
const SE_2: CurriculumTopic[] = [
  ...
  { title: "Test Exit Criteria", priority: "중" },
...
const AI_ALL: CurriculumTopic[] = [
  ...
  { title: "도메인 특화 언어 모델(DSLM, Domain-Specific Language Model)", priority: "중" },
  { title: "Physical AI", priority: "중" },
  { title: "VLA(Vision-Language-Action) 모델", priority: "상" },
  { title: "월드 파운데이션 모델(World Foundation Model)", priority: "상" },
  { title: "온디바이스 AI", priority: "하" },
  { title: "멀티모달(Multimodal) AI", topicId: "ai-5", priority: "중" },
  { title: "옴니모달(Omni-modal) AI", priority: "하" },
  { title: "정서 인공지능(Affective AI)", priority: "중" },
  ...
  { title: "테스트타임 컴퓨팅(Test-Time Compute)", priority: "하" },
  { title: "테스트 타임 스케일링(Test-Time Scaling, TTS)", priority: "하" },
  ...
  { title: "ISO/IEC 23894", priority: "중" },
  { title: "AI RMF(AI Risk Management Framework)", priority: "상" },
  { title: "튜링 테스트", priority: "하" },
  { title: "AI 시스템 테스트", priority: "상" },
  { title: "ISO/IEC 42119-2", priority: "중" },
  { title: "ISO 29119-11", priority: "중" },
  ...
  { title: "하네스 엔지니어링", priority: "상" },
  { title: "AI BOM(Artificial Intelligence Bill of Materials)", priority: "중" },
  { title: "오픈웨이트(Open-weight) 모델", priority: "중" },
  { title: "AI 슈퍼컴퓨팅 플랫폼(Supercomputing Platform)", priority: "하" },
  { title: "AI 네이티브 개발 플랫폼(AI-Native Development Platform)", priority: "하" },
  ...
  { title: "UCP와 ACP", priority: "중" },
  { title: "AX (AI Transformation)", priority: "하" },
  { title: "공공 AX 전략", priority: "중" },
  { title: "인공지능 경영시스템(ISO 42001:2023)", priority: "중" },
  { title: "소버린 AI(Artificial Intelligence)", priority: "중" },
  ...
  { title: "생성형 인공지능 서비스 이용자 보호 가이드라인(2025.02.28)", topicId: "ai-175", priority: "상" },
  { title: "인공지능 학습용 데이터 품질관리 가이드라인 v3.1", priority: "상" },
  { title: "인공지능 (AI) 도입 사업비 산정 절차", priority: "중" },
  { title: "AI 기본법", topicId: "ai-157", priority: "상" },
  { title: "인공지능 투명성 확보 가이드라인", priority: "중" },
  { title: "고영향 인공지능(AI) 판단 가이드라인", priority: "중" },
  { title: "인공지능 영향평가 가이드라인", priority: "중" },
  { title: "인공지능 생성물 워터마크 적용 기술", priority: "하" },
  { title: "생성형AI 데이터 품질관리 가이드 v2.0", priority: "중" },
  // 새 교재 CONTENTS 에서는 빠졌지만 서브노트가 남아 있어 뒤에 둔다.
...
/**
 * 학원 일정부터 시작한다 — 개강 주(9/6)와 1주차(9/7)부터. 개강 전 선행 학습
 * 4주(8/3~8/24)는 기록째 걷어냈다. 지금은 학원 진도가 기준이고, 선행 때
 * 체크한 완료 기록이 심화반 진도처럼 보이면 안 된다. loadDone 이 버린다.
 */
export const WEEKS: CurriculumWeek[] = [
  {
    // 개강 주 — 학원 일정의 시작. 9/6(일) 심화반 개강과 NS 19기 01주차 모의고사.
    // 선행 학습이 아니라 학원 기록이므로 남긴다. 평일은 개강 전 휴식.
    start: "2026-08-31",
    title: "개강 주 · 9/6 심화반 개강과 NS 19기 01주차 모의고사",
    days: [
      { kind: "rest", label: "휴식", note: "개강 전까지 쉬어 갑니다." },
      { kind: "rest", label: "휴식", note: "개강 전까지 쉬어 갑니다." },
      { kind: "rest", label: "휴식", note: "개강 전까지 쉬어 갑니다." },
      { kind: "rest", label: "휴식", note: "개강 전까지 쉬어 갑니다." },
      { kind: "rest", label: "휴식", note: "개강 전까지 쉬어 갑니다." },
