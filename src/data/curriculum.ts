...
// ── 2주차: 소프트웨어공학(SE) 93토픽 ─────────────────────────────────
// 교재 CONTENTS 순서·Priority 그대로. 슬라이드(서브노트)는 받는 대로 채운다.
const SE_1: CurriculumTopic[] = [
  { title: "공공기관 정보화사업 예비타당성", priority: "중" },
  { title: "소프트웨어 개발 방법론", priority: "중" },
  { title: "소프트웨어 설계의 원리", priority: "중" },
  { title: "객체지향 프로그래밍 특징", topicId: "se-18", priority: "상" },
  { title: "다형성 (Polymorphism)", priority: "상" },
  { title: "객체지향 설계 원리", priority: "상" },
  { title: "Product Line", topicId: "se-28", priority: "중" },
  { title: "AOP (Aspect Oriented Programming)", priority: "중" },
  { title: "테일러링 (Tailoring)", priority: "중" },
  ...
  { title: "SW Architecture 구축 절차", priority: "중" },
  { title: "소프트웨어 아키텍처 드라이버 (SW Architecture Driver)", priority: "상" },
  { title: "유틸리티 트리 (Utility Tree)", priority: "중" },
  { title: "소프트웨어 품질 속성 시나리오", priority: "중" },
  { title: "소프트웨어 아키텍처 스타일", priority: "상" },
  { title: "SW Architecture 평가", topicId: "se-59", priority: "중" },
  { title: "CBAM(Cost Benefit Analysis Method)", priority: "중" },
  { title: "Clean architecture", topicId: "se-67", priority: "중" },
  { title: "디자인 패턴 (Design Pattern)", priority: "중" },
  { title: "싱글턴 패턴 (Singleton pattern)", priority: "중" },
  { title: "MVVM (Model, View, View Model)", priority: "중" },
  { title: "UML의 4+1 View Model", priority: "중" },
  { title: "UML (정적, 동적 다이어그램)", priority: "중" },
  { title: "클래스 다이어그램 (Class Diagram)", priority: "상" },
  { title: "유즈케이스 다이어그램", priority: "상" },
  { title: "상태 다이어그램 (State Diagram)", priority: "상" },
  { title: "시퀀스 다이어그램 (Sequence Diagram)", priority: "상" },
  { title: "Interaction overview diagram", topicId: "se-94", priority: "중" },
  { title: "MSA (Micro Service Architecture)", priority: "상" },
];

const SE_2: CurriculumTopic[] = [
  { title: "API Gateway", topicId: "se-70", priority: "상" },
  { title: "SAGA패턴", priority: "중" },
  ...
  { title: "데브옵스 (DevOps)", priority: "중" },
  { title: "SRE (Site Reliability Engineering)", topicId: "se-141", priority: "중" },
  { title: "무중단 배포", priority: "중" },
  { title: "릴리즈 엔지니어링", priority: "중" },
  { title: "카오스 엔지니어링 (Chaos Engineering)", topicId: "se-144", priority: "중" },
  { title: "DevSecOps", topicId: "sec-341", priority: "중" },
  { title: "테스트 원리", topicId: "se-149", priority: "중" },
  { title: "블랙박스 테스트", topicId: "se-156", priority: "상" },
  { title: "화이트박스 테스트", topicId: "se-158", priority: "상" },
  { title: "탐색적 테스트", priority: "상" },
  { title: "테스트 오라클", topicId: "se-163", priority: "중" },
  { title: "경험 기반 테스트", priority: "상" },
  { title: "위험 기반 테스트", topicId: "se-168", priority: "중" },
  { title: "뮤테이션 테스트 (Mutation Test)", priority: "중" },
  { title: "성능 테스트", topicId: "se-174", priority: "중" },
  { title: "퍼징 테스트 (Fuzzing Test)", priority: "중" },
  { title: "튜링 테스트", topicId: "se-181", priority: "중" },
  { title: "Keyword Driven Testing", priority: "중" },
  { title: "카오스 테스트 (Chaos Test)", topicId: "se-190", priority: "중" },
  { title: "Back to Back 테스트", priority: "중" },
  { title: "Test Process", topicId: "se-195", priority: "중" },
  { title: "ISO 29119", topicId: "se-196", priority: "중" },
  { title: "ISO 29119-11", priority: "하" },
  { title: "Test Exit Criteria", priority: "상" },
  { title: "Lehman의 Software 변화의 원리", priority: "중" },
  { title: "데메테르의 법칙 (Law of Demeter)", topicId: "se-207", priority: "하" },
];

const SE_3: CurriculumTopic[] = [
  { title: "3R", topicId: "se-208", priority: "상" },
  { title: "소프트웨어 리팩토링", topicId: "se-212", priority: "상" },
  { title: "유지보수", priority: "중" },
  { title: "ISO/IEC/IEEE 14764", priority: "하" },
  { title: "오픈소스 SW 보안위협", priority: "중" },
  { title: "오픈소스 거버넌스", priority: "중" },
  { title: "CMMI 3.0", priority: "중" },
  { title: "GS 인증", topicId: "se-229", priority: "중" },
  { title: "SP 인증", priority: "중" },
  { title: "ISO/IEC 25010:2023", priority: "중" },
  { title: "상용소프트웨어 품질성능 평가 시험", topicId: "se-230", priority: "하" },
  ...
  { title: "난독화", topicId: "se-296", priority: "상" },
  { title: "정보시스템 운영/유지보수 감리", priority: "하" },
  { title: "정보시스템 감리 의무 대상과 관점별 점검 기준", priority: "중" },
  { title: "공통감리 절차", priority: "상" },
  { title: "정보시스템 감리결과보고서 (구성, 보고사항)", priority: "하" },
  { title: "소프트웨어 안전 확보를 위한 지침", topicId: "se-52", priority: "하" },
  { title: "소프트웨어사업 영향평가", priority: "하" },
  { title: "상용 소프트웨어 직접구매 제도", priority: "하" },
  { title: "SBOM", priority: "상" },
  { title: "사용성 평가", priority: "하" },
  { title: "정보시스템 운영 성과관리", topicId: "se-203", priority: "하" },
];

const WEEK2_DAYS: CurriculumDay[] = [
  { kind: "study", label: "PM 전체 (프로젝트 관리)", topics: [...PM_PLAN, ...PM_SCHEDULE, ...PM_TEAM, ...PM_AGILE] },
  { kind: "study", label: "SE ① 방법론·설계·아키텍처", topics: SE_1 },
